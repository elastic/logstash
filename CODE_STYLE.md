...
This guide is intended to become a reference for logstash developers, a central place where contributor can refer when in doubt about how to style their code. Nevertheless an style guide is also useful to make the code look similar, reducing complexities and especially when groups of contributors are growing.

This style guide is based on the [guide][rails-style-guide] created by Bozhidar Batsov for [Rubocop][RuboCop], The Airbnb [guide][Airbnb], the Logstash team inputs, and others. There is also a rubocop file used to check this guide automatically.
