...
class LinuxJobs(Jobs):
    ...
    def prepare_shell(self) -> str:
        ...
        # JDK 17 is below the supported minimum (21); allow Logstash to boot so we can still test it
        force_opts = '\nexport LS_JAVA_OPTS="-Dlogstash.jdk17.allow=true ${LS_JAVA_OPTS:-}"' if self.jdk.endswith("_17") else ""
