...
This situation can be caused by insufficient memory. If {ls} uses more memory than the declared resource, Kubernetes kills the pod immediately and the l{ls} log does not show any shutdown related message.
