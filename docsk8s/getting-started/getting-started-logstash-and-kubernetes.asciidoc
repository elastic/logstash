...
This section guides you through the process of setting up {ls} to monitor a Kubernetes environment running on Minikube. Kubernetes logs and metrics will be monitored by Filebeat and Metricbeat, respectively, processed through a Logstash pipeline, and then delivered into an Elasticsearch cluster in the Kubernetes environment.

To deliver the monitoring data into an external Elasticsearch cluster, whether on your local machine or on Elasticsearch Service, refer to <<getting-started-external-elasticsearch,Send data to an external Elasticsearch cluster>>.

This section includes the following topics:

* <<gs-prerequisites>>
* <<gs-set-up>>
* <<gs-generate-certificate>>
* <<gs-create-elastic-stack>>
* <<gs-tidy-up>>
