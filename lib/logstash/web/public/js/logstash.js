      ...
      $("#results").load("api/search?format=html", logstash.params,
        function(response, status, xhr) {
          if (status == "error") {
            ...
            /* Include a helper message if this is a special error */
            if (/No indices \/ shards to search on/.test(response)) {
              response += "<p><b> This may mean you have no data in ElasticSearch. </b>"
            }
