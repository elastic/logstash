    ...
    histogram: function(tries) {
      ...
      jQuery.getJSON("/api/histogram", logstash.params, function(histogram, text, jqxhr) {
        ...
        if (tries > 0 && logstash.params.interval > 1000) {
          ...
          /* TODO(sissel): record a good graph interval for this specific instance
           * as being 'logstash.params.interval' 
           *
           * Saving it will be useful when history tracking (back button, etc) gets better.
           */
        }
      });
    },
