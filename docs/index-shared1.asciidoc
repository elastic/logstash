...
:edit_url: https://github.com/elastic/logstash/edit/5.6/docs/static/introduction.asciidoc
...
:edit_url: https://github.com/elastic/logstash/edit/5.6/docs/static/getting-started-with-logstash.asciidoc
include::static/getting-started-with-logstash.asciidoc[]

// Advanced LS Pipelines

:edit_url: https://github.com/elastic/logstash/edit/5.6/docs/static/advanced-pipeline.asciidoc
include::static/advanced-pipeline.asciidoc[]

// Processing Pipeline

:edit_url: https://github.com/elastic/logstash/edit/5.6/docs/static/life-of-an-event.asciidoc
include::static/life-of-an-event.asciidoc[]

// Lostash setup

:edit_url: https://github.com/elastic/logstash/edit/5.6/docs/static/setting-up-logstash.asciidoc
include::static/setting-up-logstash.asciidoc[]

:edit_url: https://github.com/elastic/logstash/edit/5.6/docs/static/settings-file.asciidoc
include::static/settings-file.asciidoc[]

:edit_url: https://github.com/elastic/logstash/edit/5.6/docs/static/running-logstash-command-line.asciidoc
include::static/running-logstash-command-line.asciidoc[]

:edit_url: https://github.com/elastic/logstash/edit/5.6/docs/static/running-logstash.asciidoc
include::static/running-logstash.asciidoc[]

:edit_url: https://github.com/elastic/logstash/edit/5.6/docs/static/docker.asciidoc
include::static/docker.asciidoc[]

:edit_url: https://github.com/elastic/logstash/edit/5.6/docs/static/logging.asciidoc
include::static/logging.asciidoc[]

:edit_url: https://github.com/elastic/logstash/edit/5.6/docs/static/shutdown.asciidoc
