...
* [Monolithic jar](http://semicomplete.com/files/logstash/logstash-1.0.5-monolithic.jar)
* [rubygem](https://github.com/downloads/logstash/releases/logstash-1.0.5.gem)
