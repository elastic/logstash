...
:edit_url: https://github.com/elastic/logstash/edit/{branch}/docs/static/setup/installing-xls.asciidoc
include::static/setup/installing-xls.asciidoc[]

:edit_url: https://github.com/elastic/logstash/edit/{branch}/docs/static/setup/setting-up-xpack.asciidoc
