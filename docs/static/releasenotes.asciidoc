...
26c4eb9 - (HEAD -> 7.14, origin/7.14) Docs: keep elastic_app_search output meta-data (#13048) (#13055) (24 hours ago) <Karol Bucek>
6b6bafe - Emergency revert for 7.14 (#13043) (7 days ago) <Andrea Selva>
674d30d - update lockfile for 7.14.0 (#13034) (8 days ago) <João Duarte>
825d706 - add lockfile based on 7.13 branch (8 days ago) <Joao Duarte>
c081985 - Add unit test to grant that production aliases correspond to a published RubyGem (#12993) (#13009) (10 days ago) <Andrea Selva>
c305592 - Feat: event factory support (#13017) (#13025) (10 days ago) <Karol Bucek>
...
873e2c7 - Backport PR #12830 to 7.x: ecs-compatibility docs (#13016) (2 weeks ago) <Ry Biesemeyer>
6d3446d - Backport PR #13008 to 7.x: Fix UBI source URL (#13011) (2 weeks ago) <Rob Bavey>
4dcc69d - ispec: fix cross-spec leak from fatal error integration specs (#13002) (#13013) (2 weeks ago) <Ry Biesemeyer>
2c84a5d - Fix logstash.bat not setting exit code (#12948) (#13007) (2 weeks ago) <Andrea Selva>
75d616e - Use the OS separator to invoke gradlew from Rake script (#13000) (#13006) (2 weeks ago) <Andrea Selva>
1059bd9 - Fix Reflections stack traces when process yml files in classpath and debug is enabled (#12991) (#13003) (3 weeks ago) <Andrea Selva>
db726ab - Fix/log4j routing to avoid create spurious file (#12965) (#12999) (3 weeks ago) <Andrea Selva>
f063d86 - Added test to cover the installation of aliased plugins (#12967) (#12998) (3 weeks ago) <Andrea Selva>
138b60c - Explicitate the type of log format in appender's names (#12964) (#12997) (3 weeks ago) <Andrea Selva>
adcb0da - Fix acceptance test when run artifact:all (#12975) (#12996) (3 weeks ago) <Andrea Selva>
72e8dc8 - fix database manager with multiple pipelines (#12862) (#12995) (3 weeks ago) <kaisecheng>
854fad6 - Avoid hard-coded plugin alias definitions (#12841) (#12960) (3 weeks ago) <Andrea Selva>
35ce0ee - [7.x] Deps: update JRuby to 9.2.19.0 (#12989) (#12990) (3 weeks ago) <Karol Bucek>
7d4b2ff - Doc: Add tip for checking for existing field  (#12987) (3 weeks ago) <Karen Metts>
d0d4cae - Release notes draft for 7.13.2 to 7.x (#12982) (3 weeks ago) <Karen Metts>
9997cee - Doc: Remove unused tagged regions (#12979) (4 weeks ago) <Karen Metts>
419b1dc - Backport PR #12791 to 7.x: Deps: update JRuby to 9.2.18.0 (#12971) (4 weeks ago) <Karol Bucek>
9cf722d - Test: handle a RGs warning from packing output (#12974) (4 weeks ago) <Karol Bucek>
adb7f67 - Backport PR #12962 Fix dependency on plugin_alias.yml during `rake artifacts:all` (#12963) (5 weeks ago) <Andrea Selva>
d9e2154 - Refactoring of JavaKeyStore.getKeyStorePassword method to simplify if conditions (#12952) (#12961) (5 weeks ago) <Andrea Selva>
6766a87 - Release notes for 7.13.1 (#12946) (#12957) (5 weeks ago) <kaisecheng>
f93b30c - Use the JVM specified in the CI matrix environment also to run spawned proccesses (#12945) (#12953) (5 weeks ago) <Andrea Selva>
0a1bb2f - Internal: Update messaging in release notes script (#12949) (#12950) (6 weeks ago) <Karen Metts>
f0ba6ea5 - Backport PR #12925 to 7.x: Add logstash-integration-elastic_enterprise_search to plugins-metadata.json (#12934) (6 weeks ago) <Rob Bavey>
5ff415c - Doc: Expand definition and fix typo(#12937) (6 weeks ago) <Karen Metts>
270616f - Forwardport release notes for 7.13.0 to 7.x branch  (#12932) (6 weeks ago) <Karen Metts>
ec8d182 - Geoip disable database manager (#12905) (#12906) (8 weeks ago) <kaisecheng>
f8551a0 - Update bundled JDK to 11.0.11+9 (#12881) (#12882) (8 weeks ago) <Andrea Selva>
7f934db - fix ubi8 docker image creation by skipping yum clean metadata (#12902) (#12903) (8 weeks ago) <João Duarte>
e5e41f8 - [backport 7.x] [Build] On aarch64 docker build, install `noarch` version of bind-license first (#12891) (#12900) (8 weeks ago) <Rob Bavey>
4f58cb3 - Doc: Update contributing steps and guidelines (#12895) (8 weeks ago) <Karen Metts>
3b552af - Comment out config examples that no longer work (#12892) (8 weeks ago) <Karen Metts>
6a338c6 - Geoip use cc indefinitely (#12888) (#12889) (8 weeks ago) <kaisecheng>
68b8fd3 - change download path for geoip plugin (#12863) (#12875) (8 weeks ago) <kaisecheng>
b33692e - Update elasticsearch gem dependency requirements (#11258) (#12874) (9 weeks ago) <Andrea Selva>
5287e77 - Change Gradle's :logstash-integration-tests:integrationTests task to depends on copyES (#12847) (#12868) (9 weeks ago) <Andrea Selva>
6c0f3c6 - Doc: Keystore must be accessible to logstash user (#12864) (10 weeks ago) <Karen Metts>
4449383 - bump core version to 7.14.0 (#12839) (3 months ago) <kaisecheng>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.13.3..7.14 *.release"
