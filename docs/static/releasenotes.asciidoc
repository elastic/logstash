...
* Docs - lumberjack plugin deprecated, recommended not to use in LS to LS communication https://github.com/elastic/logstash/pull/19526[#19526]

==== Updates to dependencies

* Upgrade rubyzip dependency https://github.com/elastic/logstash/pull/19552[#19552]

* Update jackson to 2.21.6 https://github.com/elastic/logstash/pull/19549[#19549]

* Pin resolv 0.7.2 and fork JRuby for gem installs https://github.com/elastic/logstash/pull/19536[#19536]

* Update bundled JDK to 21.0.12.1 https://github.com/elastic/logstash/pull/19509[#19509]

* Update Ironbank image to UBI 10.2 https://github.com/elastic/logstash/pull/19504[#19504]
...
* Fix access method to big tables to avoid materialising the full result set in memory and generate an out-of-memory error. https://github.com/logstash-plugins/logstash-integration-jdbc/pull/204[#204]
