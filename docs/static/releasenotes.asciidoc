...
=== Logstash Pull Requests with label v7.13.3

* Backport PR #13008 to 7.13: Fix UBI source URL https://github.com/elastic/logstash/pull/13012[#13012]

=== Logstash Commits between 7.13 and 7.13.2

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.13.2..7.13"

5e907b77a - (HEAD -> 7.13, origin/7.13) Update patch plugin versions in gemfile lock for 7.13.3 (#13027) (6 hours ago) <Logstash Machine>
f3b1ff0bc - Backport PR #13008 to 7.13: Fix UBI source URL (#13012) (7 days ago) <Rob Bavey>
02b981f04 - Doc: Add tip for checking for existing field (#12988) (2 weeks ago) <Karen Metts>
0998be3aa - bump to 7.13.3 (#12983) (2 weeks ago) <kaisecheng>
f24cf2740 - Release notes draft for 7.13.2 (#12981) (2 weeks ago) <Logstash Machine>
55e1f324c - Doc: Remove unused tagged regions (#12980) (3 weeks ago) <Karen Metts>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.13.2..7.13 *.release"
