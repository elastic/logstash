...
* Logstash now logs a warning and a deprecation notice at startup when running on a JDK older than 21. Support for JDK 17 is deprecated and will be removed in a future release https://github.com/elastic/logstash/pull/19285[#19285]
