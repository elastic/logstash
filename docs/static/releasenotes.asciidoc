...
=== Logstash Commits between 7.8 and 7.7.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.7.0..7.8"

804982e5f - (HEAD -> 7.8, origin/7.8) emit deprecation entry for netflow and azure modules (64 minutes ago) <Joao Duarte>
950329e67 - Introduced JDK environment variable to explicitly pass the JAVA_HOME to use and defined .ci/ with OS and JDK preferences (#11935) (2 days ago) <Andrea Selva>
05b097fc7 - Quieten down kafka teardown script (10 days ago) <Rob Bavey>
fc5d51225 - Doc:Replace cloud trial notice with attribute (11 days ago) <Karen Metts>
fa75aadcf - Doc:Add deprecation notice for azure module (11 days ago) <Karen Metts>
30b7d6fcd - download kafka from another mirror (3 weeks ago) <Joao Duarte>
968a2a2cc - Fix: avoid gsub (frame dependent) usage from Java (3 weeks ago) <Karol Bucek>
0dc71a720 - Performance: improve event.clone memory usage (3 weeks ago) <Karol Bucek>
6378b4949 - Doc:Expand and clarify guidance for jvm settings (3 weeks ago) <Karen Metts>
7319a5dc9 - Update minor plugin versions in gemfile lock for 7.8.0 (#11870) (3 weeks ago) <João Duarte>
8c7fdd8bf - create 7.8 branch from 7.x and add lockfile (3 weeks ago) <Joao Duarte>
2217e3478 - Doc:Rename internal collection to legacy collection (3 weeks ago) <Karen Metts>
18f144431 - RUNNER: print RUBY_DESCRIPTION at startup to facilitate debugging (3 weeks ago) <Joao Duarte>
4b8797bd9 - [doc] missing role for config management integration (#10341) (#11856) (4 weeks ago) <Karen Metts>
8f142fc8b - Update JrJackson and Jackson Databind versions (4 weeks ago) <Rob Bavey>
ba78c05e0 - [7.x] Backport JDK Unit Testing Matrices (#11839) (4 weeks ago) <Rob Bavey>
51431af40 - Added warning message if OperatingSystemMXBean not available (5 weeks ago) <Rob Bavey>
caa40036b - Avoid using deprecated `getSystemCpuLoad` method with JDK14 (5 weeks ago) <Rob Bavey>
62154e0ad - depend on the elasticsearch output plugin >= 10.4.2 (5 weeks ago) <Colin Surprenant>
770d9b271 - remove plugin internal validation call (5 weeks ago) <Colin Surprenant>
c73544f1e - reinstate x-pack.monitoring settings in logstash.yml (5 weeks ago) <Joao Duarte>
65bca0ca6 - Review comments (5 weeks ago) <Karen Metts>
cbc6209b7 - Remove new internal collection (5 weeks ago) <Karen Metts>
5dbe95bfa - Incorporate review comments (5 weeks ago) <Karen Metts>
cf890d0df - Add experimental tags for internal collection (5 weeks ago) <Karen Metts>
beec172e2 - Remove known issue (5 weeks ago) <Karen Metts>
252b71118 - API: avoid starting webserver when `http.enabled=false` (5 weeks ago) <Ry Biesemeyer>
3fbe846b8 - [Doc]Release notes: Add known issue for monitoring settings (#11816) (#11821) (5 weeks ago) <Karen Metts>
c0db7f435 - dont use qualifier or snapshot in logstash core version (5 weeks ago) <Joao Duarte>
3962b05ac - Update benchmark.bat (5 weeks ago) <André Letterer>
5a0e10b2a - Update pqrepair.bat (5 weeks ago) <André Letterer>
9198afd36 - Update pqcheck.bat (5 weeks ago) <André Letterer>
6bbf54ab4 - Update benchmark.bat (5 weeks ago) <André Letterer>
ba89b217e - tools convert to batch files (#11753) (5 weeks ago) <André Letterer>
e06d2195d - settings: deprecate unit-less TimeValue values (6 weeks ago) <Ry Biesemeyer>
59e4ac8b8 - add proxy support (central management & monitoring) (6 weeks ago) <Laurent Huet>
33efbf387 - Update kafka version for integration tests. (6 weeks ago) <Rob Bavey>
8b223093c - Release Notes for 7.7 (continued) (#11762) (#11805) (6 weeks ago) <Karen Metts>
da7de67ed - More review comments (6 weeks ago) <Karen Metts>
7b68aee7f - Incorporate review comments (6 weeks ago) <Karen Metts>
b67ffceb5 - Doc updates for internal collectors (6 weeks ago) <Karen Metts>
ee2d819d4 - Fix: cloud_id not propagating from monitoring config (6 weeks ago) <Karol Bucek>
21b1ef531 - add rootProject.name (6 weeks ago) <Joao Duarte>
54f5ac14f - update guava and httpclient dependencies (6 weeks ago) <Joao Duarte>
28ae8fa21 - Add redirects page (6 weeks ago) <Karen Metts>
6eebf24d5 - Fix typo in pipeline ordered description (6 weeks ago) <Karen Metts>
dfe5cc5ee - Restructure monitoring docs to support new and legacy internal collectors (#11714) (6 weeks ago) <Karen Metts>
ba7fd0ced - Handle Boolean Edges (7 weeks ago) <Rob Bavey>
2e545c75e - Remove separator vertices and associated edges from serialized output (7 weeks ago) <Rob Bavey>
a8fca3c07 - Change plugin name from java_sink to sink (7 weeks ago) <Andres Rodriguez>
73a8808b1 - Update description in logstash.yml (7 weeks ago) <Karen Metts>
3b4dd6c5a - Note that unit qualifier is required for config.reload.interval (7 weeks ago) <Karen Metts>
c00c3da95 - Incorporate review comments (7 weeks ago) <Rob Bavey>
d33195750 - Fix hard coded constraint on pipeline name for metrics (7 weeks ago) <Rob Bavey>
a6c92efef - remove :cluster_uuids gauge (7 weeks ago) <Joao Duarte>
f2701dc70 - performance: share a single secret store (7 weeks ago) <Ry Biesemeyer>
085868595 - release notes script add version in plugin entries (7 weeks ago) <Joao Duarte>
deeede982 - update benchmark cli dependencies (#11766) (7 weeks ago) <João Duarte>
0eb2f54de - Update gradle version to 6.3 (#11742) (#11761) (7 weeks ago) <Rob Bavey>
9b732a2cb - Incorporate review comments (8 weeks ago) <Karen Metts>
0a4aa8b49 - Add guidelines for setting jvm heap size (8 weeks ago) <Karen Metts>
f4b934914 - simplify batch classes, do not compute JE empty batches, refactor RE worker loop (#11746) (8 weeks ago) <Colin Surprenant>
bd7d5b9b0 - Better wording thanks to Andrea Selva (8 weeks ago) <Luca Belluccini>
9d789292f - Clarify behavior in case of PQ full & isolator pattern (8 weeks ago) <Luca Belluccini>
d56a0739d - Refactor: avoid array in case of single event (8 weeks ago) <Karol Bucek>
85f0f87a3 - Update to release notes based on review (9 weeks ago) <Rob Bavey>
448c9c653 - 7.6.2 Release notes (9 weeks ago) <Rob Bavey>
0aae62ace - separate filter & output execution, rebatch after filter when ordered (#11726) (9 weeks ago) <Colin Surprenant>
baf60a984 - Updated: JRuby to 9.2.11.1 (9 weeks ago) <Karol Bucek>
e77a2985c - Start dev cycle for 7.8.0 (9 weeks ago) <andsel>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.7.0..7.8 *.release"
