...
=== Logstash Pull Requests with label v8.19.14

=== Logstash Commits between 8.19 and 8.19.13

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.19.13..8.19"

24786ddb6 - (HEAD -> 8.19, origin/8.19) Upgrade Log4j to 2.25.3 (Manual backport of #18522) (#18943) (2 hours ago) <Rob Bavey>
fcd0e8d4e - Fix comparison of ES SHA, (#18923) (#18929) (4 days ago) <mergify[bot]>
cf9cf67b8 - Update patch plugin versions in gemfile lock (#18920) (6 days ago) <github-actions[bot]>
a940e86c5 - Adds verification of the file name (#18848) (#18908) (10 days ago) <mergify[bot]>
c936e29d9 - [8.19] (backport #18891) Add tests for Oracle Linux 9 (#18901) (11 days ago) <mergify[bot]>
b53460f31 - Bump requests in /.buildkite/scripts/health-report-tests (#18904) (#18905) (11 days ago) <mergify[bot]>
b3762153b - [8.19] (backport #18853) Bump https://github.com/pre-commit/pre-commit-hooks from v4.6.0 to 6.0.0 (#18887) (12 days ago) <mergify[bot]>
8b264bdea - Update patch plugin versions in gemfile lock (#18865) (3 weeks ago) <github-actions[bot]>
e2e85fc1c - Bump logstash version 8.19.14 (#18868) (3 weeks ago) <github-actions[bot]>
1683ce46f - Release notes for 8.19.13 (#18840) (3 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.19.13..8.19 *.release"
Changed plugin versions:
logstash-input-azure_event_hubs: 1.5.4 -> 1.5.5
logstash-input-beats: 6.9.6 -> 6.9.8
logstash-input-http: 3.10.5 -> 3.10.7
logstash-input-tcp: 6.4.9 -> 6.4.11
logstash-integration-elastic_enterprise_search: 3.0.1 -> 3.0.2
logstash-integration-kafka: 11.8.4 -> 11.8.7
logstash-output-http: 5.7.1 -> 5.7.2
...
* Upgrade netty to 4.1.131 https://github.com/logstash-plugins/logstash-input-beats/pull/532[#532]

*Http Input - 3.10.7*

* Update Netty dependency to 4.1.132.Final https://github.com/logstash-plugins/logstash-input-http/pull/213[#213]

* Upgrade netty to 4.1.131 https://github.com/logstash-plugins/logstash-input-http/pull/211[#211]

*Tcp Input - 6.4.11*

* Update Netty dependency to 4.1.132.Final https://github.com/logstash-plugins/logstash-input-tcp/pull/248[#248]

* Upgrade netty to 4.1.131 https://github.com/logstash-plugins/logstash-input-tcp/pull/247[#247]
