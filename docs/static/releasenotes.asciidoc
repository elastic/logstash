...
* Expose xpack.monitoring.elasticsearch.proxy setting as Docker env varible https://github.com/elastic/logstash/pull/12151[#12151]
* add ssl verification_mode to env2yaml https://github.com/elastic/logstash/pull/12162[#12162]
* bump version to 7.9.1 https://github.com/elastic/logstash/pull/12185[#12185]
...
* Docker: Expose xpack.management.elasticsearch.proxy https://github.com/elastic/logstash/pull/12201[#12201]
* fix flushing upon empty batches with ordered execution https://github.com/elastic/logstash/pull/12204[#12204]
* Release notes draft for 7.9.1 https://github.com/elastic/logstash/pull/12212[#12212]
...
fa360cf3f - (HEAD -> 7.9, origin/7.9) Doc:Add redirect from multiline filter to multiline codec (#12208) (#12218) (17 hours ago) <Karen Metts>
ffb96ff99 - Update patch plugin versions in gemfile lock for 7.9.1 (#12210) (3 days ago) <Logstash Machine>
0ce6614e1 - fix flushing upon empty batches with ordered execution (8 days ago) <Colin Surprenant>
75ac8eb23 - Add test for ordered pipeline flushing fix (8 days ago) <Rob Bavey>
dfc7e51c5 - Docker: Expose xpack.management.elasticsearch.proxy (#12201) (9 days ago) <Andres Rodriguez>
933c9fd18 - ensure input plugin close is called upon termination or pipeline reload (13 days ago) <Colin Surprenant>
14dbf65a3 - Expose xpack.monitoring.elasticsearch.proxy setting as Docker env variable (13 days ago) <andsel>
2fde15750 - add ssl verification_mode to env2yaml (13 days ago) <Drew Boswell>
a850489c1 - Doc:Add note that stdin input doesn't allow config reloading (13 days ago) <Karen Metts>
42a1d0dbf - bump jruby to 9.2.13.0 (2 weeks ago) <Joao Duarte>
ded07b0cc - Release notes 7.9.0  (#12179) (2 weeks ago) <Karen Metts>
e8d5c1cfa - bump version to 7.9.1 (#12185) (2 weeks ago) <João Duarte>
