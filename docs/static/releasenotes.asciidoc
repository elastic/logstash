...
* Add system properties to configure Jackson's stream read constraints #15763 https://github.com/elastic/logstash/pull/15763[#15763]
...
* Add https://www.elastic.co/guide/en/logstash/8.12/running-logstash-kubernetes.html[info and link] to {ls} running on a {k8s} cluster through https://www.elastic.co/guide/en/cloud-on-k8s/current/index.html[{eck} (ECK)]  https://github.com/elastic/logstash/pull/15565[#15565]
* Add info for  https://www.elastic.co/guide/en/logstash/current/serverless-monitoring-with-elastic-agent.html[sending {ls] monitoring data to Elastic serverless] https://github.com/elastic/logstash/pull/15636[#15636]
...
* Update https://www.elastic.co/guide/en/logstash/current/introduction.html[Logstash intro] and https://www.elastic.co/guide/en/logstash/current/ls-security.html#serverless[security overview] for serverless https://github.com/elastic/logstash/pull/15663[#15663]
* Update the https://www.elastic.co/guide/en/logstash/8.12/ls-to-ls-native.html#configure-upstream-logstash-output[{ls)-to-{ls} communication] section to reflect the multiple hosts usage https://github.com/elastic/logstash/pull/15512[#15512]
