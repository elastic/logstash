...
TIP: Clear the `JAVA_HOME` environment variable to run Logstash with the bundled JDK. 
This approach is recommended and can help you avoid version incompatibilies. 
