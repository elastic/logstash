...
1ab316ebe - (HEAD -> 6.6, origin/6.6) change 「5.x」→「6.x」 (68 seconds ago) <taku333>
7cb8d471a - Update patch plugin versions in gemfile lock (#10363) (2 hours ago) <Guy Boertje>
ef0d135d9 - qa: allow connections to localhost in webmock (#10384) (6 hours ago) <Ry Biesemeyer>
