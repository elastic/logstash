...
b9581ffaf - (HEAD -> 6.6, origin/6.6) Bump doc version to 6.6.1 (#10473) (85 seconds ago) <Karen Metts>
1ac0815b9 - Release notes draft for 6.6.1 (#10468) (46 minutes ago) <Logstash Machine>
...
3bdc57ac3 - spec: make timing-sensitive specs a little more flexible (13 days ago) <Ry Biesemeyer>
bd6a26615 - spec: noop refactor for clarity - use explicit `metric_input` subject instead of implicit subject - use rspec/wait full expectation syntax instead of be_falsey/be_truthy - eliminate unused shared examples - incorporate single-use shared examples (13 days ago) <Ry Biesemeyer>
5b7f60e9b - agent webserver: synchronise control (13 days ago) <Ry Biesemeyer>
