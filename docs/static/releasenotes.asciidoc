...
* Update JrJackson to 0.4.10 [#11185](https://github.com/elastic/logstash/pull/11185)
* [DOCS] Add note about illegal reflective access [#11152](https://github.com/elastic/logstash/pull/11152)
* [DOCS] Clarify monitoring hosts should not be master-only [#11194](https://github.com/elastic/logstash/pull/11194)
...
* Support string arrays in network setting [#21](https://github.com/logstash-plugins/logstash-filter-cidr/pull/21)
