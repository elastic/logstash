...
=== Logstash Pull Requests with label v8.5.2

=== Logstash Commits between 8.5 and 8.5.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.5.1..8.5"

77b2cd2c0 - (HEAD -> 8.5, origin/8.5) Release notes for 8.5.2 (#14761) (17 minutes ago) <github-actions[bot]>
3e9c94ab1 - Bump version to 8.5.2 (#14751) (6 days ago) <Rob Bavey>
3d80019b8 - Backport PR #14738 to 8.5: [Doc] Document the usage of LS_JAVA_OPTS environment variable #14749 (6 days ago) <github-actions[bot]>
230d3e355 - Release notes for 8.5.1 (#14745) (7 days ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.5.1..8.5 *.release"
