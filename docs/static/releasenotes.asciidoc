...
=== Logstash Commits between 7.14 and 7.13.4

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.13.4..7.14"

fa4f8f15b - (HEAD -> 7.14, origin/7.14) Forward port of release notes for 7.13.3 and 7.13.4 to 7.14 (#13085) (24 minutes ago) <Andrea Selva>
433f558ad - plugins: bump patch + kafka's minor for 7.14 release (#13081) (27 hours ago) <Ry Biesemeyer>
53e3f62be - bump patch level dependencies (#13078) (4 days ago) <Ry Biesemeyer>
ebd1d9f26 - Backport PR #13071 to 7.14: [Test] Fix Unix acceptance tests (#13075) (6 days ago) <Rob Bavey>
a0778c531 - Doc: Include Windows and Unix commands to run basic pipeline (#13063) (11 days ago) <Karen Metts>
26c4eb936 - Docs: keep elastic_app_search output meta-data (#13048) (#13055) (13 days ago) <Karol Bucek>
6b6bafe2f - Emergency revert for 7.14 (#13043) (3 weeks ago) <Andrea Selva>
674d30d0b - update lockfile for 7.14.0 (#13034) (3 weeks ago) <João Duarte>
825d70640 - add lockfile based on 7.13 branch (3 weeks ago) <Joao Duarte>
c08198578 - Add unit test to grant that production aliases correspond to a published RubyGem (#12993) (#13009) (3 weeks ago) <Andrea Selva>
c30559269 - Feat: event factory support (#13017) (#13025) (3 weeks ago) <Karol Bucek>
a5f343401 - Doc: Add geoip database API to node stats (#13024) (4 weeks ago) <Karen Metts>
561646223 - Add geoip database metrics to /node/stats API (#13004) (#13020) (4 weeks ago) <kaisecheng>
873e2c739 - Backport PR #12830 to 7.x: ecs-compatibility docs (#13016) (4 weeks ago) <Ry Biesemeyer>
6d3446d26 - Backport PR #13008 to 7.x: Fix UBI source URL (#13011) (4 weeks ago) <Rob Bavey>
4dcc69d97 - ispec: fix cross-spec leak from fatal error integration specs (#13002) (#13013) (4 weeks ago) <Ry Biesemeyer>
2c84a5d67 - Fix logstash.bat not setting exit code (#12948) (#13007) (4 weeks ago) <Andrea Selva>
75d616eba - Use the OS separator to invoke gradlew from Rake script (#13000) (#13006) (4 weeks ago) <Andrea Selva>
1059bd91f - Fix Reflections stack traces when process yml files in classpath and debug is enabled (#12991) (#13003) (5 weeks ago) <Andrea Selva>
db726ab6f - Fix/log4j routing to avoid create spurious file (#12965) (#12999) (5 weeks ago) <Andrea Selva>
f063d86c3 - Added test to cover the installation of aliased plugins (#12967) (#12998) (5 weeks ago) <Andrea Selva>
138b60c83 - Explicitate the type of log format in appender's names (#12964) (#12997) (5 weeks ago) <Andrea Selva>
adcb0da91 - Fix acceptance test when run artifact:all (#12975) (#12996) (5 weeks ago) <Andrea Selva>
72e8dc8d9 - fix database manager with multiple pipelines (#12862) (#12995) (5 weeks ago) <kaisecheng>
854fad633 - Avoid hard-coded plugin alias definitions (#12841) (#12960) (5 weeks ago) <Andrea Selva>
35ce0eed1 - [7.x] Deps: update JRuby to 9.2.19.0 (#12989) (#12990) (5 weeks ago) <Karol Bucek>
7d4b2ff31 - Doc: Add tip for checking for existing field  (#12987) (5 weeks ago) <Karen Metts>
d0d4cae73 - Release notes draft for 7.13.2 to 7.x (#12982) (5 weeks ago) <Karen Metts>
9997cee38 - Doc: Remove unused tagged regions (#12979) (6 weeks ago) <Karen Metts>
419b1dc98 - Backport PR #12791 to 7.x: Deps: update JRuby to 9.2.18.0 (#12971) (6 weeks ago) <Karol Bucek>
9cf722d30 - Test: handle a RGs warning from packing output (#12974) (6 weeks ago) <Karol Bucek>
adb7f678e - Backport PR #12962 Fix dependency on plugin_alias.yml during `rake artifacts:all` (#12963) (7 weeks ago) <Andrea Selva>
d9e21549c - Refactoring of JavaKeyStore.getKeyStorePassword method to simplify if conditions (#12952) (#12961) (7 weeks ago) <Andrea Selva>
6766a8782 - Release notes for 7.13.1 (#12946) (#12957) (7 weeks ago) <kaisecheng>
f93b30cca - Use the JVM specified in the CI matrix environment also to run spawned proccesses (#12945) (#12953) (7 weeks ago) <Andrea Selva>
0a1bb2fd0 - Internal: Update messaging in release notes script (#12949) (#12950) (8 weeks ago) <Karen Metts>
f0ba6ea5c - Backport PR #12925 to 7.x: Add logstash-integration-elastic_enterprise_search to plugins-metadata.json (#12934) (8 weeks ago) <Rob Bavey>
5ff415c49 - Doc: Expand definition and fix typo(#12937) (8 weeks ago) <Karen Metts>
270616f34 - Forwardport release notes for 7.13.0 to 7.x branch  (#12932) (8 weeks ago) <Karen Metts>
ec8d182eb - Geoip disable database manager (#12905) (#12906) (10 weeks ago) <kaisecheng>
f8551a05c - Update bundled JDK to 11.0.11+9 (#12881) (#12882) (10 weeks ago) <Andrea Selva>
7f934db2c - fix ubi8 docker image creation by skipping yum clean metadata (#12902) (#12903) (10 weeks ago) <João Duarte>
e5e41f85c - [backport 7.x] [Build] On aarch64 docker build, install `noarch` version of bind-license first (#12891) (#12900) (10 weeks ago) <Rob Bavey>
4f58cb3bf - Doc: Update contributing steps and guidelines (#12895) (2 months ago) <Karen Metts>
3b552afeb - Comment out config examples that no longer work (#12892) (2 months ago) <Karen Metts>
6a338c675 - Geoip use cc indefinitely (#12888) (#12889) (2 months ago) <kaisecheng>
68b8fd3a4 - change download path for geoip plugin (#12863) (#12875) (2 months ago) <kaisecheng>
b33692e41 - Update elasticsearch gem dependency requirements (#11258) (#12874) (3 months ago) <Andrea Selva>
5287e7740 - Change Gradle's :logstash-integration-tests:integrationTests task to depends on copyES (#12847) (#12868) (3 months ago) <Andrea Selva>
6c0f3c602 - Doc: Keystore must be accessible to logstash user (#12864) (3 months ago) <Karen Metts>
44493835c - bump core version to 7.14.0 (#12839) (3 months ago) <kaisecheng>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.13.4..7.14 *.release"
Changed plugin versions:
logstash-filter-csv: 3.0.10 -> 3.1.1
logstash-filter-fingerprint: 3.2.4 -> 3.3.2
...
logstash-input-beats: 6.1.5 -> 6.1.6
...
logstash-integration-jdbc: 5.0.7 -> 5.1.4
logstash-integration-elastic_enterprise_search: 2.1.2 -> 2.1.2
logstash-integration-kafka: 10.7.6 -> 10.8.1
...
* Improve robustness when handling errors from `sequel` library in jdbc static and streaming
    filtershttps://github.com/logstash-plugins/logstash-integration-jdbc/pull/78[#78]
...
* Added config setting to enable schema registry validation to be skipped when an authentication scheme unsupported
    by the validator is used https://github.com/logstash-plugins/logstash-integration-kafka/pull/97[#97]
