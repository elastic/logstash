...
=== Logstash Pull Requests with label v8.19.8

=== Logstash Commits between 8.19 and 8.19.7

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.19.7..8.19"

26286bc92 - (HEAD -> 8.19, origin/8.19) Update patch plugin versions in gemfile lock (#18445) (16 hours ago) <github-actions[bot]>
617da753a - [8.19] (backport #18426) bump: ubi 9.7 (#18432) (8 days ago) <mergify[bot]>
365a93c4a - Bump logstash version 8.19.8 (#18419) (2 weeks ago) <github-actions[bot]>
8c43cd3b7 - Release notes for 8.19.7 (#18406) (2 weeks ago) <github-actions[bot]>
a62e0d880 - Ensure java updator runs on all active branches (#18408) (#18410) (3 weeks ago) <mergify[bot]>
7eae56c08 - [8.19] (backport #18375) Use logstash-versions.yml for observabilitySRE stack versions (#18400) (3 weeks ago) <mergify[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.19.7..8.19 *.release"
