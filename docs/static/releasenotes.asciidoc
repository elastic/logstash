...
* Backport PR #16339 to 8.15: settings: add support for observing settings after post-process hooks https://github.com/elastic/logstash/pull/16348[#16348]
...
46b996c24 - (HEAD -> 8.15, origin/8.15) settings: add support for observing settings after post-process hooks (#16339) (#16348) (29 hours ago) <github-actions[bot]>
b6bf12d86 - Doc: Reposition worker-utilization in doc (#16335) (#16337) (6 days ago) <github-actions[bot]>
4f34601a4 - correctly handle stack overflow errors during pipeline compilation (#16323) (#16336) (7 days ago) <github-actions[bot]>
3624a82c5 - Update major plugin versions in gemfile lock for 8.15.0 (#16330) (8 days ago) <github-actions[bot]>
e99e5bc82 - regenerate webserver test certificates (#16331) (#16333) (8 days ago) <github-actions[bot]>
bbfc9279c - Release notes for 8.14.3 (#16312) (#16321) (2 weeks ago) <github-actions[bot]>
aef289ce9 - Remove Debian 10 from CI (#16300) (#16317) (2 weeks ago) <github-actions[bot]>
eae379b6d - Add Ubuntu 24.04 to CI (#16299) (#16302) (2 weeks ago) <github-actions[bot]>
2c926c240 - Remove CentOS 7 from CI (#16293) (#16296) (3 weeks ago) <github-actions[bot]>
5d3d3fe8c - Release notes for 8.14.2 (#16266) (#16285) (3 weeks ago) <Ry Biesemeyer>
447cacec6 - add flow-informed tuning guidance (#16265) (#16289) (3 weeks ago) <github-actions[bot]>
9572a6bdb - Update plugin versions in gemfile lock (#16283) (3 weeks ago) <github-actions[bot]>
86af05753 - Add base lock file for 8.15.0 (3 weeks ago) <João Duarte>
121b1c963 - update jruby to 9.4.8.0 (#16278) (3 weeks ago) <João Duarte>
a046d3f27 - Revert "add ubuntu 24.04 to CI (#16263)" (#16279) (3 weeks ago) <João Duarte>
a0bcd61ad - add ubuntu 24.04 to CI (#16263) (3 weeks ago) <João Duarte>
7080ec542 - Add retries to aarch64 CI pipeline (#16271) (3 weeks ago) <Dimitrios Liappis>
095733c40 - Doc: Add ecs and datastream requirement for intg filter (#16268) (4 weeks ago) <Karen Metts>
784fa186c - Ensure pipeline metrics are cleared on the pipeline shutdown (#16264) (4 weeks ago) <Edmo Vamerlatti Costa>
0cfe6b080 - Add `RubyEvent#dup` support and unit test case to keep `Json#dump(Event)` safe. (#16255) (4 weeks ago) <Mashhur>
0e1d67eda - produce wolfi docker image in ci (#16252) (4 weeks ago) <João Duarte>
bc0b9556b - Add quotes to fix path handling in pqcheck.bat (#16205) (4 weeks ago) <Alex S>
e6682c94b - Pin fileutils version to 1.7+ (#16250) (4 weeks ago) <Mashhur>
0ec16ca39 - Unicode pipeline and plugin ids (#15971) (4 weeks ago) <Ry Biesemeyer>
440aa98e4 - [CI] Benchmark pipeline (#16191) (5 weeks ago) <kaisecheng>
92909cb1c - json: remove unnecessary dup/freeze in serialization (#16213) (5 weeks ago) <Ry Biesemeyer>
ca1403009 - Forwardport PR #16212 to main: Release notes for 8.14.1 (#16214) (5 weeks ago) <github-actions[bot]>
321e407e5 - Avoid to log file not found errors when DLQ segments are removed concurrently between writer and reader. (#16204) (5 weeks ago) <Andrea Selva>
ed930f820 - Avoid mocking the value returned in global SETTINGS constant. (#16245) (5 weeks ago) <Andrea Selva>
0d385a961 - Update pull-requests.json (#16220) (5 weeks ago) <ev1yehor>
13a8c4f1a - remove version pinning from rexml (#16224) (5 weeks ago) <João Duarte>
801f0f441 - Geoip database management cache invalidation (#16222) (5 weeks ago) <Ry Biesemeyer>
148461440 - Wolfi-based image flavor (#16189) (5 weeks ago) <João Duarte>
0f6fa5c8f - p2p: adds opt-in pipeline bus with less synchronization (#16194) (5 weeks ago) <Ry Biesemeyer>
fab345881 - Introduce filesystem signalling from DLQ read to writer to update byte size metric accordingly when the reader uses `clean_consumed` (#16195) (5 weeks ago) <Andrea Selva>
948a0edf1 - Logstash monitoring doc improvements. (#16208) (6 weeks ago) <Mashhur>
7f424c1f5 - Update logstash_releases.json to account for 7.17.22 (#16185) (6 weeks ago) <João Duarte>
881f7605f - Bump logstash-releases.json after 8.14.1 release (#16217) (6 weeks ago) <Edmo Vamerlatti Costa>
23221cadd - Pin rexml gem version to 3.2.6 (#16209) (6 weeks ago) <Edmo Vamerlatti Costa>
efa83787a - Revert PR #16050 (7 weeks ago) <Andrea Selva>
70d0f1d02 - Release notes for 8.14.0 (#16155) (#16198) (7 weeks ago) <github-actions[bot]>
14afa851d - Bump `logstash-releases.json` after 8.14.0 release (#16197) (7 weeks ago) <Rob Bavey>
5c7d41679 - Update log4j rollover to configure time retention (#16179) (7 weeks ago) <Andrea Selva>
d0606ff09 - Bundle logstash-integration-snmp and remove input-snmp and input-snmptrap as default (#16180) (7 weeks ago) <Edmo Vamerlatti Costa>
e2acb4d6b - Add incomplete integration plugins to metadata.json as skip (#16174) (8 weeks ago) <Karen Metts>
1d4038b27 - Add initial buildkite pipeline for Benchmark (#16190) (8 weeks ago) <kaisecheng>
2a7f05975 - Upgrade jrjackson to 0.4.20 (#16153) (9 weeks ago) <João Duarte>
ea930861e - PQ: avoid blocking writer when precisely full (#16176) (9 weeks ago) <Ry Biesemeyer>
d0bdc33fa - Regenerate dependencies report and add strscan. (#16169) (10 weeks ago) <Mashhur>
73fb21b4a - Update plugins-metadata.json (#16137) (10 weeks ago) <Karen Metts>
979d30d70 - Handle non-unicode payload in Logstash. (#16072) (2 months ago) <Mashhur>
53d948017 - [DOC] Remove reference to puppet LS module (#12356) (2 months ago) <Luca Belluccini>
439fbebe2 - Update catalog-info.yaml to properly define dependencies type. (#16163) (2 months ago) <Mashhur>
977ef89a7 - Updated to 21.0.3+9 (#16055) (2 months ago) <Andrea Selva>
f781578c3 - Update catalog-info.yaml (#16161) (2 months ago) <Andres Rodriguez>
734405dcb - Replace stack traces with logger in DSL. (#16159) (2 months ago) <Mashhur>
2eebfd8f0 - Adds section to describe intended usage of `pipeline.buffer.type` (#16083) (2 months ago) <Andrea Selva>
...
830733d75 - (origin/8.10.2) Provide opt-in flag to avoid fields name clash when log format is json (#15969) (3 months ago) <Andrea Selva>
6bf1f80a8 - bump version to 8.15.0 (#16088) (3 months ago) <kaisecheng>
f4d33cb90 - add 8.14 branch for ci (#16086) (3 months ago) <kaisecheng>
cb45cd28c - Doc: Remove include statements for screenshots not rendering properly (#15981) (3 months ago) <Karen Metts>
...
logstash-integration-aws: 7.1.6 -> 7.1.7
logstash-integration-kafka: 11.4.2 -> 11.5.0
