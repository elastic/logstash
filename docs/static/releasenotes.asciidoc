...
=== Logstash Pull Requests with label v8.11.1

* Fixed functional test in case the LS_JAVA_HOME is configured https://github.com/elastic/logstash/pull/15535[#15535]
* [ci] JDK matrix Buildkite pipelines (part 1) https://github.com/elastic/logstash/pull/15539[#15539]
* Backport PR #15539 to 8.11: [ci] JDK matrix Buildkite pipelines (part 1) https://github.com/elastic/logstash/pull/15555[#15555]
* Backport PR #15535 to 8.11: Fixed functional test in case the LS_JAVA_HOME is configured https://github.com/elastic/logstash/pull/15558[#15558]
* [ci] JDK matrix Buildkite pipelines (pt 2/Windows) https://github.com/elastic/logstash/pull/15563[#15563]

=== Logstash Commits between 8.11 and 8.11.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.11.0..8.11"

a233e9273 - (HEAD -> 8.11, origin/8.11) [ci] JDK matrix Buildkite pipelines (part 1) (#15539) (#15555) (3 days ago) <github-actions[bot]>
c911c7565 - Fixed functional test in case the LS_JAVA_HOME is configured (#15535) (#15558) (3 days ago) <github-actions[bot]>
ed3b2724d - downgrade jackson until #15405 is fixed (#15549) (5 days ago) <João Duarte>
3b3c2a81a - Bump version to 8.11.1 (#15542) (6 days ago) <Mashhur>
05125cc00 - [ci] Split JDK matrix pipelines per OS (#15534) (#15536) (6 days ago) <github-actions[bot]>
d4715a36c - Release notes for 8.11.0 (#15465) (6 days ago) <github-actions[bot]>
83f4f0bbc - [ci] Initial JDK matrix Buildkite pipeline (#15520) (#15521) (11 days ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.11.0..8.11 *.release"
