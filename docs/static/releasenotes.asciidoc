...
=== Logstash Pull Requests with label v8.4.3

=== Logstash Commits between 8.4 and 8.4.2

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.4.2..8.4"

5fd2b3395 - (HEAD -> 8.4, origin/8.4) bump to 8.4.3 (#14536) (7 days ago) <João Duarte>
679d4dc02 - Release notes for 8.4.2 (#14531) (7 days ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.4.2..8.4 *.release"
