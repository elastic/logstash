...
As described in the <<known-pipeline-slowdown,7.8.0 release notes>>*, a performance regression was introduced in 7.7.0.
The issue was found to be caused by an enhancement - https://github.com/elastic/logstash/pull/11078[#11078] - that included the plugin ids in log entries produced by Logstash pipelines.
The implementation of this feature has been adapted to not cause the performance issue, you can find more about the solution here https://github.com/elastic/logstash/pull/12038[#12038].
