...
* Handle non-unicode payload in Logstash. https://github.com/elastic/logstash/pull/16072[#16072] - 8.14.1
* Ensure pipeline metrics are cleared on the shutdown https://github.com/elastic/logstash/pull/16264[#16264] - 8.14.3
* 0ec16ca39 - Unicode pipeline and plugin ids (#15971) (4 weeks ago) <Ry Biesemeyer> - 8.14.2
* 801f0f441 - Geoip database management cache invalidation (#16222) (5 weeks ago) <Ry Biesemeyer> - 8.14.2
...
* 8e8a5b08d - Updated target and source Java definitions in build.gradle because deprecated and planned for removal in next major (#16156) (3 months ago) <Andrea Selva>
* 23221cadd - Pin rexml gem version to 3.2.6 (#16209) (6 weeks ago) <Edmo Vamerlatti Costa>

[[docs-8.15.0]]
==== Documentation enhancements

* Logstash https://www.elastic.co/guide/en/logstash/current/monitoring-with-ea.html[monitoring doc] improvements https://github.com/elastic/logstash/pull/16208[#16208] 
* Add ecs and datastream requirement for https://www.elastic.co/guide/en/logstash/8.15/ea-integrations.html#es-tips[integration filter] https://github.com/elastic/logstash/pull/16268[#16268] 
* Remove reference to puppet {ls} module https://github.com/elastic/logstash/pull/12356[#12356]
* Add section to describe intended usage of https://www.elastic.co/guide/en/logstash/master/jvm-settings.html#reducing-off-heap-usage[`pipeline.buffer.type`] https://github.com/elastic/logstash/pull/16083[#16083] 
* Reposition https://www.elastic.co/guide/en/logstash/master/node-stats-api.html#pipeline-stats[worker-utilization] for better placement and flow https://github.com/elastic/logstash/pull/16337[#16337]
