...
* Fix an issue where ssl verification mode was not being used correctly with stack monitoring using internal collection https://github.com/elastic/logstash/pull/12749[#12749]
