...
=== Logstash Pull Requests with label v7.14.2

* Update bundled JDK to 11.0.12+7 https://github.com/elastic/logstash/pull/13185[#13185]
* Bump plugins for 7.14.2 release https://github.com/elastic/logstash/pull/13219[#13219]

=== Logstash Commits between 7.14 and 7.14.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.14.1..7.14"

e495e0c42 - (HEAD -> 7.14, origin/7.14) Bump plugins for 7.14.2 release (#13219) (25 hours ago) <Andrea Selva>
eb410a83b - [backport 7.14] Added rexml notice to license list (#13209) (#13220) (26 hours ago) <Andrea Selva>
0b5bbe1dc - Update bundled JDK to 11.0.12+7 (#13185) (#13187) (13 days ago) <Andrea Selva>
bfd363a0d - Bump 7.14.2 (#13191) (2 weeks ago) <Andrea Selva>
f653b47dd - Release notes for 7.14.1 (#13174) (2 weeks ago) <Logstash Machine>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.14.1..7.14 *.release"
Changed plugin versions:
logstash-filter-dissect: 1.2.0 -> 1.2.1
logstash-filter-mutate: 3.5.2 -> 3.5.3
logstash-input-tcp: 6.2.0 -> 6.2.1
logstash-output-elasticsearch: 11.0.3 -> 11.0.5
