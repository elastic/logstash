...
=== Logstash Pull Requests with label v8.2.3
...
* Backport PR #14197 to 8.2: Remove startup.options and system-install docs https://github.com/elastic/logstash/pull/14202[#14202]
* Backport PR #14098 to 8.2. Switch adoptopenjdk url to adoptium https://github.com/elastic/logstash/pull/14224[#14224]
* Backport PR #14152 to 8.2: update jdk to 11.0.15+10 https://github.com/elastic/logstash/pull/14225[#14225]
* bump lock file for 8.2 https://github.com/elastic/logstash/pull/14231[#14231]

=== Logstash Commits between 8.2 and 8.2.3

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.2.3..8.2"

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.2.3..8.2 *.release"
