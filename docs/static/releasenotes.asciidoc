...
=== Logstash Pull Requests with label v7.17.6

* Support ironbank docker build https://github.com/elastic/logstash/pull/14298[#14298]
* Fix broken link to image on docs https://github.com/elastic/logstash/pull/14317[#14317]
* Fix artifact path for integration with ubireleaser https://github.com/elastic/logstash/pull/14319[#14319]
* Backport PR #14319 to 7.17: Fix artifact path for integration with ubireleaser https://github.com/elastic/logstash/pull/14320[#14320]
* Fix broken link to image https://github.com/elastic/logstash/pull/14343[#14343]
* Backport PR #14343 to 7.17: Fix broken link to image https://github.com/elastic/logstash/pull/14344[#14344]
* pin bundler 2.3.18 to avoid bug in .19 https://github.com/elastic/logstash/pull/14394[#14394]
* Backport PR #14394 to 7.17: pin bundler 2.3.18 to avoid bug in .19 https://github.com/elastic/logstash/pull/14404[#14404]
* bump jdk to 11.0.16+8 https://github.com/elastic/logstash/pull/14430[#14430]
* update flores dependency to at least 0.0.8 https://github.com/elastic/logstash/pull/14437[#14437]
* remove sinatra constraint https://github.com/elastic/logstash/pull/14446[#14446]
* Backport PR #14437 to 7.17: update flores dependency to at least 0.0.8 https://github.com/elastic/logstash/pull/14449[#14449]
* Backport PR #14446 to 7.17: remove sinatra constraint https://github.com/elastic/logstash/pull/14451[#14451]

=== Logstash Commits between 7.17 and 7.17.5

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.17.5..7.17"

780cefc82 - (HEAD -> 7.17, origin/7.17) bump lock file for 7.17 (#14461) (2 minutes ago) <github-actions[bot]>
2bf294f29 - remove sinatra constraint (#14446) (#14451) (5 days ago) <github-actions[bot]>
ee24f3ce3 - update flores dependency to at least 0.0.8 (#14437) (#14449) (6 days ago) <github-actions[bot]>
b7344f43e - bump jdk to 11.0.16+8 (#14430) (11 days ago) <João Duarte>
44b1913a1 - pin bundler 2.3.18 to avoid bug in .19 (#14394) (#14404) (3 weeks ago) <github-actions[bot]>
c8419c209 - Fix broken link to image (#14343) (#14344) (6 weeks ago) <github-actions[bot]>
a7ad66015 - Fix artifact path for integration with ubireleaser (#14319) (#14320) (8 weeks ago) <github-actions[bot]>
7f9b477ba - Support ironbank docker build (#14298) (#14306) (8 weeks ago) <github-actions[bot]>
6f0bcb45d - Bump for 7.17.6 (#14309) (8 weeks ago) <Ry Biesemeyer>
8fe63b388 - Release notes for 7.17.5 (#14303) (8 weeks ago) <Logstash Machine>
c9b3046f3 - make retries in pip and go get extra shell compatible (#14282) (#14294) (8 weeks ago) <github-actions[bot]>
054f53edd - improve resiliency of make venv and golang Dockerfile with retries (#14239) (#14277) (8 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.17.5..7.17 *.release"
Changed plugin versions:
logstash-filter-date: 3.1.14 -> 3.1.15
...
logstash-patterns-core: 4.3.3 -> 4.3.4
...
* Fixes read mode to restart the read from reference stored in sincedb in case the file wasn't completely consumed. https://github.com/logstash-plugins/logstash-input-file/pull/307[#307]
...
* Fix: typo in CISCOFW302013_302014_302015_302016 grok pattern https://github.com/logstash-plugins/logstash-patterns-core/pull/313[#313]
