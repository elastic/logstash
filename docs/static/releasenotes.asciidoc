...
=== Logstash Pull Requests with label v8.4.1

* [Doc] add off-heap memory session https://github.com/elastic/logstash/pull/14431[#14431]

=== Logstash Commits between 8.4 and 8.4.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.4.0..8.4"

80eb94703 - (HEAD -> 8.4, origin/8.4) Bump lockfile for 8.4.1 (#14471) (8 hours ago) <Rob Bavey>
eb440f802 - Doc: Update release notes with security notice [8.4] (#14468) (13 hours ago) <Karen Metts>
c1183c5bd - Bump version to 8.4.1 (#14465) (18 hours ago) <Rob Bavey>
935bc2b21 - Release notes for 8.4.0 (#14458) (29 hours ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.4.0..8.4 *.release"
Changed plugin versions:
logstash-input-beats: 6.4.0 -> 6.4.1
