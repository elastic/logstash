...
* Some work and improvements on Docker images, were added RedHat UBI license information and some fixes to pass RedHat docker image certification.
  Now UBI8 (Universal Base Image) images are created. Improved acceptance tests for Docker and added integration tests for the same
  https://github.com/elastic/logstash/pull/12248[#12248] https://github.com/elastic/logstash/pull/12296[#12296].
...
* Changed DLQ writer policy to avoid the possibility of the DLQ reader reading an incomplete DLQ segment. Now the writer
  output to a temporary file, renamed on completion https://github.com/elastic/logstash/pull/12304[#12304]
