...
* Upgraded JRuby and updated the CSV gem fix a thread leak issue in Logstash 8.4.0 when using the CSV filter https://github.com/elastic/logstash/pull/14508[#14508] https://github.com/elastic/logstash/pull/14526[#14526]
...
* Added documentation for interfacing Winlogbeat with Logstash, which you can see https://www.elastic.co/guide/en/logstash/8.4/winlogbeat-modules.html[here] https://github.com/elastic/logstash/pull/14512[#14512]
