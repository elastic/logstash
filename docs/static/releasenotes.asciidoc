...
=== Logstash Pull Requests with label v8.16.4
...
* Backport PR #16955 to 8.16: fix user and password detection from environment's uri https://github.com/elastic/logstash/pull/16957[#16957]
* [Backport 8.16] Reimplement LogStash::String setting in Java (#16559)  https://github.com/elastic/logstash/pull/16961[#16961]
* Backport PR #16938 to 8.16: remove irrelevant warning for internal pipeline https://github.com/elastic/logstash/pull/16964[#16964]
...
* Backport PR #16899 to 8.16: plugin manager: add `--level=[major|minor|patch]` (default: `minor`) https://github.com/elastic/logstash/pull/16975[#16975]
* Backport PR #16902 to 8.16: [doc] fix the necessary privileges of central pipeline management https://github.com/elastic/logstash/pull/16976[#16976]
* Use centralized version qualifier https://github.com/elastic/logstash/pull/16995[#16995]
* Backport PR #16995 to 8.16: Use centralized version qualifier https://github.com/elastic/logstash/pull/17004[#17004]
* Backport PR #16968 to 8.16: Fix BufferedTokenizer to properly resume after a buffer full condition respecting the encoding of the input string https://github.com/elastic/logstash/pull/17021[#17021]

=== Logstash Commits between 8.16 and 8.16.3

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.16.3..8.16"

3a35abc24 - (HEAD -> 8.16, origin/8.16) bump lock file for 8.16 (#17023) (2 days ago) <github-actions[bot]>
002d4897c - Backport PR #16968 to 8.16: Fix BufferedTokenizer to properly resume after a buffer full condition respecting the encoding of the input string (#16968) (#17021) (3 days ago) <github-actions[bot]>
32e6def9f - Upgrade JDK to 21.0.6+7 (#16990) (8 days ago) <João Duarte>
4e87a30c1 - Validate the size limit in BufferedTokenizer. (#16882) (#16892) (9 days ago) <Mashhur>
589f1b652 - plugin manager: add `--level=[major|minor|patch]` (default: `minor`) (#16899) (#16975) (10 days ago) <github-actions[bot]>
430424aac - [doc] fix the necessary privileges of central pipeline management (#16902) (#16976) (10 days ago) <github-actions[bot]>
5ead3a988 - add openssl command to wolfi image (#16972) (10 days ago) <kaisecheng>
baa181ae3 - remove irrelevant warning for internal pipeline (#16938) (#16964) (11 days ago) <github-actions[bot]>
ed38254f4 - [Backport 8.x] Reimplement LogStash::String setting in Java (#16576) (#16959) (#16961) (11 days ago) <Andrea Selva>
1adecfe3b - fix user and password detection from environment's uri (#16955) (#16957) (11 days ago) <github-actions[bot]>
f2a7b3022 - Increase Xmx used by JRuby during Rake execution to 4Gb (#16911) (#16944) (2 weeks ago) <github-actions[bot]>
15e4e2504 - Backport 16907 to 8.16: Use --qualifier in release manager (#16907) #16942 (2 weeks ago) <Dimitrios Liappis>
2a4eb2da0 - Doc: Remove extra symbol to fix formatting error (#16926) (#16936) (2 weeks ago) <github-actions[bot]>
7f19931c7 - fix jars installer for new maven and pin psych to 5.2.2 (#16919) (#16925) (2 weeks ago) <github-actions[bot]>
3ac74007f - bump core 8.16.4 (#16915) (3 weeks ago) <kaisecheng>
a3f7aece2 - Release notes for 8.16.3 (#16879) (3 weeks ago) <github-actions[bot]>
946c78c94 - Initialize flow metrics if pipeline metric.collect params is enabled. (#16881) (#16889) (4 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.16.3..8.16 *.release"
Changed plugin versions:
logstash-filter-elastic_integration: 8.16.0 -> 8.16.1
