...
=== Logstash Pull Requests with label v8.19.12

=== Logstash Commits between 8.19 and 8.19.11

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.19.11..8.19"

8054df790 - (HEAD -> 8.19, origin/8.19) Test rpm and deb packages on aarch64 in exhaustive test pipeline (#18780) (#18793) (11 hours ago) <mergify[bot]>
c8f1a166b - Update patch plugin versions in gemfile lock (#18789) (14 hours ago) <github-actions[bot]>
e5e1e4554 - Update patch plugin versions in gemfile lock (#18779) (2 days ago) <github-actions[bot]>
a76257483 - Avoid duplicate steps in snyk artifact scanning (#18768) (#18774) (2 days ago) <mergify[bot]>
b5f9acbd9 - Updated Faraday (#18762) (3 days ago) <Andrea Selva>
a525f3ee9 - bk(comment-trigger): support case insensitive (#18737) (#18772) (3 days ago) <mergify[bot]>
96f403521 - Update march_hare gem to version 4.8.0-java (#18756) (11 days ago) <João Duarte>
01fc12b50 - Use updated copyAllJdks task for ubi8 (#18751) (2 weeks ago) <Cas Donoghue>
7ccf303a2 - [8.19] (backport #18733) Respect ARCH env var when downloading JDK via gradle (#18748) (2 weeks ago) <mergify[bot]>
c209cc110 - [CI] Sync acceptance test OS matrix with JDK matrix pipeline (#18739) (#18742) (2 weeks ago) <mergify[bot]>
882d0b159 - Add aarch64 known issue for 8.19.11 (#18732) (2 weeks ago) <Rob Bavey>
14cb4da4e - Use redhat ubi-8 instead of elastic hosted (#18723) (2 weeks ago) <Cas Donoghue>
120824dfa - Clarify input param to bump LS version GHA (#18715) (#18725) (2 weeks ago) <mergify[bot]>
f54fd9031 - Add Debian 13 to linux matrix (#18698) (#18716) (2 weeks ago) <mergify[bot]>
7ac3516a4 - [8.19] (backport #18557) Add Snyk scanning for Logstash release artifacts (#18687) (2 weeks ago) <mergify[bot]>
400504d90 - Bump 8.19.12 (#18705) (2 weeks ago) <Andrea Selva>
57ebb74d8 - Fix obserbabilitySRE DRA jobs after docker update on runners (#18699) (#18700) (3 weeks ago) <mergify[bot]>
0b4dbaf08 - Release notes for 8.19.11 (#18677) (3 weeks ago) <github-actions[bot]>
c5105fd13 - Ensure jruby managed with gradle bootstrap is used everywher in CI (#18676) (#18684) (3 weeks ago) <mergify[bot]>
49718d518 - Fix smart exhaustive test pipeline (#18661) (#18681) (3 weeks ago) <mergify[bot]>
b6d4668b1 - Bump requests in /.buildkite/scripts/health-report-tests (#17702) (#18672) (3 weeks ago) <mergify[bot]>
220f35697 - Only raise PR to bump java version when all artifacts are ready (#18668) (#18669) (3 weeks ago) <mergify[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.19.11..8.19 *.release"
...
* Fix: replace deprecated `File.exists?` with `File.exist?` for Ruby 3.4 (JRuby 10) compatibility https://github.com/logstash-plugins/logstash-codec-collectd/pull/36[#36]

*Netflow Codec - 4.3.4*

* Fix: replace deprecated `File.exists?` with `File.exist?` for Ruby 3.4 (JRuby 10) compatibility https://github.com/logstash-plugins/logstash-codec-netflow/pull/215[#215]

*Date Filter - 3.1.16*

* Re-packaging the plugin https://github.com/logstash-plugins/logstash-filter-date/pull/163[#163]

*Dissect Filter - 1.2.6*

* Re-packaging the plugin https://github.com/logstash-plugins/logstash-filter-dissect/pull/93[#93]
* Removed `jar-dependencies` dependency https://github.com/logstash-plugins/logstash-filter-dissect/pull/91[#91]
  

*Geoip Filter - 7.3.4*

* Fix: replace deprecated `File.exists?` with `File.exist?` for Ruby 3.4 (JRuby 10) compatibility https://github.com/logstash-plugins/logstash-filter-geoip/pull/239[#239]

* Re-packaging the plugin https://github.com/logstash-plugins/logstash-filter-geoip/pull/236[#236]

*Grok Filter - 4.4.4*

* Fix: replace deprecated `File.exists?` with `File.exist?` for Ruby 3.4 (JRuby 10) compatibility https://github.com/logstash-plugins/logstash-filter-grok/pull/197[#197]

*Beats Input - 6.9.6*

* Re-packaging the plugin https://github.com/logstash-plugins/logstash-input-beats/pull/529[#529]

*Dead_letter_queue Input - 2.0.2*

* Re-packaging the plugin https://github.com/logstash-plugins/logstash-input-dead_letter_queue/pull/57[#57]

*File Input - 4.4.7*

* Re-packaging the plugin https://github.com/logstash-plugins/logstash-input-file/pull/331[#331]

*Http Input - 3.10.5*

* Re-packaging the plugin https://github.com/logstash-plugins/logstash-input-http/pull/209[#209]

*Tcp Input - 6.4.9*

* Re-packaging the plugin https://github.com/logstash-plugins/logstash-input-tcp/pull/244[#244]

*Unix Input - 3.1.3*

* Fix: replace deprecated `File.exists?` with `File.exist?` for Ruby 3.4 (JRuby 10) compatibility https://github.com/logstash-plugins/logstash-input-unix/pull/31[#31]

*Jdbc Integration - 5.6.3*

* Fix: replace deprecated `File.exists?` with `File.exist?` for Ruby 3.4 (JRuby 10) compatibility https://github.com/logstash-plugins/logstash-integration-jdbc/pull/192[#192]

* Re-packaging the plugin https://github.com/logstash-plugins/logstash-integration-jdbc/pull/190[#190]

*Kafka Integration - 11.8.4*

* Upgrade kafka-avro-serializer dependency https://github.com/logstash-plugins/logstash-integration-kafka/pull/225[#225]

* Re-packaging the plugin https://github.com/logstash-plugins/logstash-integration-kafka/pull/223[#223]

*Nagios Output - 3.0.7*

* Fix: replace deprecated `File.exists?` with `File.exist?` for Ruby 3.4 (JRuby 10) compatibility https://github.com/logstash-plugins/logstash-output-nagios/pull/11[#11]

*Webhdfs Output - 3.1.1*

* Re-packaging the plugin https://github.com/logstash-plugins/logstash-output-webhdfs/pull/49[#49]
