...
=== Logstash Pull Requests with label v7.16.1

* Fix: delegating from deprecated setting https://github.com/elastic/logstash/pull/13481[#13481]
* Backport PR #13481 to 7.16: Fix: delegating from deprecated setting https://github.com/elastic/logstash/pull/13484[#13484]
* Backport #13494 to 7.16. bump log4j version to 2.15.0 https://github.com/elastic/logstash/pull/13496[#13496]

=== Logstash Commits between 7.16 and 7.16.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.16.0..7.16"

b2d1d1138 - (HEAD -> 7.16, origin/7.16) Updated lockfile for 7.16.1 (#13499) (2 days ago) <Rob Bavey>
0da0f8e12 - Backport #13494 to 7.16. bump log4j version to 2.15.0 (#13496) (2 days ago) <Rob Bavey>
5e3c2ac74 - Deps: bump lock file for 7.16.1 (#13483) (4 days ago) <Karol Bucek>
d73755475 -  Backport PR #13481 to 7.16: Fix: delegating from deprecated setting (#13484) (4 days ago) <Karol Bucek>
d492c4ed3 - Release: bump version to 7.16.1 (#13476) (5 days ago) <Karol Bucek>
c22871004 - Release notes for 7.16.0 (#13436) (5 days ago) <Logstash Machine>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.16.0..7.16 *.release"
Changed plugin versions:
logstash-codec-avro: 3.3.0 -> 3.3.1
logstash-filter-date: 3.1.9 -> 3.1.11
logstash-filter-dissect: 1.2.1 -> 1.2.2
logstash-filter-geoip: 7.2.3 -> 7.2.6
logstash-filter-grok: 4.4.0 -> 4.4.1
logstash-filter-mutate: 3.5.4 -> 3.5.6
logstash-filter-syslog_pri: 3.1.0 -> 3.1.1
logstash-filter-useragent: 3.3.1 -> 3.3.2
logstash-filter-xml: 4.1.2 -> 4.1.3
logstash-input-azure_event_hubs: 1.4.0 -> 1.4.1
logstash-input-beats: 6.2.1 -> 6.2.3
logstash-input-dead_letter_queue: 1.1.5 -> 1.1.6
logstash-input-http: 3.4.2 -> 3.4.3
logstash-input-tcp: 6.2.1 -> 6.2.3
logstash-integration-jdbc: 5.1.6 -> 5.1.8
logstash-integration-kafka: 10.8.1 -> 10.8.2
logstash-mixin-validator_support: 1.0.1 -> 1.0.2
logstash-output-elasticsearch: 11.2.1 -> 11.2.3
logstash-output-sns: 4.0.7 -> 4.0.8
...
* Update log4j dependencies https://github.com/logstash-plugins/logstash-filter-date/pull/142[#142]
* Build against JRuby 9k https://github.com/logstash-plugins/logstash-filter-date/issues/116[#116]
* Fix build failure https://github.com/logstash-plugins/logstash-filter-date/issues/114[#114]
...
* Update Log4J dependencies https://github.com/logstash-plugins/logstash-filter-geoip/pull/196[#196]
...
* Update log4j dependencies https://github.com/logstash-plugins/logstash-input-azure_event_hubs/pull/71[#71]
...
* Update log4j dependencies https://github.com/logstash-plugins/logstash-input-tcp/pull/186[#186]
