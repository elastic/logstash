...
=== Logstash Pull Requests with label v8.19.10

=== Logstash Commits between 8.19 and 8.19.9

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.19.9..8.19"

e21497ddf - (HEAD -> 8.19, origin/8.19) Update patch plugin versions in gemfile lock (#18547) (3 hours ago) <github-actions[bot]>
ecffa0f81 - bump lock file for 8.19 (#18533) (2 weeks ago) <github-actions[bot]>
cd6a19914 - Stop tests from polluting maven settings (#18525) (#18527) (2 weeks ago) <mergify[bot]>
8aff7bcc5 - Doc: Fix links in Logstash-to-serverless topic 8.19 (#18497) (3 weeks ago) <Karen Metts>
8f0ae306d - Bump logstash version 8.19.10 (#18509) (3 weeks ago) <github-actions[bot]>
bf178faf2 - Release notes for 8.19.9 (#18478) (3 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.19.9..8.19 *.release"
Changed plugin versions:
logstash-input-beats: 6.9.4 -> 6.9.5
logstash-input-http: 3.10.3 -> 3.10.4
logstash-input-tcp: 6.4.7 -> 6.4.8
