...
* <<logstash-7-17-29,Logstash 7.17.29>>
...
[[logstash-7-17-29]]
=== Logstash 7.17.29 Release Notes

---------- GENERATED CONTENT STARTS HERE ------------
=== Logstash Pull Requests with label v7.17.29

=== Logstash Commits between 7.17 and 7.17.28

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.17.28..7.17"

4dd7c059b - (HEAD -> 7.17, origin/7.17) Ensure elasticsearch logs and data dirs exist before startup (#17531) (#17538) (10 weeks ago) <mergify[bot]>
70b99246d - Shareable function for partitioning integration tests (#17223) (#17304) (3 months ago) <mergify[bot]>
7bc0194f1 - bump version to 7.17.29 (#17149) (4 months ago) <João Duarte>
da3a59c5c - Release notes for 7.17.28 (#17112) (4 months ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.17.28..7.17 *.release"
...
* BREAKING: removed webhdfs output due to deprecated dependencies and lack of support https://github.com/elastic/logstash/pull/17061[#17061]
* [DOC] fix the necessary privileges of central pipeline management https://github.com/elastic/logstash/pull/16931[#16931]

[[dependencies-7-17-28]]
==== Updates to dependencies

* JDK: 11.0.26+4 https://github.com/elastic/logstash/pull/17011[#17011]
* Multiple library dependency upgrades https://github.com/elastic/logstash/pull/17037[#17037]
  * jackson: 2.14.1
  * jackson-databind: 2.14.1
  * jrjackson: 0.4.17
  * guava: 32.1.3
  * org.yaml:snakeyaml: 2.2 (on ingest converter)
...
* Updated Netty dependency to 4.1.87 https://github.com/logstash-plugins/logstash-input-beats/pull/466[#466]
