...
0ad12391f - (HEAD -> 6.5, origin/6.5) correctly handle pipeline actions (#10338) (32 seconds ago) <Colin Surprenant>
d68fb948d - add missing ruby shebang to release tools (6 days ago) <Joao Duarte>
f290dfbd5 - properly set thread name in thread context (#10271) (7 days ago) <Colin Surprenant>
195e7fcb8 - Remove excess period (8 days ago) <Josh Soref>
6dce15901 - add lockfile bump and release notes draft tools (9 days ago) <Joao Duarte>
3f2c5312c - (origin/update_release_notes_1546909573, origin/update_release_notes_1546907493, origin/update_release_notes_1546907168) abort plugin bump script if base version not found (10 days ago) <Joao Duarte>
3e46fb549 - Catch only specific exceptions (13 days ago) <Dan Hermann>
1af4d9b10 - add option for PQ checkpoint retry (2 weeks ago) <Dan Hermann>
9df1229bd - Bump version to 6.5.5 (4 weeks ago) <Rob Bavey>
7129b4f37 - Release Notes for Logstash 6.5.4 (4 weeks ago) <Rob Bavey>
eba7f48d6 - Bump doc version to 6.5.4 (4 weeks ago) <Rob Bavey>
