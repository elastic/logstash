...
* Monitoring settings. The `xpack.` prefix for monitoring settings was removed
from the template and `logstash.yml` as part of an experimental feature. Please
continue to use the <<monitoring-settings-legacy,monitoring settings>> prefixed
