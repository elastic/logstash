...
To update a plugin, run `bin/logstash-plugin update logstash-<plugintype>-<plugin>` where `logstash-<plugintype>-<plugin>` is the name of the plugin. 
For example:`bin/logstash-plugin update logstash-filter-dissect`. 
