...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v6.8.19

=== Logstash Commits between 6.8 and 6.8.18

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v6.8.18..6.8"

c77840de3 - (HEAD -> 6.8, origin/6.8) Release notes for 6.8.18 (#13111) (6 weeks ago) <Logstash Machine>
55a08ba86 - Bump 6.8.19 (#13117) (6 weeks ago) <Ry Biesemeyer>
da4ba0c39 - Doc: Add placeholder for release notes (#13110) (7 weeks ago) <Karen Metts>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v6.8.18..6.8 *.release"
