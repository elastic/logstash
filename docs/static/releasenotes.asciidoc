...
=== Logstash Pull Requests with label v8.15.4
...
* Backport PR #16482 to 8.15: Bugfix for BufferedTokenizer to completely consume lines in case of lines bigger then sizeLimit https://github.com/elastic/logstash/pull/16579[#16579]

=== Logstash Commits between 8.15 and 8.15.3

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.15.3..8.15"

f1cb89343 - (HEAD -> 8.15, origin/8.15) Update patch plugin versions in gemfile lock (#16610) (23 minutes ago) <github-actions[bot]>
cef98e45d - Bugfix for BufferedTokenizer to completely consume lines in case of lines bigger then sizeLimit (#16482) (#16579) (12 days ago) <github-actions[bot]>
1c9e0bb3e - Bump 8.15.4 (#16573) (12 days ago) <Edmo Vamerlatti Costa>
2866bf9e3 - Revert "Bump 8.15.4" (13 days ago) <edmocosta>
2caa1c8f8 - Bump 8.15.4 (13 days ago) <edmocosta>
2788841f5 - Release notes for 8.15.3 (#16527) (13 days ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.15.3..8.15 *.release"
