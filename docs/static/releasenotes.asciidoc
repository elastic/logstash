...
* Implements a functionality to log HTTP traffic, disabled by default. To enable, switch on debug logs. https://github.com/logstash-plugins/logstash-input-http/pull/237[#237]
