...
=== Logstash Pull Requests with label v8.9.2

=== Logstash Commits between 8.9 and 8.9.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.9.1..8.9"

e418e7267 - (HEAD -> 8.9, origin/8.9) Update patch plugin versions in gemfile lock (#15286) (24 hours ago) <github-actions[bot]>
b09ebfeef - bump core (13 days ago) <Kaise Cheng>
db86da61d - Release notes for 8.9.1 (#15244) (2 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.9.1..8.9 *.release"
