...
=== Logstash Pull Requests with label v8.1.2
...
* Doc: Logstash-to-Logstash communication  https://github.com/elastic/logstash/pull/13926[#13926]
* Backport PR #13902 to 8.1: add backoff to checkpoint write https://github.com/elastic/logstash/pull/13930[#13930]
* Backport PR #13926 to 8.1: Doc: Logstash-to-Logstash communication  https://github.com/elastic/logstash/pull/13936[#13936]
* bump lock file for 8.1 https://github.com/elastic/logstash/pull/13939[#13939]

=== Logstash Commits between 8.1 and 8.1.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.1.1..8.1"

c83e95cd2 - (HEAD -> 8.1, origin/8.1) Update patch plugin versions in gemfile lock (#13939) (18 minutes ago) <github-actions[bot]>
4a346c100 - Doc: Logstash-to-Logstash communication  (#13926) (#13936) (3 days ago) <github-actions[bot]>
86949bc74 - add backoff to checkpoint write (#13902) (#13930) (4 days ago) <github-actions[bot]>
94a7aa335 - Bump version to 8.1.2 (#13920) (6 days ago) <Rob Bavey>
0f5689b8d - Update release notes for 8.1.1 (#13907) (6 days ago) <Rob Bavey>
86cdc7a38 - Update Jackson databind in ingest-converter tool (#13900) (#13916) (10 days ago) <github-actions[bot]>
bebd06477 - i18n: alias logstash.runner.configuration.* under logstash.agent.configuration (#13244) (#13842) (10 days ago) <Ry Biesemeyer>
c37e0457a - fix default argument handling in rake artifact task (#13904) (10 days ago) <João Duarte>
f758adf78 - Add reference to java 17 to README.md (#13765) (#13913) (10 days ago) <github-actions[bot]>
be8395e15 - [Doc] update queue.max_bytes and queue.page_capacity (#13833) (#13909) (10 days ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.1.1..8.1 *.release"
