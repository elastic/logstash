...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v7.13.1

* Update bundled JDK to 11.0.11+9 https://github.com/elastic/logstash/pull/12881[#12881]
* [backport 7.13]Update bundled JDK to 11.0.11+9 (#12881) https://github.com/elastic/logstash/pull/12883[#12883]
* Backport PR #12925 to 7.13: Add logstash-integration-elastic_enterpris… https://github.com/elastic/logstash/pull/12935[#12935]

=== Logstash Commits between 7.13 and 7.13.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.13.0..7.13"

b209505df - (HEAD -> 7.13, origin/7.13) Revert "Backport PR #12925 to 7.13: Add logstash-integration-elastic_enterprise_search to plugins-metadata.json (#12935)" (#12943) (20 hours ago) <Rob Bavey>
130240e0c - bump lock file for 7.13.1 (#12942) (21 hours ago) <Logstash Machine>
299def1fe - Backport PR #12925 to 7.13: Add logstash-integration-elastic_enterprise_search to plugins-metadata.json (#12935) (23 hours ago) <Rob Bavey>
ca3f7144e - Doc: Expand definition and fix typo (#12938) (2 days ago) <Karen Metts>
f017d277d - Update bundled JDK to 11.0.11+9 (#12881) (#12883) (2 days ago) <Andrea Selva>
9ff79700d - Release: bump version to 7.13.1 (#12927) (3 days ago) <Andrea Selva>
f903eeb99 - Update release notes for 7.13.0 (#12843) (4 days ago) <kaisecheng>
048a97e57 - Forward Port PR #12825 to 7.13:Update release notes for 7.12.1 (#12924) (4 days ago) <Rob Bavey>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.13.0..7.13 *.release"
Changed plugin versions:
logstash-codec-cef: 6.2.0 -> 6.2.1
logstash-filter-aggregate: 2.9.1 -> 2.9.2
logstash-filter-fingerprint: 3.2.3 -> 3.2.4
logstash-filter-mutate: 3.5.1 -> 3.5.2
logstash-filter-ruby: 3.1.5 -> 3.1.7
logstash-input-tcp: 6.0.9 -> 6.0.10
logstash-integration-kafka: 10.7.4 -> 10.7.5
logstash-output-http: 5.2.4 -> 5.2.5
---------- DELETE UP TO HERE ------------
