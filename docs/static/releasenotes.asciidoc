...
=== Logstash Pull Requests with label v7.13.2
...
=== Logstash Commits between 7.13 and 7.13.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.13.1..7.13"

55e1f324c - (HEAD -> 7.13, origin/7.13) Doc: Remove unused tagged regions (#12980) (17 hours ago) <Karen Metts>
6d32f7df7 - Update lock file for 7.13.2 (#12978) (19 hours ago) <kaisecheng>
65c32657d - Deps: update lock file for 7.13.2 (#12977) (28 hours ago) <Karol Bucek>
3486e4d73 - Use the JVM specified in the CI matrix environment also to run spawned proccesses (#12945) (#12954) (8 days ago) <Andrea Selva>
55ddb65fe - bump version to 7.13.2 (#12956) (9 days ago) <kaisecheng>
8bdca0a86 - Release notes for 7.13.1 (#12946) (10 days ago) <Logstash Machine>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.13.1..7.13 *.release"
Changed plugin versions:
logstash-filter-geoip: 7.1.2 -> 7.1.3
logstash-integration-kafka: 10.7.5 -> 10.7.6
