...
=== Logstash Pull Requests with label v8.18.5

=== Logstash Commits between 8.18 and 8.18.4

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.18.4..8.18"

928e03527 - (HEAD -> 8.18, origin/8.18) [8.18] (backport #17924) Move logstash release information to `.ci` (#17939) (3 days ago) <mergify[bot]>
2a611d24c - Update patch plugin versions in gemfile lock (#17917) (5 days ago) <github-actions[bot]>
f676cb23f - Log *what* components trigger a grype scan (#17905) (#17910) (7 days ago) <mergify[bot]>
086f8c860 - Update patch plugin versions in gemfile lock (#17902) (10 days ago) <github-actions[bot]>
385a780c1 - [8.18] (backport #17879) Update monkey patch for clamp to 1.3.3 (#17881) (11 days ago) <mergify[bot]>
3bc005088 - [8.18] (backport #17782) Release notes for 8.17.9 (#17847) (3 weeks ago) <mergify[bot]>
973e1d334 - [CI] fix benchmark docker name (#17827) (#17834) (3 weeks ago) <mergify[bot]>
ba6b3b16c - [8.18] (backport #17812) update commons-lang3 lib (#17814) (3 weeks ago) <mergify[bot]>
e7dc9b446 - bump core to 8.18.5 (#17842) (3 weeks ago) <kaisecheng>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.18.4..8.18 *.release"
Changed plugin versions:
logstash-filter-elastic_integration: 8.17.2 -> 8.17.3
