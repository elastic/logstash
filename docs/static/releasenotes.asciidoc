...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v7.12.1

* Fix Elasticsearch/DLQ integration test flakiness https://github.com/elastic/logstash/pull/12685[#12685]
* Build: avoid leaking memory from generate_plugins_version https://github.com/elastic/logstash/pull/12763[#12763]
* Backport PR #12763 to 7.12: Build: avoid leaking memory from generate_plugins_version https://github.com/elastic/logstash/pull/12773[#12773]
...
* Backport PR #12782 to 7.12: Set correct permissions for /usr/share/logstash on pkg installs https://github.com/elastic/logstash/pull/12789[#12789]
* Backport PR #12784 (#12805) to 7.12: Fix: logstash-keystore failing with an error https://github.com/elastic/logstash/pull/12804[#12804]
* [7.12] Allow plugin manager uninstall plugin regardless of working directory (#12786) https://github.com/elastic/logstash/pull/12809[#12809]
* Backport PR #12685 to 7.12: Fix Elasticsearch/DLQ integration test flakiness https://github.com/elastic/logstash/pull/12823[#12823]

=== Logstash Commits between 7.12 and 7.12.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.12.0..7.12"

a0a95c823 - (HEAD -> 7.12, upstream/7.12) Backport PR #12685 to 7.12: Fix Elasticsearch/DLQ integration test flakiness (#12823) (17 hours ago) <Karol Bucek>
eb3e4afd7 - Deps: bump lock file for 7.12.1 (#12822) (17 hours ago) <Karol Bucek>
c424f990f - updated distributor pattern section (#12810) (2 days ago) <Ahil PonArul>
2abdc3f4a - Allow plugin manager uninstall plugin regardless of working directory (#12786) (#12809) (7 days ago) <kaisecheng>
4676aa886 - Backport PR #12784 (#12805) to 7.12: Fix: logstash-keystore failing with an error (#12804) (7 days ago) <Karol Bucek>
fb0c42d22 - Set correct permissions for /usr/share/logstash on pkg installs (#12782) (#12789) (2 weeks ago) <Andres Rodriguez>
58dd011b1 - Build: avoid leaking memory from generate_plugins_version (#12763) (#12773) (3 weeks ago) <Karol Bucek>
2d4468215 - Doc: Rework security update in release notes (#12768) (3 weeks ago) <Karen Metts>
9b4e60298 - Release notes for 7.12.0 (#12683) (3 weeks ago) <Logstash Machine>
76fc176da - Release: bump version to 7.12.1 (#12764) (3 weeks ago) <Karol Bucek>
ec7808b3e - Doc:Add placeholder and coming tag for 7.12.0 release notes (#12762) (3 weeks ago) <Karen Metts>
3c5c5a150 - Forwardport release notes for 7.11.1 and 7.11.2 to 7.12 branch (#12743) (3 weeks ago) <Karen Metts>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.12.0..7.12 *.release"
Changed plugin versions:
logstash-codec-cef: 6.1.1 -> 6.1.2
logstash-filter-fingerprint: 3.2.2 -> 3.2.3
logstash-filter-mutate: 3.5.0 -> 3.5.1
logstash-input-beats: 6.1.0 -> 6.1.2
...
logstash-output-elasticsearch: 10.8.2 -> 10.8.6
