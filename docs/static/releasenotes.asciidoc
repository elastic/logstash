...
5a9696b33 - (HEAD -> 6.7, origin/6.7) Make the sample command easier to follow (33 seconds ago) <Yi Ou>
6b2da9c67 - Update Kafka version to fix build (4 days ago) <Rob Bavey>
af76e7660 - Update JRuby and Java prerequisites (4 days ago) <Dan Hermann>
6fe4fb8d6 - Add note that pline-pline also supports files (5 days ago) <Karen Metts>
eb14bdcd6 - Update supported java version and example (6 days ago) <Karen Metts>
af43a6b5d - Bump version to 6.7.1 (#10585) (6 days ago) <Rob Bavey>
62477b09a - Set released state of docs to 'released' (#10579) (6 days ago) <Rob Bavey>
cbb3e0d63 - Release notes for 6.7.0 (#10578) (6 days ago) <Rob Bavey>
