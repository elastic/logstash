...
a880a6b - (HEAD -> 6.7, origin/6.7) Call out requirement for Java execution in note (66 seconds ago) <Dan Hermann>
5a9696b - Make the sample command easier to follow (2 days ago) <Yi Ou>
6b2da9c - Update Kafka version to fix build (6 days ago) <Rob Bavey>
af76e76 - Update JRuby and Java prerequisites (6 days ago) <Dan Hermann>
6fe4fb8 - Add note that pline-pline also supports files (7 days ago) <Karen Metts>
eb14bdc - Update supported java version and example (8 days ago) <Karen Metts>
af43a6b - Bump version to 6.7.1 (#10585) (8 days ago) <Rob Bavey>
62477b0 - Set released state of docs to 'released' (#10579) (8 days ago) <Rob Bavey>
cbb3e0d - Release notes for 6.7.0 (#10578) (8 days ago) <Rob Bavey>
