...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v6.8.11

=== Logstash Commits between 6.8 and 6.8.10

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v6.8.10..6.8"

f410c4dd7 - (HEAD -> 6.8, origin/6.8) fix license notices after version bumps (#12082) (5 days ago) <João Duarte>
112e6259b - bump lock file for 6.8.11 (#12079) (5 days ago) <Logstash Machine>
707d79353 - Bump 6.8.11 (#11963) (5 weeks ago) <Andrea Selva>
b261bca84 - Update release notes 6.8.10 (#11955) (5 weeks ago) <Ry Biesemeyer>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v6.8.10..6.8 *.release"
Changed plugin versions:
logstash-input-azure_event_hubs: 1.1.2 -> 1.1.4
logstash-input-file: 4.1.16 -> 4.1.17
logstash-input-http: 3.3.4 -> 3.3.5
logstash-input-syslog: 3.4.1 -> 3.4.3
---------- DELETE UP TO HERE ------------
