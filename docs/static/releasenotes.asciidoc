...
* Ensures that logstash-provided defaults for jackson deserialization are applied unless explicitly overridden https://github.com/elastic/logstash/pull/16854[#16854].
