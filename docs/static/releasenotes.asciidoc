...
* Fix: Avoid issue with `nil` natie threads by making get_thread_id "nil safe" https://github.com/elastic/logstash/pull/11458[#11458]
...
* Updated Netty dependencies, and removed support for CBC ciphers https://github.com/logstash-plugins/logstash-input-beats/pull/376[#376]
