...
* Inject variable reference instead of variable value in "logstash.yaml" to ensure keystore values take precedence from Environment Variables https://github.com/elastic/logstash/pull/16037[#16037]
