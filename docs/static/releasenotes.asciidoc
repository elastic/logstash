...
af76e7660 - (HEAD -> 6.7, origin/6.7) Update JRuby and Java prerequisites (2 minutes ago) <Dan Hermann>
6fe4fb8d6 - Add note that pline-pline also supports files (21 hours ago) <Karen Metts>
