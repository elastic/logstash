...
* Feature/log appender per pipeline https://github.com/elastic/logstash/pull/11108[#11108]
...
f354b47ea - (HEAD -> 7.5, origin/7.5) don't rely on expect match and last_match in qa test (3 weeks ago) <Joao Duarte>
...
2804651a7 - improve reliability of webserver port binding (4 weeks ago) <Joao Duarte>
0db05498b - Remove edit_me link overrides for monitoring topics (4 weeks ago) <Karen Metts>
...
f57868662 - Fix typo in doc-for-plugin (5 weeks ago) <Karen Metts>
35cb71eda - more resilient testing of logging level setting (5 weeks ago) <Joao Duarte>
78ffbb31b - Fix to avoid Nashorn error regarding the unknown flag `--no-deprecation-warning` for JDK < 11. closes 11221 (5 weeks ago) <andsel>
6e360c64e - bump lock file for 7.5.0 (#11223) (5 weeks ago) <Logstash Machine>
e5a48e4ea - bump to 7.5.0 (5 weeks ago) <Joao Duarte>
1cf8a7b8d - plugins: replace kafka input/output with integration (5 weeks ago) <Ry Biesemeyer>
5a8cef4e8 - plugins: replace rabbitmq input/output with integration (5 weeks ago) <Ry Biesemeyer>
d278efda4 - doc: replace unicode non-breaking hyphen U+8211 with ASCII hyphen (5 weeks ago) <Ry Biesemeyer>
08fd76ab3 - make pipeline grammars more accurately capture field references (5 weeks ago) <Ry Biesemeyer>
138e1f91e - regenerate config parsers from unmodified grammar definitions (5 weeks ago) <Ry Biesemeyer>
96dfeb501 - add tasks for generating config parsers (5 weeks ago) <Ry Biesemeyer>
a9def1e10 - syntax fix (5 weeks ago) <Sachin Frayne>
...
f48b261af - Update reference to last 6.x version to be 6.8 (6 weeks ago) <Karen Metts>
8d19b5f07 - handling missing gems during generatePluginsVersion (6 weeks ago) <Joao Duarte>
15f0de348 - remove 10k character truncation from log4j2.properties (6 weeks ago) <João Duarte>
32b831010 - Add remaining review comments from #11033 (6 weeks ago) <Karen Metts>
3db93d5eb - Added section in logstash.yml documentation to describe feature (6 weeks ago) <andsel>
fc9c0e0ca - Added LS configuration variable 'pipeline.separate_logs' to separate logs per pipelines - use log4j RoutingAppender - avoid output to main log files when log per pipeline is enabled - closes 10427 (6 weeks ago) <andsel>
0d6bb46ed - Clarify monitoring hosts should not be master-only (6 weeks ago) <Jason Tedor>
9c9266fe3 - Add metricbeat as monitoring option (#11190) (7 weeks ago) <Karen Metts>
70c38b596 - clarify: config.reload.interval is seconds (7 weeks ago) <Andrew Siegman>
fc0db0d95 - [DOCS] Fixes links to monitoring content (#11166) (#11172) (7 weeks ago) <Lisa Cawley>
dfb3cb5a3 - Update version of jrjackson (8 weeks ago) <Rob Bavey>
a91e3b6be - Backport release notes to 7.x (#11160) (8 weeks ago) <João Duarte>
3e7ec18e3 - Add note about illegal reflective access (9 weeks ago) <Karen Metts>
0953ad929 - remove mention of pipeline to pipeline being Beta (9 weeks ago) <Joao Duarte>
975ef25a8 - Deprecate LS Netflow module and point to FB Netflow module (9 weeks ago) <Karen Metts>
20c4d8639 - Update logstash to use shared version files (#11132) (10 weeks ago) <Karen Metts>
30d3865dc - Fixed links in contributing-to-logstash page (10 weeks ago) <Kuba Clark>
1cbaeebb4 - Added origins of pipeline's configuration (es config string, the paths of config files used, module). (10 weeks ago) <andsel>
652e1b70a - Update link to Debugging Java Performance (3 months ago) <Pavel Zubkou>
c12acff15 - use 2048 bits key (3 months ago) <Colin Surprenant>
