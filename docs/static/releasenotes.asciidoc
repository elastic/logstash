...
* Performance: Share a single secret store to reduce overhead for pipelines that use these variables. 
We no longer incur the cost of repeatedly building the keystore. https://github.com/elastic/logstash/pull/10794[#10794]
