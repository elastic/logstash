...
* Added missed dependency (elastic-app-search) to the gemspec, fixes issue https://github.com/logstash-plugins/logstash-output-elastic_app_search/issues/17[#17]
