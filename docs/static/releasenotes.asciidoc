...
=== Logstash Pull Requests with label v8.14.1

* Handle non-unicode payload in Logstash. (#16072) https://github.com/elastic/logstash/pull/16168[#16168]
* Backport PR #16176 to 8.14: PQ: avoid blocking writer when precisely full https://github.com/elastic/logstash/pull/16178[#16178]
* Revert pr #16050 https://github.com/elastic/logstash/pull/16201[#16201]
* Backport PR #16201 to 8.14: Revert pr #16050 https://github.com/elastic/logstash/pull/16203[#16203]
* Pin rexml gem version to 3.2.6 https://github.com/elastic/logstash/pull/16209[#16209]
* Backport PR #16209 to 8.14: Pin rexml gem version to 3.2.6 https://github.com/elastic/logstash/pull/16210[#16210]

=== Logstash Commits between 8.14 and 8.14.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.14.0..8.14"

8fa13707f - (HEAD -> 8.14, origin/8.14) Update patch plugin versions in gemfile lock (#16211) (2 hours ago) <github-actions[bot]>
224421f3e - Pin rexml gem version to 3.2.6 (#16209) (#16210) (3 hours ago) <github-actions[bot]>
550e93583 - Revert PR #16050 (#16203) (4 days ago) <github-actions[bot]>
7afb42c13 - Bump version to 8.14.1 (#16196) (5 days ago) <Rob Bavey>
78fb37928 - Release notes for 8.14.0 (#16155) (6 days ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.14.0..8.14 *.release"
Changed plugin versions:
logstash-filter-elastic_integration: 0.1.8 -> 0.1.9
logstash-input-azure_event_hubs: 1.4.5 -> 1.4.7
logstash-integration-jdbc: 5.4.10 -> 5.4.11
logstash-integration-kafka: 11.4.1 -> 11.4.2
