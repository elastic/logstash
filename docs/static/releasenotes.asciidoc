...
=== Logstash Pull Requests with label v8.13.3

* Doc: Remove include statements for screenshots not rendering properly https://github.com/elastic/logstash/pull/15981[#15981]
* Backport PR #15981 to 8.13: Doc: Remove include statements for screenshots not rendering properly https://github.com/elastic/logstash/pull/16089[#16089]

=== Logstash Commits between 8.13 and 8.13.2

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.13.2..8.13"

5ecd3cf0a - (HEAD -> 8.13, origin/8.13) bump lock file for 8.13 (#16107) (13 minutes ago) <github-actions[bot]>
3dbe7de26 - Doc: Remove include statements for screenshots not rendering properly (#15981) (#16089) (9 days ago) <github-actions[bot]>
2bef137dc - Release notes for 8.13.2 (#16068) (2 weeks ago) <github-actions[bot]>
09d92e65f - bump version to 8.13.3 (#16069) (2 weeks ago) <João Duarte>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.13.2..8.13 *.release"
Changed plugin versions:
logstash-input-beats: 6.8.2 -> 6.8.3
logstash-input-http: 3.8.0 -> 3.8.1
logstash-input-tcp: 6.4.1 -> 6.4.2
...
* update netty to 4.1.109 https://github.com/logstash-plugins/logstash-input-beats/pull/495[#495]

*Http Input - 3.8.1*

* update netty to 4.1.109 https://github.com/logstash-plugins/logstash-input-http/pull/173[#173]

*Tcp Input - 6.4.2*

* update netty to 4.1.109 https://github.com/logstash-plugins/logstash-input-tcp/pull/220[#220]
