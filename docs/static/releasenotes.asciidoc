...
**Logstash response to Apache Log4j vulnerability**. 
...
In Logstash, we responded by bumping the log4j version to 2.15.0 in https://github.com/elastic/logstash/pull/13494[#13494] to bypass the vulnerability.
