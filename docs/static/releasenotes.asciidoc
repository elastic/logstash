...
* <<logstash-8-19-22,Logstash 8.19.22>>
...
* <<logstash-8-19-17,Logstash 8.19.17>>
...
=== Logstash Pull Requests with label v8.19.22

=== Logstash Commits between 8.19 and 8.19.21

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.19.21..8.19"

dbf5917cc - (HEAD -> 8.19, origin/8.19) bump lock file for 8.19 (#19557) (25 hours ago) <github-actions[bot]>
26fc4ee8c - [8.19] (backport #19501) Upgrade rubyzip dependency. (#19552) (2 days ago) <mergify[bot]>
7599c4322 - [8.19] (backport #19442) Update jackson to 2.21.6 (#19549) (2 days ago) <mergify[bot]>
8f538000f - Add lumberjack plugin deprecation in LS to LS comm. (#19526) (2 days ago) <Mashhur>
b2fa2ece3 - [8.19] Update dependency tree versions (#19540) (2 days ago) <Mashhur>
4ec911350 - [8.19] (backport #19483) Pin resolv 0.7.2 and fork JRuby for gem installs (#19536) (2 days ago) <mergify[bot]>
9eca63c98 - Update patch plugin versions in gemfile lock (#19538) (3 days ago) <github-actions[bot]>
1fed15fda - Update patch plugin versions in gemfile lock (#19529) (3 days ago) <github-actions[bot]>
0e89d42d3 - Update bundled JDK to 21.0.12.1 build 1 (#19509) (3 days ago) <github-actions[bot]>
a0a05e824 - chore: deps(updatecli): Bump updatecli version to v0.121.0 (#19511) (#19518) (4 days ago) <mergify[bot]>
30646e714 - Update Ironbank image to UBI 10.2 (#19504) (4 days ago) <Rob Bavey>
7ac517755 - add missing test files (#19495) (#19500) (9 days ago) <mergify[bot]>
ebd33e0aa - Add the logstash-output-http plugin to observabilitySRE container (#19465) (#19494) (10 days ago) <mergify[bot]>
d95c0abd9 - Migrate DRA GCS publishing from Release manager to dra-prep-plugin (#19477) (#19487) (2 weeks ago) <mergify[bot]>
739bf8260 - Bump logstash version 8.19.22 (#19476) (2 weeks ago) <github-actions[bot]>
79616da19 - Release notes for 8.19.21 (#19464) (3 weeks ago) <github-actions[bot]>
d9123fdf6 - chore: deps(updatecli): Bump updatecli version to v0.120.1 (#19453) (#19459) (4 weeks ago) <mergify[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.19.21..8.19 *.release"
Changed plugin versions:
logstash-filter-elastic_integration: 8.19.9 -> 8.19.10
logstash-input-azure_event_hubs: 1.5.9 -> 1.5.10
logstash-input-beats: 6.9.12 -> 6.9.13
logstash-input-http: 3.11.1 -> 3.11.2
logstash-input-tcp: 6.4.15 -> 6.4.17
...
* Update jackson dependency to 3.1.6 https://github.com/elastic/logstash-filter-elastic_integration/pull/497[#497]

*Azure_event_hubs Input - 1.5.10*

* Update `proton-j` to 0.35.0 https://github.com/logstash-plugins/logstash-input-azure_event_hubs/pull/122[#122]

*Beats Input - 6.9.13*

* Update Netty dependency to 4.1.138.Final https://github.com/logstash-plugins/logstash-input-beats/pull/580[#580]

*Http Input - 3.11.2*

* Update Netty dependency to 4.1.138.Final https://github.com/logstash-plugins/logstash-input-http/pull/242[#242]

*Tcp Input - 6.4.17*

* Update Netty dependency to 4.1.138.Final https://github.com/logstash-plugins/logstash-input-tcp/pull/289[#289]

* Fix for processing the HA Proxy protocol, considering the line can be split in multiple buffers. https://github.com/logstash-plugins/logstash-input-tcp/pull/287[#287]

*Jdbc Integration - 5.6.6*

* Fix access method to big tables to avoid materialise the full result set in memory and generate an out-of-memory error. https://github.com/logstash-plugins/logstash-integration-jdbc/pull/204[#204]

* Prevent concurrent Sequel JDBC subadapter initialization races by preloading adapter at driver load time https://github.com/logstash-plugins/logstash-integration-jdbc/pull/203[#203]

*Kafka Integration - 11.8.12*

* Upgrade zstd-jni dependency https://github.com/logstash-plugins/logstash-integration-kafka/pull/280[#280]

*Scheduler Mixin - 1.0.2*

* Fix: terminate idle scheduler work threads on plugin close, which leaked one thread per pipeline reload https://github.com/logstash-plugins/logstash-mixin-scheduler/pull/7[#7]

*Email Output - 4.1.4*

* Requiere `mail` dependency 2.9 or later  https://github.com/logstash-plugins/logstash-output-email/pull/72[#72]
...
* Updated JDK to 21.0.12 build 8 https://github.com/elastic/logstash/pull/19367[#19367].

==== Plugins

*Csv Filter - 3.1.2*

* Pin `csv` dependency to `< 3.2.6` to avoid a JRuby CSV.parse_line performance regression introduced in csv 3.2.6 https://github.com/logstash-plugins/logstash-filter-csv/pull/94[#94]

*Elastic_integration Filter - 8.19.9*

* Apply the default 30-second socket timeout to low-level HTTP connections so stalled connections time out consistently https://github.com/elastic/logstash-filter-elastic_integration/pull/480[#480]

*Elasticsearch Filter - 3.19.1*

* Support base64-encoded and Elastic Cloud (`essu_`-prefixed) API keys in the `api_key` option; reject unrecognized formats at startup. https://github.com/logstash-plugins/logstash-filter-elasticsearch/pull/229[#229]

*Beats Input - 6.9.11*

* Update Netty dependency to 4.1.136.Final https://github.com/logstash-plugins/logstash-input-beats/pull/574[#574]

*Elasticsearch Input - 4.23.1*

* Support base64-encoded and Elastic Cloud (`essu_`-prefixed) API keys in the `api_key` option; reject unrecognized formats at startup. https://github.com/logstash-plugins/logstash-input-elasticsearch/pull/276[#276]

*Http Input - 3.10.11*

* Fix to use the `Content-type` declared charset to decode the request body https://github.com/logstash-plugins/logstash-input-http/pull/232[#232]

* Update Netty dependency to 4.1.136.Final https://github.com/logstash-plugins/logstash-input-http/pull/229[#229]

*Tcp Input - 6.4.14*

* Update Netty dependency to 4.1.136.Final https://github.com/logstash-plugins/logstash-input-tcp/pull/282[#282]

*Jdbc Integration - 5.6.4*

* Fix connection leak on statement retry by opening JDBC connection once outside retry loop https://github.com/logstash-plugins/logstash-integration-jdbc/pull/201[#201]

*Elasticsearch Output - 11.22.17*

* Support base64-encoded and Elastic Cloud (`essu_`-prefixed) API keys in the `api_key` option; reject unrecognized formats at startup. https://github.com/logstash-plugins/logstash-output-elasticsearch/pull/1278[#1278]


[[logstash-8-19-19]]
=== Logstash 8.19.19 Release Notes

.Deprecation of JDK versions older than 21
****
Running {ls} on a JDK older than 21 is deprecated. {ls} now logs a warning and a deprecation notice at startup when it runs on Java 11 or Java 17. https://github.com/elastic/logstash/pull/19285[#19285]

These JDK versions continue to work with the Logstash 8.19.x releases, but support for them will be removed in a future release. The bundled JDK is Java 21; to run with a custom JDK, set `LS_JAVA_HOME` to a Java 21 installation.
****

==== Updates to dependencies

* Updated JRuby to 9.4.15.0 https://github.com/elastic/logstash/pull/19284[#19284]
* Updated Jackson and jrjackson dependencies https://github.com/elastic/logstash/pull/19288[#19288]

==== Plugins

*Elastic_integration Filter - 8.19.8*

* Sync up with Elasticsearch 8.19 branch to pull latest dependencies https://github.com/elastic/logstash-filter-elastic_integration/pull/479[#479]

* Update jackson dependency to 3.1.4 https://github.com/elastic/logstash-filter-elastic_integration/pull/471[#471]

*Azure_event_hubs Input - 1.5.8*

* Update jackson dependency to 2.21.4 https://github.com/logstash-plugins/logstash-input-azure_event_hubs/pull/118[#118]

*Kafka Integration - 11.8.10*

* Update jackson dependency to 2.21.4 https://github.com/logstash-plugins/logstash-integration-kafka/pull/269[#269]

*Elasticsearch Output - 11.22.16*
...
[[logstash-8-19-18]]
=== Logstash 8.19.18 Release Notes

==== Updates to dependencies

Upgrade puma to 8.x https://github.com/elastic/logstash/pull/19244[#19244]
...
[[logstash-8-19-17]]
=== Logstash 8.19.17 Release Notes

==== Updates to dependencies

* Upgrade Elasticsearch transport and API clients https://github.com/elastic/logstash/pull/19190[#19190]

==== Updates to documentations

* Logstash's file descriptors usage, limits and sizing guidance documented https://github.com/elastic/logstash/pull/19208[#19208]

==== Plugins

*Azure_event_hubs Input - 1.5.7*

* Upgrades `jackson.core` to 2.21.2 and `nimbus-jose-jwt` to 10.9 versions. https://github.com/logstash-plugins/logstash-input-azure_event_hubs/pull/117[#117]

* [DOCS] Added recommendation to migrate to the Kafka integration plugin https://github.com/logstash-plugins/logstash-input-azure_event_hubs/pull/116[#116]

*Beats Input - 6.9.10*

* Update Netty dependency to 4.1.135.Final https://github.com/logstash-plugins/logstash-input-beats/pull/566[#566]

*Http Input - 3.10.9*

* Update Netty dependency to 4.1.135.Final https://github.com/logstash-plugins/logstash-input-http/pull/220[#220]

*Tcp Input - 6.4.13*

* Update Netty dependency to 4.1.135.Final https://github.com/logstash-plugins/logstash-input-tcp/pull/273[#273]

*Elastic_enterprise_search Integration - 3.0.3*

* Allow enterprise-search dependency to pull 8.19 and newer versions https://github.com/logstash-plugins/logstash-integration-elastic_enterprise_search/pull/27[#27]
...
* Update Netty dependency to 4.1.134.Final https://github.com/logstash-plugins/logstash-input-beats/pull/540[#540]

*Http Input - 3.10.8*

* Update Netty dependency to 4.1.134.Final https://github.com/logstash-plugins/logstash-input-http/pull/218[#218]

*Tcp Input - 6.4.12*

* Update Netty dependency to 4.1.134.Final https://github.com/logstash-plugins/logstash-input-tcp/pull/258[#258]

*Pipe Output - 3.0.7*

* [DOC] Document `command` string form limitation https://github.com/logstash-plugins/logstash-output-pipe/pull/6[#6]
...
* Upgrades kotlin-stdlib dependency https://github.com/logstash-plugins/logstash-input-azure_event_hubs/pull/114[#114]

*Beats Input - 6.9.8*

* Update Netty dependency to 4.1.132.Final https://github.com/logstash-plugins/logstash-input-beats/pull/534[#534]

*Http Input - 3.10.7*

* Update Netty dependency to 4.1.132.Final https://github.com/logstash-plugins/logstash-input-http/pull/213[#213]

*Tcp Input - 6.4.11*

* Update Netty dependency to 4.1.132.Final https://github.com/logstash-plugins/logstash-input-tcp/pull/248[#248]

*Elastic_enterprise_search Integration - 3.0.2*

* Upgrades `elastic-enterprise-search` gem and tolerates `Elastic::Transport` client https://github.com/logstash-plugins/logstash-integration-elastic_enterprise_search/pull/26[#26]

*Kafka Integration - 11.8.7*

* Upgrade Avro dependency to 1.11.5 https://github.com/logstash-plugins/logstash-integration-kafka/pull/242[#242]

* [DOC] Add info about Kafka timestamp behavior  https://github.com/logstash-plugins/logstash-integration-kafka/pull/241[#241]

* Redact `sasl_jaas_config` to prevent credentials from appearing in debug logs. https://github.com/logstash-plugins/logstash-integration-kafka/pull/237[#237]

*Http Output - 5.7.2*

* [DOC] Clarify that `ssl_certificate_authorities` takes at-most-one value https://github.com/logstash-plugins/logstash-output-http/pull/150[#150]
...
IMPORTANT: As of JDK 21.0.10, all `TLS_RSA_*` cipher suites are disabled by default due to their lack of forward secrecy; connections relying on these suites will fail with an `SSLHandshakeException` and must be migrated to ECDHE-based cipher suites.
...
* Fixed an issue where some logstash artifacts were shipped with a JDK targeting the wrong platform/architecture. https://github.com/elastic/logstash/pull/18748[#18748]

==== Plugins

*Collectd Codec - 3.1.1*

* Replace deprecated File.exists? by File.exist? to ensure compatibility with Ruby 3.4 (JRuby 10) https://github.com/logstash-plugins/logstash-codec-collectd/pull/36[#36]

*Netflow Codec - 4.3.4*

* Replace deprecated File.exists? by File.exist? to ensure compatibility with Ruby 3.4 (JRuby 10) https://github.com/logstash-plugins/logstash-codec-netflow/pull/215[#215]

*Date Filter - 3.1.16*

* Ensure gem artifact ship with all runtime dependencies  https://github.com/logstash-plugins/logstash-filter-date/pull/163[#163]

*Dissect Filter - 1.2.6*

* Ensure gem artifact ship with all runtime dependencies  https://github.com/logstash-plugins/logstash-filter-dissect/pull/93[#93]
* Removed unused runtime dependency `jar-dependencies` https://github.com/logstash-plugins/logstash-filter-dissect/pull/91[#91]

*Geoip Filter - 7.3.4*

* Replace deprecated File.exists? by File.exist? to ensure compatibility with Ruby 3.4 (JRuby 10) https://github.com/logstash-plugins/logstash-filter-geoip/pull/239[#239]

* Ensure gem artifact ship with all runtime dependencies  https://github.com/logstash-plugins/logstash-filter-geoip/pull/236[#236]

*Grok Filter - 4.4.4*

* Replace deprecated File.exists? by File.exist? to ensure compatibility with Ruby 3.4 (JRuby 10) https://github.com/logstash-plugins/logstash-filter-grok/pull/197[#197]

*Beats Input - 6.9.6*

* Ensure gem artifact ship with all runtime dependencies  https://github.com/logstash-plugins/logstash-input-beats/pull/529[#529]

*Dead_letter_queue Input - 2.0.2*

* Ensure gem artifact ship with all runtime dependencies  https://github.com/logstash-plugins/logstash-input-dead_letter_queue/pull/57[#57]

*File Input - 4.4.7*

* Ensure gem artifact ship with all runtime dependencies  https://github.com/logstash-plugins/logstash-input-file/pull/331[#331]

*Http Input - 3.10.5*

* Ensure gem artifact ship with all runtime dependencies  https://github.com/logstash-plugins/logstash-input-http/pull/209[#209]

*Tcp Input - 6.4.9*

* Ensure gem artifact ship with all runtime dependencies  https://github.com/logstash-plugins/logstash-input-tcp/pull/244[#244]

*Unix Input - 3.1.3*

* Replace deprecated File.exists? by File.exist? to ensure compatibility with Ruby 3.4 (JRuby 10) https://github.com/logstash-plugins/logstash-input-unix/pull/31[#31]

*Jdbc Integration - 5.6.3*

* Replace deprecated File.exists? by File.exist? to ensure compatibility with Ruby 3.4 (JRuby 10) https://github.com/logstash-plugins/logstash-integration-jdbc/pull/192[#192]

* Ensure gem artifact ship with all runtime dependencies  https://github.com/logstash-plugins/logstash-integration-jdbc/pull/190[#190]

*Kafka Integration - 11.8.4*

* Upgrade Avro serializer dependency https://github.com/logstash-plugins/logstash-integration-kafka/pull/225[#225]

* Ensure gem artifact ship with all runtime dependencies  https://github.com/logstash-plugins/logstash-integration-kafka/pull/223[#223]

*Nagios Output - 3.0.7*

* Replace deprecated File.exists? by File.exist? to ensure compatibility with Ruby 3.4 (JRuby 10) https://github.com/logstash-plugins/logstash-output-nagios/pull/11[#11]

*Webhdfs Output - 3.1.1*

* Ensure gem artifact ship with all runtime dependencies  https://github.com/logstash-plugins/logstash-output-webhdfs/pull/49[#49]


[[logstash-8-19-11]]
=== Logstash 8.19.11 Release Notes

[[known-issues-8-19-11]]
==== Known issues

[[known-issue-8-19-11-aarch64]]
===== Logstash will not start with bundled JDK on aarch64 downloaded artifacts

On aarch64, Logstash 8.19.11 fails to start when installed from .deb, .rpm, or .tar packages when using the bundled JDK.
...
* Made decoding more robust to malformed events https://github.com/logstash-plugins/logstash-codec-netflow/pull/214[#214]

*Azure_event_hubs Input - 1.5.4*

* Ensure gem artifact ship with all runtime dependencies https://github.com/logstash-plugins/logstash-input-azure_event_hubs/pull/110[#110]
* Remove unused Azure Active Directory dependency https://github.com/logstash-plugins/logstash-input-azure_event_hubs/pull/107[#107]

*Kafka Integration - 11.8.2*

* Upgrade transitive dependency used by Avro serializer https://github.com/logstash-plugins/logstash-integration-kafka/pull/217[#217]
...
* Added trace log to track event size expansion https://github.com/logstash-plugins/logstash-filter-split/pull/49[#49]
* [DOC] Added introductory statement to clarify purpose of the plugin https://github.com/logstash-plugins/logstash-filter-split/pull/43[#43]
...
* Docs: Correct code snippet https://github.com/logstash-plugins/logstash-output-csv/pull/28[#28]
...
* Logging improvement while handling exceptions in the pipeline, ensuring that chained exceptions propagate enough information to be actionable. https://github.com/elastic/logstash/pull/17933[#17933]
...
[[logstash-8-19-1]]
=== Logstash 8.19.1 Release Notes

No user-facing changes in Logstash core.

==== Plugins

*Elastic_integration Filter - 8.19.1*

* Add `terminate` processor support https://github.com/elastic/logstash-filter-elastic_integration/pull/345[#345]

*Translate Filter - 3.4.3*

* Allow YamlFile's Psych::Parser and Visitor instances to be garbage collected https://github.com/logstash-plugins/logstash-filter-translate/pull/104[#104]

*Xml Filter - 4.3.2*

* Update Nokogiri dependency version https://github.com/logstash-plugins/logstash-filter-xml/pull/89[#89]

*Azure_event_hubs Input - 1.5.2*

* Updated JWT dependency https://github.com/logstash-plugins/logstash-input-azure_event_hubs/pull/101[#101]

*Snmp Integration - 4.0.7*

* FIX: The `snmptrap` input now correctly enforces the user security level set by `security_level` config, and drops received events that do not match the configured value https://github.com/logstash-plugins/logstash-integration-snmp/pull/75[#75]

*Elasticsearch Output - 11.22.13*

* Add headers reporting uncompressed size and doc count for bulk requests https://github.com/logstash-plugins/logstash-output-elasticsearch/pull/1217[#1217]
...
* The {es} Input now provides https://github.com/logstash-plugins/logstash-input-elasticsearch/pull/205[support] for field value tracking, persisted to disk on each `search_after` page. This is useful to track new data being written to an index or series of indices.
