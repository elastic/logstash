...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v6.8.1
...
=== Logstash Commits between 6.8 and 6.8.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v6.8.0..6.8"

a5bdaa1fa - (HEAD -> 6.8, origin/6.8) Update patch plugin versions in gemfile lock (#10851) (74 minutes ago) <João Duarte>
f0edd134b - Remove note about j11 (6 days ago) <Karen Metts>
86ab51e97 - Value of start_timestamp must to be quoted (11 days ago) <Florian Kelbert>
5ba741c44 - rake task to generate dockerfile (backport of #10819 to 6.8) #10835 (12 days ago) <João Duarte>
5b30c009f - Fixes unit test failures on some runs of ConfigCompilerTest::testComplexConfigToPipelineIR (12 days ago) <Dan Hermann>
055c034c5 - Merge config values in LIR (12 days ago) <Dan Hermann>
2735ac789 - name rpm/deb oss packages as logstash-oss (13 days ago) <Joao Duarte>
3242bd737 - LIR support for octal literals in pipeline definitions (2 weeks ago) <Dan Hermann>
15c9a857a - plugin type in Ruby module name should be uppercase (2 weeks ago) <Dan Hermann>
a9249fd77 - Add structure for new windows topic (3 weeks ago) <Karen Metts>
9b8d042bb - bump to 6.8.1 (#10803) (3 weeks ago) <João Duarte>
4c443f98a - Bump doc version to 6.8.0 (#10798) (3 weeks ago) <Karen Metts>
a25625280 - Release notes for 6.8.0 (#10797) (3 weeks ago) <Karen Metts>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v6.8.0..6.8 *.release"
Changed plugin versions:
logstash-codec-es_bulk: 3.0.7 -> 3.0.8
logstash-filter-csv: 3.0.8 -> 3.0.10
logstash-filter-dns: 3.0.12 -> 3.0.13
logstash-filter-jdbc_streaming: 1.0.5 -> 1.0.7
logstash-filter-kv: 4.3.0 -> 4.3.1
logstash-filter-useragent: 3.2.3 -> 3.2.4
logstash-input-azure_event_hubs: 1.1.0 -> 1.1.2
logstash-input-dead_letter_queue: 1.1.4 -> 1.1.5
logstash-input-elasticsearch: 4.3.0 -> 4.3.1
logstash-input-tcp: 5.2.2 -> 5.2.3
