...
* [7.7 clean backport of #11688] support quoted plugin option key https://github.com/elastic/logstash/pull/11693[#11693]

=== Logstash Commits between 7.7 and 7.6.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.6.1..7.7"

8c791f13a - (HEAD -> 7.7, upstream/7.7) Updated lock file for 7.7.0 (#11720) (10 minutes ago) <Rob Bavey>
a48e2688c - (77/release_notes) Bump 7.7.0 (3 hours ago) <andsel>
1c964a27a - (upstream/7.x, 7_7_lockfile) Expand section on force reloading config (7 days ago) <Karen Metts>
758bc5c62 - support quoted plugin option key (#11693) (9 days ago) <Colin Surprenant>
ae3002d7d - minor, used the correct placeholder (9 days ago) <andsel>
81a96546d - Fixed typo in guage metric of unknown type log. (9 days ago) <Mark Ramotowski>
ff471bbb9 - Add `sudo` into the rpm import of GPG-KEY (9 days ago) <j-yama>
89aaebb61 - Revert "Adaptations to internal collector to send data directly to monitoring cluster Close 11573 (#11641)" (#11687) (12 days ago) <Andres Rodriguez>
7116d39b9 - Adaptations to internal collector to send data directly to monitoring cluster Close 11573 (#11641) (12 days ago) <Andrea Selva>
d90616fde - Added clarification that configuration force reload doesn't work on WinOS (12 days ago) <andsel>
...
d90161637 - Adaptations to internal collector to send data directly to monitoring cluster Close 11573 Added check on HTTP server before asking for monitoring data in unit test Fixes #11541 (13 days ago) <andsel>
...
7549824fc - Add tips for troubleshooting a pipeline (2 weeks ago) <Karen Metts>
1fc169b7f - Add apache and elastic license headers to source code files (#11673) (2 weeks ago) <João Duarte>
4412073ad - Update to include verification mode switch (2 weeks ago) <Kris Reberger>
9ef44b4c1 - Wording tweak for more emphasis (2 weeks ago) <Karen Metts>
f06b66db8 - Update logging.asciidoc (2 weeks ago) <Ryan Earle>
a2ebac33c - Update offline-plugins.asciidoc (2 weeks ago) <meshkov>
...
e64c6f312 - Backport changes from 11544 (#11665) (3 weeks ago) <Karen Metts>
ce4493653 - Changed: .ruby-version back to 9.1.12.0 (3 weeks ago) <Karol Bucek>
229487c38 - [DOCS] Updates security API examples (#10752) (#11660) (3 weeks ago) <Lisa Cawley>
b7a5f7685 - Updated: JRuby to 9.2.11.0 (3 weeks ago) <Karol Bucek>
d3d765a45 - Fix: use l/w match-ing (which does not depend on frames) (3 weeks ago) <Karol Bucek>
7706866fb - Fix: broken --help due sinatra 2.x upgrade (3 weeks ago) <Karol Bucek>
593235c16 - Update rack dependency on docgen project (3 weeks ago) <João Duarte>
c00362868 - Update release notes for 7.6.1 (3 weeks ago) <Joao Duarte>
1ce7e6915 - Fixes JDK13's javadoc build failure (3 weeks ago) <andsel>
b3c85356b - Changed the xpack metrics pipeline to use a customized ES output plugin to put document_type for /_monitoring, closes #11312 Backport commit to 7.x Fixes #11321 (4 weeks ago) <andsel>
de95de3ae - remove TODO from CONTRIBUTING notes (4 weeks ago) <Karol Bucek>
43213410f - Fixes #11598 enabling the users to use completely commented config files (4 weeks ago) <andsel>
...
ca635975c - Update contributing guidelines to clarify changelog formatting (5 weeks ago) <Karen Metts>
496f81c8c - Changed PluginFactory to resolve id field with environment variables docs: plugin ids variable expansion cannot use secret store (5 weeks ago) <andsel>
91e96b1f2 - Rework ls netflow module deprecation notice (5 weeks ago) <Karen Metts>
55410efcc - Fix setting name for monitoring (6 weeks ago) <Karen Metts>
9d6fa3215 - Release notes for 7.6.0 (6 weeks ago) <Rob Bavey>
f86bf3691 - Review: more places for RUBY.getCurrentContext() (6 weeks ago) <Karol Bucek>
2511347df - Review: more consistent getCurrentContext() (6 weeks ago) <Karol Bucek>
8461a590a - Refactor: do not keep around JRuby context reference (6 weeks ago) <Karol Bucek>
e070af8e4 - Adding plugin.id to docker images (6 weeks ago) <andsel>
72b5f295c - revert #11482 and fix redundant code generation (#11576) (7 weeks ago) <Colin Surprenant>
4ff6378c0 - Clarify wording and add to another page (7 weeks ago) <Karen Metts>
e8ffadc02 - Add Apple notarization info (7 weeks ago) <Karen Metts>
07c4d9d52 - Remove module-only disclaimer for cloud id (7 weeks ago) <Karen Metts>
52327f80f - Updating the log4j2.properties file that the Docker container image uses to also log the pipeline.id. (7 weeks ago) <Spencer Niemi>
...
52f794695 - Add deprecation notice to internal collectors for monitoring (8 weeks ago) <Karen Metts>
f94f72a79 - Add details about pipeline.workers (8 weeks ago) <Karen Metts>
6a8bebffe - add support for pipeline.ordered setting for java execution (#11552) (8 weeks ago) <Colin Surprenant>
...
7a2222046 - Added plugin.id to fish tag log lines related to plugins (9 weeks ago) <andsel>
8c3ae7e15 - Updated release notes after code review comments (9 weeks ago) <Rob Bavey>
5a14aa850 - Release notes for 7.5.2 (9 weeks ago) <Rob Bavey>
6f5101d60 - pin google-java-format back to 1.1 for licensing reasons (10 weeks ago) <Joao Duarte>
994ebf81e - Bump to 7.7.0 (#11505) (2 months ago) <Rob Bavey>
