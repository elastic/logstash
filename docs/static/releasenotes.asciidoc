...
=== Logstash Pull Requests with label v7.17.0

* Remove CI related files not used https://github.com/elastic/logstash/pull/12538[#12538]
* logging: move init into environment's settings post-processor https://github.com/elastic/logstash/pull/13221[#13221]
* Fix unknown type warning of geoip metrics https://github.com/elastic/logstash/pull/13382[#13382]
* Fix logstash-plugin install command to install non default plugin https://github.com/elastic/logstash/pull/13405[#13405]
* fix: respect LS_JAVA_OPTS environment even when optionsfile missing https://github.com/elastic/logstash/pull/13525[#13525]
* Backport #13442 to 7.17. Update logstash docker to use ubuntu 20.04 b… https://github.com/elastic/logstash/pull/13529[#13529]
* Add info log of JVM flags used to configure Logstash https://github.com/elastic/logstash/pull/13531[#13531]
* Bump log4j dependency to 2.17.0 https://github.com/elastic/logstash/pull/13544[#13544]
* Backport PR #13544 to 7.17: Bump log4j dependency to 2.17.0 https://github.com/elastic/logstash/pull/13547[#13547]
* Product origin headers to Logstash-controlled Elasticsearch clients https://github.com/elastic/logstash/pull/13563[#13563]
* [7.17] Fix logstash-plugin install command to install non default plugin (#13405) https://github.com/elastic/logstash/pull/13587[#13587]
* Avoid to increment `event.out` conter for dropped events https://github.com/elastic/logstash/pull/13593[#13593]
* Avoid to itereate with each_index https://github.com/elastic/logstash/pull/13603[#13603]
* Support env variable in condition https://github.com/elastic/logstash/pull/13608[#13608]
* [Docs] Add pipeline.ecs_compatibility to the list https://github.com/elastic/logstash/pull/13612[#13612]
* Backport PR #13563 to 7.17: Product origin headers to Logstash-controlled Elasticsearch clients https://github.com/elastic/logstash/pull/13623[#13623]
* [Backport PR#13604 to 7.17] Fix 2 failing tests on Windows https://github.com/elastic/logstash/pull/13629[#13629]
* Fix Ruby port check execution in kafka_setup.sh https://github.com/elastic/logstash/pull/13631[#13631]
* Backport PR #13525 to 7.17: fix: respect LS_JAVA_OPTS environment even when optionsfile missing https://github.com/elastic/logstash/pull/13635[#13635]
* Backport PR #13612 to 7.17: [Docs] Add pipeline.ecs_compatibility to the list https://github.com/elastic/logstash/pull/13638[#13638]
* Fix/gems not found in integration test after plugin install https://github.com/elastic/logstash/pull/13641[#13641]
* field-reference: cap RUBY_CACHE to 10k entries https://github.com/elastic/logstash/pull/13642[#13642]
* stats api: startup resilience when stats are partially formed https://github.com/elastic/logstash/pull/13645[#13645]
* Backport PR #13642 to 7.17: field-reference: cap RUBY_CACHE to 10k entries https://github.com/elastic/logstash/pull/13655[#13655]
* Fix unit test under Windows https://github.com/elastic/logstash/pull/13656[#13656]
* Backport PR #13645 to 7.17: stats api: startup resilience when stats are partially formed https://github.com/elastic/logstash/pull/13660[#13660]
* Backport PR #13221 to 7.17: logging: move init into environment's settings post-processor https://github.com/elastic/logstash/pull/13663[#13663]
* Backport PR #13656 to 7.17: Fix unit test under Windows https://github.com/elastic/logstash/pull/13665[#13665]
* Test fix, switch to plugin with less dependencies https://github.com/elastic/logstash/pull/13672[#13672]
* [Backport 7.17] Test fix, switch to plugin with less dependencies (#13672) https://github.com/elastic/logstash/pull/13674[#13674]

=== Logstash Commits between 7.17 and 7.16.3

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.16.3..7.17"

455995c32 - (HEAD -> 7.17, origin/7.17) Doc: Add placeholder for 7.17.0 release notes (#13688) (24 hours ago) <Karen Metts>
4cfe69839 - Revert "[DOC] Clarify the scope of environment variable expansion (#13299)" (#13679) (#13683) (32 hours ago) <kaisecheng>
e971d17dd - Update patch plugin versions in gemfile lock (#13680) (2 days ago) <Ry Biesemeyer>
d2a98a0b7 - Support env variable in condition (#13608) (#13678) (3 days ago) <kaisecheng>
bdf2748e1 - bump dependency patches again for in-flight 7.17.0 (#13676) (3 days ago) <Ry Biesemeyer>
289ea89b2 - [Backport 7.17] Test fix, switch to plugin with less dependencies (#13672) (#13674) (3 days ago) <Andrea Selva>
319e67dce - logging: move init into environment's settings post-processor (#13221) (#13663) (4 days ago) <Ry Biesemeyer>
8d057881a - stats api: startup resilience when stats are partially formed (#13645) (#13660) (4 days ago) <Ry Biesemeyer>
fe4827132 - [Backport 7.17] Fix unit test under Windows (#13656) (#13665) (4 days ago) <Ry Biesemeyer>
22e2e52d9 - Backport PR #13612 to 7.17: [Docs] Add pipeline.ecs_compatibility to the list (#13638) (8 days ago) <Ry Biesemeyer>
c8e2bef09 - field-reference: cap RUBY_CACHE to 10k entries (#13642) (#13655) (8 days ago) <Ry Biesemeyer>
3c0b948a8 - [DOC] Clarify scope of queue settings 7.17 (#13651) (8 days ago) <Karen Metts>
779a4d5f1 - [Backport 7.17] Fix Ruby port check execution in kafka_setup.sh (#13631) (#13640) (8 days ago) <Andrea Selva>
9c4fdf889 - [Backport 7.17] Fix/gems not found in integration test after plugin install (#13641) (#13643) (8 days ago) <Andrea Selva>
89b3b54a8 - bump dependencies for 7.17.0 (#13647) (8 days ago) <Ry Biesemeyer>
abadc329e - ecs: docs and comments syncing for 7.last (#13626) (10 days ago) <Ry Biesemeyer>
36c5e2a09 - Backport PR #13525 to 7.17: fix: respect LS_JAVA_OPTS environment even when optionsfile missing (#13635) (10 days ago) <Ry Biesemeyer>
779e081c9 - [Backport PR#13604 to 7.17] Fix 2 failing tests on Windows (#13629) (10 days ago) <Rob Bavey>
920e82193 - [Backport 7.17]Add info log of JVM flags used to configure Logstash (#13531) (#13632) (10 days ago) <Andrea Selva>
dc4368e0c -  [backport 7.17]Avoid to increment `event.out` conter for dropped events (#13593) (#13624) (11 days ago) <Andrea Selva>
ddb1ed17c - Product origin headers to Logstash-controlled Elasticsearch clients (#13563) (#13623) (2 weeks ago) <Ry Biesemeyer>
5b8e61595 - Doc: Forward 7.16.2 and 7.16.2 release notes to 7.17 (#13611) (2 weeks ago) <Karen Metts>
236cbcaad -  [backport 7.17] Avoid to itereate with each_index (#13603) (#13609) (2 weeks ago) <Andrea Selva>
d1e2816c4 - Fix unknown type warning of geoip metrics (#13382) (#13602) (2 weeks ago) <kaisecheng>
0407e9383 - Adds license definitions for faraday-multipart and faraday-retry (#13592) (#13594) (3 weeks ago) <Andrea Selva>
e48a0810e - docs: sprintf vs UTC nature of @timestamp field (#13576) (#13590) (3 weeks ago) <Ry Biesemeyer>
958d968e7 - Update lockfile for 7.17.0 (#13582) (3 weeks ago) <Rob Bavey>
c77994f43 - Fix logstash-plugin install command to install non default plugin (#13405) (#13587) (3 weeks ago) <kaisecheng>
18a586506 - Removed unused CI files (#13575) (3 weeks ago) <Andrea Selva>
267545d99 - Bump log4j dependency to 2.17.1 (#13564) (#13566) (4 weeks ago) <kaisecheng>
2bc03c8c0 - update lock file for 7.17.0 (#13550) (6 weeks ago) <kaisecheng>
c9940c78e - Bump log4j dependency to 2.17.0 (#13547) (6 weeks ago) <Andres Rodriguez>
18c30527c - Doc: Add anchor to bundled jdk info 7.17 (#13542) (6 weeks ago) <Karen Metts>
5fad50496 - Doc: remove PQ on input for Output Isolator 7.17 (#13539) (6 weeks ago) <Karen Metts>
2d831b85b - Backport #13442 to 7.17. Update logstash docker to use ubuntu 20.04 base image (#13529) (6 weeks ago) <Rob Bavey>
47038d7ec - Chore: bump version to 7.17.0 (snapshot) (#13527) (6 weeks ago) <Karol Bucek>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.16.3..7.17 *.release"
...
* Refactor: leverage codec when using schema registry https://github.com/logstash-plugins/logstash-integration-kafka/pull/106[#106]
...
* Adds ECS templates https://github.com/logstash-plugins/logstash-output-elasticsearch/pull/1048[#1048]
