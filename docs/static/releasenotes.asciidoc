...
=== Logstash Commits between 8.8 and 8.8.2

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.8.2..8.8"

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.8.2..8.8 *.release"
