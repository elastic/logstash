...
=== Logstash Pull Requests with label v7.17.24

* Download of JDK from the Elastic catalog instead of Adoptium https://github.com/elastic/logstash/pull/15514[#15514]
* Update bundled JDK https://github.com/elastic/logstash/pull/16394[#16394]
* [CI] Increase Jruby -Xmx for DRA https://github.com/elastic/logstash/pull/16408[#16408]
* Backport PR #16408 to 7.17: [CI] Increase Jruby -Xmx for DRA https://github.com/elastic/logstash/pull/16409[#16409]

=== Logstash Commits between 7.17 and 7.17.23

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.17.23..7.17"

3e07c3a02 - (HEAD -> 7.17, origin/7.17) bump lock file for 7.17 (#16412) (20 hours ago) <github-actions[bot]>
bf220b6e1 - Increase Jruby -Xmx to avoid OOM during zip task in DRA (#16408) (#16409) (7 days ago) <github-actions[bot]>
0f43da15c - Update bundled JDK (#16394) (2 weeks ago) <Andrea Selva>
dde697251 - Bump 7.17.24 (#16346) (5 weeks ago) <Andrea Selva>
1fbfdc0d6 - Release notes for 7.17.23 (#16345) (5 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.17.23..7.17 *.release"
