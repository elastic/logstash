...
=== Logstash Pull Requests with label v8.5.0
...
* Backport PR #14327 to main: Release notes for 8.3.2 https://github.com/elastic/logstash/pull/14387[#14387]
* Backport PR #14365 to main: Release notes for 8.3.3 https://github.com/elastic/logstash/pull/14389[#14389]
* Update version of the bundled JDK to 17.0.4+8 https://github.com/elastic/logstash/pull/14424[#14424]
* fix(env2yaml): Add monitoring.cluster_uuid https://github.com/elastic/logstash/pull/14425[#14425]
* bump jruby version to 9.3.7.0 https://github.com/elastic/logstash/pull/14455[#14455]
* winlogbeat-modules: add docs for interfacing winlogbeat with logstash https://github.com/elastic/logstash/pull/14472[#14472]
* Created DRA shell script to create artifacts and dependency report https://github.com/elastic/logstash/pull/14522[#14522]

=== Logstash Commits between 8.5 and 8.4.3

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.4.3..8.5"

ba48a8e99 - (HEAD -> 8.5, origin/8.5) Backport dra 8.5 (#14587) (2 days ago) <Andrea Selva>
c958f961f - Release notes for 8.4.2 (#14531) (2 weeks ago) <github-actions[bot]>
1d2947668 - Update plugin versions in gemfile lock for 8.5.0 (#14547) (2 weeks ago) <github-actions[bot]>
efb2ff9c0 - add initial lock file for 8.5.0 (2 weeks ago) <João Duarte>
6e0b365c9 - Feature: flow metrics integration (#14518) (2 weeks ago) <Ry Biesemeyer>
6534386f2 - Created DRA shell script to create artifacts and dependency report (#14522) (3 weeks ago) <Andrea Selva>
0578ddbbd - Upgrade jruby to 9.3.8.0 (#14524) (3 weeks ago) <Rob Bavey>
5d7fa78e0 - Fix Windows scripts (#14515) (4 weeks ago) <Rob Bavey>
b7b9613c6 - winlogbeat-modules: add docs for interfacing winlogbeat with logstash (#14472) (4 weeks ago) <Dan Kortschak>
8d41b8549 - Manually import CSV gem to work around thread leak (#14507) (4 weeks ago) <Rob Bavey>
2a2f5ae24 - Update add_to_projects_beta.yml (4 weeks ago) <Andres Rodriguez>
328a4e20d - Update add_to_projects_beta.yml (4 weeks ago) <Andres Rodriguez>
37ebcee71 - Update add_to_projects_beta.yml (4 weeks ago) <Andres Rodriguez>
248a51235 - Update add_to_projects_beta.yml (4 weeks ago) <Andres Rodriguez>
955c48131 - Update add_to_projects_beta.yml (4 weeks ago) <Andres Rodriguez>
842e45aba - Update add_to_projects_beta.yml (4 weeks ago) <Andres Rodriguez>
5c5a52d6b - Update add_to_projects_beta.yml (4 weeks ago) <Andres Rodriguez>
3d43f86fa - Update add_to_projects_beta.yml (4 weeks ago) <Andres Rodriguez>
4584b632f - drop support for all DES ciphers in OpenSSL and simplify cipher list (#14499) (4 weeks ago) <João Duarte>
89c45d6d8 - Change deb/rpm specification to describe as replacement of noarch old Logstash packages (#14346) (4 weeks ago) <Andrea Selva>
3a7862110 - fix SettingsImpl to remove hardcoded checkpointRetry (#14487) (4 weeks ago) <kaisecheng>
26289b955 - Forward port release notes for 8.4.0 and 8.4.1 (#14484) (5 weeks ago) <Andrea Selva>
a10e23685 - Update CI versions after 8.4.1 (#14482) (5 weeks ago) <Andrea Selva>
2944eacd2 - Add missing reference to full config of LS-to-LS over HTTP (#14466) (5 weeks ago) <Andres Rodriguez>
88d89fe89 - [Doc] add off-heap memory session (#14431) (6 weeks ago) <kaisecheng>
a2a82f740 - Bump release and snapshot versions (#14469) (6 weeks ago) <Rob Bavey>
6bc2483cf - bump jruby version to 9.3.7.0 (#14455) (7 weeks ago) <João Duarte>
9d16c3bce - Stop pinning mustermann in logstash-core.gemspec (#14453) (7 weeks ago) <João Duarte>
24c675ccd - remove sinatra constraint (#14446) (7 weeks ago) <João Duarte>
4cb900ce7 - update flores dependency to at least 0.0.8 (#14437) (7 weeks ago) <João Duarte>
c124cc6c9 - Remove the `chmod g+s` command from ironbank docker image (#14435) (7 weeks ago) <Rob Bavey>
cd60c6522 - Update tests to allow integration tests to use the bundled JDK (#14432) (7 weeks ago) <Rob Bavey>
5767b3b98 - Ensuring COPY instruction is used instead of ADD in Dockerfiles (#14423) (8 weeks ago) <lior-orca>
2e4837ccf - Fixes typo in running logstash CLI doc (#14428) (8 weeks ago) <Andrea Selva>
f03330acd - Add monitoring.cluster_uuid as Docker env setting(#14425) (8 weeks ago) <Boris Djurdjevic>
595967680 - Update feature-request.md (#12873) (8 weeks ago) <Andres Rodriguez>
4771ad61b - Update version of the bundled JDK to 17.0.4+8 (#14424) (8 weeks ago) <Rob Bavey>
5b69f6579 - Pin jar-dependencies 0.4.1 (#14421) (9 weeks ago) <kaisecheng>
788797234 - Open java modules for gradle test after 7.5 upgrade (#14413) (9 weeks ago) <Andrea Selva>
535499811 - Doc: Fileset must be enabled in module (#14405) (9 weeks ago) <Karen Metts>
dfa88aa0e - Make version bump github action work with future JRuby versions (#14391) (10 weeks ago) <João Duarte>
8aa62dc44 - pin bundler 2.3.18 to avoid bug in .19 (#14394) (10 weeks ago) <João Duarte>
f798d5f0e - Upgrade CI stack version to 8.3.3 (#14393) (2 months ago) <Mashhur>
cf8469857 - Release notes for 8.3.3 (#14365) (#14389) (2 months ago) <github-actions[bot]>
506094eda - Release notes for 8.3.2 (#14327) (#14387) (2 months ago) <github-actions[bot]>
07fe589d8 - [doc] Describe DLQ's age retention policy (#14340) (2 months ago) <Andrea Selva>
3c5ed2b62 - Document the cleaning of consumed events feature (#14341) (2 months ago) <Andrea Selva>
5a6460899 - Bump version to 8.5.0 (#14382) (2 months ago) <Rob Bavey>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.4.3..8.5 *.release"
Changed plugin versions:
logstash-filter-translate: 3.3.1 -> 3.4.0
logstash-input-elasticsearch: 4.14.0 -> 4.16.0
logstash-input-exec: 3.4.0 -> 3.6.0
logstash-input-file: 4.4.3 -> 4.4.4
logstash-input-http_poller: 5.3.1 -> 5.4.0
logstash-output-elasticsearch: 11.6.0 -> 11.9.0
...
* Fix: Test failures due to insufficient time given for scheduler to start https://github.com/logstash-plugins/logstash-input-exec/pull/32[#32] 
