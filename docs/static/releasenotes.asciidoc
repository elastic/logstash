...
=== Logstash Pull Requests with label v8.11.2

* Doc: Add Elastic Agent collection https://github.com/elastic/logstash/pull/15528[#15528]
* [ci] Fix image name for Rocky Linux 8 https://github.com/elastic/logstash/pull/15584[#15584]
* Backport PR #15584 to 8.11: [ci] Fix image name for Rocky Linux 8 https://github.com/elastic/logstash/pull/15587[#15587]
* Backport PR #15528 to 8.11: Doc: Add Elastic Agent collection https://github.com/elastic/logstash/pull/15589[#15589]
* [ci] Support amazonlinux for JDK matrix pipeline https://github.com/elastic/logstash/pull/15595[#15595]
* Backport PR #15595 to 8.11: [ci] Support amazonlinux for JDK matrix pipeline https://github.com/elastic/logstash/pull/15596[#15596]
* Backport PR #15595 to 8.11: [ci] Support amazonlinux for JDK matrix pipeline https://github.com/elastic/logstash/pull/15598[#15598]
* [ci] Use GCP prod image for JDK matrix jobs https://github.com/elastic/logstash/pull/15600[#15600]
* Backport PR #15600 to 8.11: [ci] Use GCP prod image for JDK matrix jobs https://github.com/elastic/logstash/pull/15602[#15602]
* [ci] Initial Exhaustive tests Buildkite pipeline https://github.com/elastic/logstash/pull/15607[#15607]
* Backport PR #15607 to 8.11: [ci] Initial Exhaustive tests Buildkite pipeline https://github.com/elastic/logstash/pull/15615[#15615]
* Doc: Housekeeping changes to monitoring with agent docs https://github.com/elastic/logstash/pull/15619[#15619]
* [ci] Fix scheduled JDK matrix CI jobs https://github.com/elastic/logstash/pull/15623[#15623]
* Backport PR #15623 to 8.11: [ci] Fix scheduled JDK matrix CI jobs https://github.com/elastic/logstash/pull/15625[#15625]
* [ci] Switch to Adoptium JDK 17 for Jenkins CI https://github.com/elastic/logstash/pull/15628[#15628]
* [ci] Switch to Adoptium distro for JDK 11 https://github.com/elastic/logstash/pull/15629[#15629]
* Backport PR #15628 to 8.11: [ci] Switch to Adoptium JDK 17 for Jenkins CI https://github.com/elastic/logstash/pull/15632[#15632]
* Backport PR #15629 to 8.11: [ci] Switch to Adoptium distro for JDK 11 https://github.com/elastic/logstash/pull/15633[#15633]
* Added missing method of logger wrapper for puma https://github.com/elastic/logstash/pull/15640[#15640]
* [ci] Compatibility tests for Exhaustive suite https://github.com/elastic/logstash/pull/15641[#15641]
* Backport PR #15640 to 8.11: Added missing method of logger wrapper for puma https://github.com/elastic/logstash/pull/15642[#15642]
* Backport PR #15641 to 8.11: [ci] Compatibility tests for Exhaustive suite https://github.com/elastic/logstash/pull/15647[#15647]
* Shutdown DLQ segments flusher only if it has been started https://github.com/elastic/logstash/pull/15649[#15649]
* Backport PR #15649 to 8.11: Shutdown DLQ segments flusher only if it has been started https://github.com/elastic/logstash/pull/15656[#15656]

=== Logstash Commits between 8.11 and 8.11.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.11.1..8.11"

4292ef917 - (HEAD -> 8.11, origin/8.11) Shutdown DLQ segments flusher only if it has been started (#15649) (#15656) (5 hours ago) <github-actions[bot]>
dae158532 - [ci] Compatibility tests for Exhaustive suite (#15641) (#15647) (5 days ago) <github-actions[bot]>
6d55f2640 - Added missing method of logger wrapper for puma (#15640) (#15642) (5 days ago) <github-actions[bot]>
be32ecd55 - [ci] Switch to Adoptium distro for JDK 11 (#15629) (#15633) (6 days ago) <github-actions[bot]>
02b67592d - [ci] Switch to Adoptium JDK 17 for Jenkins CI (#15628) (#15632) (6 days ago) <github-actions[bot]>
34056f378 - [ci] Fix scheduled JDK matrix CI jobs (#15623) (#15625) (7 days ago) <github-actions[bot]>
6f4a7d499 - Doc: Improvements to monitoring with agent (#15619) to 8.11 (#15621) (8 days ago) <Karen Metts>
3e2a250cb - [ci] Initial Exhaustive tests Buildkite pipeline (#15607) (#15615) (8 days ago) <github-actions[bot]>
b15f59074 - bump lock file for 8.11 (#15613) (11 days ago) <github-actions[bot]>
93d8a9da3 - swap dataformat-yaml with snakeyaml (#15599) (13 days ago) <João Duarte>
0835b50f8 - [ci] Use GCP prod image for Linux JDK matrix job (#15600) (#15602) (2 weeks ago) <github-actions[bot]>
8a563519e - [ci] Support amazonlinux for JDK matrix pipeline (#15595) (#15598) (2 weeks ago) <github-actions[bot]>
cf00b2986 - Update base image on ironbank to 8.8 (#15582) (3 weeks ago) <Rob Bavey>
06d00405c - [ci] Add yaml language server to pipelines (#15590) (#15591) (3 weeks ago) <Dimitrios Liappis>
91e0d8a55 - Doc: Add Elastic Agent collection (#15528) (#15589) (3 weeks ago) <github-actions[bot]>
4df57ee31 - [ci] Fix image name for Rocky Linux 8 (#15584) (#15587) (3 weeks ago) <github-actions[bot]>
ad8e53705 - bump lock file in preparation for 8.11.2 (#15586) (3 weeks ago) <github-actions[bot]>
34c88e7f7 - [ci] JDK matrix Buildkite pipelines (pt 2/Windows) (#15563) (#15567) (3 weeks ago) <github-actions[bot]>
3d4e7e121 - Release notes for 8.11.1 (#15572) (3 weeks ago) <github-actions[bot]>
9876ce105 - bump version to 8.11.2 (#15574) (3 weeks ago) <João Duarte>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.11.1..8.11 *.release"
Changed plugin versions:
logstash-filter-mutate: 3.5.7 -> 3.5.8
logstash-input-beats: 6.7.1 -> 6.7.2
logstash-input-elastic_serverless_forwarder: 0.1.3 -> 0.1.4
logstash-input-http_poller: 5.5.0 -> 5.5.1
logstash-mixin-validator_support: 1.1.0 -> 1.1.1
...
* Restore accidentally removed Lumberjack event parse source lines https://github.com/logstash-plugins/logstash-input-beats/pull/486[#486]
...
*Http_poller Input - 5.5.1*

* [DOC]Remove redundant table items https://github.com/logstash-plugins/logstash-input-http_poller/pull/142[#142]

*Validator_support Mixin - 1.1.1*

* allow single word host names https://github.com/logstash-plugins/logstash-mixin-validator_support/pull/7[#7]
