...
6548501c2 - (HEAD -> 6.6, origin/6.6) keystore: instances of `CharsetEncoder` are stateful and cannot be shared (33 seconds ago) <Ry Biesemeyer>
3bdc57ac3 - spec: make timing-sensitive specs a little more flexible (14 hours ago) <Ry Biesemeyer>
bd6a26615 - spec: noop refactor for clarity - use explicit `metric_input` subject instead of implicit subject - use rspec/wait full expectation syntax instead of be_falsey/be_truthy - eliminate unused shared examples - incorporate single-use shared examples (14 hours ago) <Ry Biesemeyer>
5b7f60e9b - agent webserver: synchronise control (15 hours ago) <Ry Biesemeyer>
1ab316ebe - change 「5.x」→「6.x」 (23 hours ago) <taku333>
7cb8d471a - Update patch plugin versions in gemfile lock (#10363) (25 hours ago) <Guy Boertje>
ef0d135d9 - qa: allow connections to localhost in webmock (#10384) (29 hours ago) <Ry Biesemeyer>
8bef18ada - fix agent silent exit upon pipelines reloading (#10370) (6 days ago) <Colin Surprenant>
