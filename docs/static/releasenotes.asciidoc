...
(7.6.2) 7549824fc - Add tips for troubleshooting a pipeline (2 weeks ago) <Karen Metts>
(7.6.2) 4412073ad - Update to include verification mode switch (2 weeks ago) <Kris Reberger>
9ef44b4c1 - Wording tweak for more emphasis (2 weeks ago) <Karen Metts>
(7.6.2) f06b66db8 - Update logging.asciidoc (2 weeks ago) <Ryan Earle>
(7.6.2) a2ebac33c - Update offline-plugins.asciidoc (2 weeks ago) <meshkov>
...
(7.6.2)ca635975c - Update contributing guidelines to clarify changelog formatting (5 weeks ago) <Karen Metts>

(7.6.1) 91e96b1f2 - Rework ls netflow module deprecation notice (5 weeks ago) <Karen Metts>
(7.6.1) 55410efcc - Fix setting name for monitoring (6 weeks ago) <Karen Metts>
(7.6.1) 4ff6378c0 - Clarify wording and add to another page (7 weeks ago) <Karen Metts>
(7.6.1) e8ffadc02 - Add Apple notarization info (7 weeks ago) <Karen Metts>
(7.6.0) 07c4d9d52 - Remove module-only disclaimer for cloud id (7 weeks ago) <Karen Metts>
80cd89673 - Fix missing " on glob pattern (8 weeks ago) <tbotalla>
(7.6.0) 52f794695 - Add deprecation notice to internal collectors for monitoring (8 weeks ago) <Karen Metts>
(7.6.0) f94f72a79 - Add details about pipeline.workers (8 weeks ago) <Karen Metts>
...
Logging - added plugin name to log statements
...
Monitoring - added support for sending monitoring to dedicated monitoring cluster
...
(7.6.2)Fixed regression where a completely commented out configuration files would cause pipeline not to be able to start
* Fix/permit commented out config sources https://github.com/elastic/logstash/pull/11615[#11615]

(7.6.2) Fixed regression where quoted configuration keys would cause pipeline to not be able to start
...
Fix of ordered pipeline for java execution - this might need a blog note, extra release notes to explain
...
Fix Multiple pipeline performance regression
...
(7.6.2) 81a96546d - Fixed typo in guage metric of unknown type log. (9 days ago) <Mark Ramotowski> #11689
Add `sudo` into the rpm import of GPG-KEY #11684

Regular expression fix.
d3d765a45 - Fix: use l/w match-ing (which does not depend on frames) (3 weeks ago) <Karol Bucek>

(7.6.2) 7706866fb - Fix: broken --help due sinatra 2.x upgrade (3 weeks ago) <Karol Bucek>

Fixes Monitoring API corrupts output when id contains environment variable reference
...
(7.6.2) * Fixed issue where calling `java_import` on `org.logstash.netty.SslContextBuilder` was causing the TCP input to pick up the wrong SslContextBuilder class
...
(7.6.2) * Refactor: scope (and avoid unused) java imports https://github.com/logstash-plugins/logstash-input-http/pull/124[#124]

*Redis Input*

(7.6.2) * [DOC] Reordered config option to alpha order https://github.com/logstash-plugins/logstash-input-redis/issues/79[#79]
...
(7.6.2)*  Refactor: scope and review java_imports https://github.com/logstash-plugins/logstash-input-snmp/pull/72[#72]

*Tcp Input*

(7.6.2) * Refactor: scope java_import to avoid polluting https://github.com/logstash-plugins/logstash-input-tcp/pull/152[#152]

*Kafka Integration*

(7.6.2) * Fix links in changelog pointing to stand-alone plugin changelogs.
(7.6.2) * Refactor: scope java_import to plugin class

*Rabbitmq Integration*

(7.6.2) * Refactor: scope (and remove unused) java imports https://github.com/logstash-plugins/logstash-integration-rabbitmq/pull/29[#29]

*Elasticsearch Output*

(7.6.2)* [DOC] Replaced link to Elastic Cloud trial with attribute, and fixed a comma splice https://github.com/logstash-plugins/logstash-output-elasticsearch/pull/926[#926]
(7.6.2)* [DOC] Replaced setting name with correct value https://github.com/logstash-plugins/logstash-output-elasticsearch/pull/919[#919]
(7.6.2)* Fixed integration tests for Elasticsearch 7.6+ https://github.com/logstash-plugins/logstash-output-elasticsearch/pull/922[#922]
(7.6.2)* Fixed integration tests for Elasticsearch API `7.5.0` https://github.com/logstash-plugins/logstash-output-elasticsearch/pull/923[#923]
