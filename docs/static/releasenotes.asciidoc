...
=== Logstash Pull Requests with label v8.8.2

* 8.8 - Update bundler version in jruby load path in rubyUtils https://github.com/elastic/logstash/pull/15110[#15110]

=== Logstash Commits between 8.8 and 8.8.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.8.1..8.8"

c5e0c2c99 - (HEAD -> 8.8, origin/8.8) Update bundler load version (#15110) (32 hours ago) <Rob Bavey>
6014e6852 - Update patch plugin versions in gemfile lock (#15100) (2 days ago) <github-actions[bot]>
40089bef9 - Bump version to 8.8.2 (#15087) (2 weeks ago) <Rob Bavey>
d1b86cfbb - Release notes for 8.8.1 (#15085) (2 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.8.1..8.8 *.release"
Changed plugin versions:
logstash-filter-translate: 3.4.1 -> 3.4.2
logstash-integration-aws: 7.1.1 -> 7.1.4
logstash-integration-jdbc: 5.4.3 -> 5.4.4
logstash-integration-rabbitmq: 7.3.2 -> 7.3.3
logstash-output-csv: 3.0.8 -> 3.0.9
logstash-output-elasticsearch: 11.15.7 -> 11.15.8
...
* Added an option `use_aws_bundled_ca` to use bundled ca certs that ships with AWS SDK to verify SSL peer certificates https://github.com/logstash-plugins/logstash-integration-aws/pull/32[#32]

* Fix: adaptations to run with JRuby 9.4 https://github.com/logstash-plugins/logstash-integration-aws/pull/29[#29]
...
* Fixes a regression introduced in 11.14.0 which could prevent Logstash 8.8 from establishing a connection to Elasticsearch for Central Management and Monitoring core features https://github.com/logstash-plugins/logstash-output-elasticsearch/issues/1141[#1141]
