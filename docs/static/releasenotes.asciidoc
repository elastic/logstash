...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v7.8.1
...
=== Logstash Commits between 7.8 and 7.8.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.8.0..7.8"

8f983a1cd - (HEAD -> 7.8, origin/7.8) Clear `JAVA_HOME` to use bundled JDK for Elasticsearch (2 hours ago) <Rob Bavey>
ceac229fa - update benchmark-cli dependencies (5 days ago) <Joao Duarte>
ab1bacfda - Update patch plugin versions in gemfile lock for 7.8.1 (#12080) (5 days ago) <Logstash Machine>
a301ae9fe - [7.8 bp] Add wait to `stop_es` integration test helper function (#12078) (6 days ago) <Rob Bavey>
837e8c648 - make PQ and DLQ tests use less disk space (6 days ago) <Joao Duarte>
61013440a - fix pipeline spec that didn't wait for pipeline to terminate (6 days ago) <Joao Duarte>
9b37f17d0 - ensure pipeline terminates execution before doing assertion (6 days ago) <Joao Duarte>
9c21d3595 - remove need for extra ShutdownWatcher thread (7 days ago) <Joao Duarte>
435007f1e - do not call agent.converge_state_and_update before agent.execute (8 days ago) <Colin Surprenant>
b0223266d - release queue dir lock upon exceptions while opening queue (8 days ago) <Colin Surprenant>
9ae14eec7 - improve test for cache difference (12 days ago) <Joao Duarte>
0310ca00c - Doc:Add info on using api keys for access Co-authored-by: João Duarte <jsvd@users.noreply.github.com> (12 days ago) <Karen Metts>
6bdecd039 - Ensure line codec can be found in example ruby filter (#12042) (12 days ago) <vijairaj>
ec23229ae - Fix missed import (13 days ago) <andsel>
84f915441 - Changed the assignment of plugin.id to load the value dynamically istead of hardcode (13 days ago) <Colin Surprenant>
ca0b7d789 - [Doc]Release notes for 7.8 (#12033) (3 weeks ago) <Karen Metts>
de651003d - bump version to 7.8.1 (3 weeks ago) <Joao Duarte>
59167cf94 - Add link conversion from Markdown to AsciiDoctor (#11508) (3 weeks ago) <Rob Bavey>
c4667d897 - [DOCS] Fixes Stack Overview links (#12025) (#12027) (3 weeks ago) <Lisa Cawley>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.8.0..7.8 *.release"
Changed plugin versions:
logstash-filter-xml: 4.1.0 -> 4.1.1
logstash-input-beats: 6.0.9 -> 6.0.11
logstash-input-elasticsearch: 4.6.0 -> 4.6.2
