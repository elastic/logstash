...
* Eliminated log warning about unknown gauge metric type when using pipeline-to-pipeline communication. https://github.com/elastic/logstash/pull/17721[#17721]
