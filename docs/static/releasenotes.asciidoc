...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v6.8.17

=== Logstash Commits between 6.8 and 6.8.16

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v6.8.16..6.8"

fd3d0a8ed - (HEAD -> 6.8, origin/6.8) Update patch plugin versions in gemfile lock for 6.8.17 (#13026) (4 hours ago) <Logstash Machine>
fd5fd63df - Release: bump version to 6.8.17 (#12926) (5 weeks ago) <Andrea Selva>
8dd39ef96 - Created release notes for v6.8.16 (#12922) (5 weeks ago) <Andrea Selva>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v6.8.16..6.8 *.release"
Changed plugin versions:
logstash-codec-multiline: 3.0.10 -> 3.0.11
logstash-filter-aggregate: 2.9.1 -> 2.9.2
logstash-filter-fingerprint: 3.2.1 -> 3.2.4
logstash-filter-kv: 4.4.0 -> 4.4.1
logstash-filter-metrics: 4.0.6 -> 4.0.7
logstash-filter-ruby: 3.1.5 -> 3.1.7
logstash-filter-sleep: 3.0.6 -> 3.0.7
logstash-input-file: 4.1.17 -> 4.1.18
logstash-input-http: 3.3.5 -> 3.3.7
logstash-input-snmp: 1.2.2 -> 1.2.7
logstash-input-sqs: 3.1.2 -> 3.1.3
logstash-input-syslog: 3.4.3 -> 3.4.5
