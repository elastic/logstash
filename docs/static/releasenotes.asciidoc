...
* <<logstash-6-8-12,Logstash 6.8.12>>
...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v6.8.22

* bump version to 6.8.22 https://github.com/elastic/logstash/pull/13507[#13507]
* update readme wrt 6.8.22 https://github.com/elastic/logstash/pull/13509[#13509]
* bump Log4j dependency to 2.17.0 on 6.8 https://github.com/elastic/logstash/pull/13545[#13545]

=== Logstash Commits between 6.8 and 6.8.21

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v6.8.21..6.8"

9a394e700 - (HEAD -> 6.8, origin/6.8) bump lock file for 6.8.22 (#13553) (3 minutes ago) <Logstash Machine>
aa688a08a - bump Log4j dependency to 2.17.0 on 6.8 (#13545) (5 hours ago) <João Duarte>
5bd5f9812 - update readme wrt 6.8.22 (#13509) (4 days ago) <João Duarte>
0630ed783 - Doc: Add dep note to 6.8.21 release notes (#13517) (4 days ago) <Karen Metts>
1a209ec56 - Release notes for 6.8.21 (#13502) (5 days ago) <Logstash Machine>
45831020d - bump version to 6.8.22 (#13507) (5 days ago) <João Duarte>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v6.8.21..6.8 *.release"
Changed plugin versions:
logstash-filter-date: 3.1.9 -> 3.1.13
logstash-filter-dissect: 1.2.0 -> 1.2.3
logstash-filter-geoip: 5.0.3 -> 5.0.4
logstash-input-azure_event_hubs: 1.1.4 -> 1.4.2
logstash-input-beats: 5.1.9 -> 5.1.10
logstash-input-dead_letter_queue: 1.1.5 -> 1.1.7
logstash-input-http: 3.3.7 -> 3.4.4
logstash-input-tcp: 5.2.3 -> 5.2.6
---------- DELETE UP TO HERE ------------
...
* Use correct headers api for redirects in plugin manager http client https://github.com/elastic/logstash/pull/13411[#13411]

**Updates to dependencies**

* Update log4j dependencies https://github.com/elastic/logstash/pull/13500[#13500]
...
Fix thread safety issues with the JavaKeystore implementation of the secret store https://github.com/elastic/logstash/pull/12237[#12237]
