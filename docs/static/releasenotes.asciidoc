...
* Fixed bugs in DLQ 
** throwing `java.nio.file.NoSuchFileException` when finalize the segment https://github.com/elastic/logstash/pull/15233[15233]
** sorting DLQ file in wrong order https://github.com/elastic/logstash/pull/15246[#15246]
...
*Elastic Serverless Forwarder 0.1.2*
