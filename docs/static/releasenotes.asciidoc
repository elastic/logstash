...
* Add support to add and remove multiple keystore keys in a single operation https://github.com/elastic/logstash/pull/15739[#15739]
* Docker: Update Iron Bank base image to ubi9.2 (#15490) (3 months ago) <Rob Bavey>
...
* Add reference to ECK https://github.com/elastic/logstash/pull/15565[#15565]
* Add monitoring for serverless https://github.com/elastic/logstash/pull/15636[#15636]
* Add docs for extending integrations with filter-elastic_integrations https://github.com/elastic/logstash/pull/15674[#15674]
* Update Logstash intro and security overview for serverless https://github.com/elastic/logstash/pull/15663[#15663]
* Update the Logstash to Logstash Native section to reflect the multiple hosts usage https://github.com/elastic/logstash/pull/15512[#15512]
