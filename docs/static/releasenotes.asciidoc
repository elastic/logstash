...
=== Logstash Pull Requests with label v8.6.1

* Update build.gradle - update snakeyaml https://github.com/elastic/logstash/pull/14563[#14563]
* [doc] update Debian/Ubuntu instructions following apt-key deprecation https://github.com/elastic/logstash/pull/14835[#14835]
* Backport PR #14563 to 8.6: Update build.gradle - update snakeyaml https://github.com/elastic/logstash/pull/14848[#14848]

=== Logstash Commits between 8.6 and 8.6.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.6.0..8.6"

6a248b509 - (HEAD -> 8.6, origin/8.6) Update snakeyaml to 1.33 (#14848) (23 hours ago) <github-actions[bot]>
ce1f7c90c - Bump version to next 8.6.1 (#14829) (2 weeks ago) <Andrea Selva>
fff10aaf4 - Backport the commit 4b020631f3a3ee12af0c31ecc7398058e83bd59b to 8.6 (#14834) (2 weeks ago) <Andrea Selva>
da4be346c - Release notes for 8.6.0 (#14762) (2 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.6.0..8.6 *.release"
