...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v7.11.2

* Separate "not terminated" state in "loading" and "running" https://github.com/elastic/logstash/pull/12444[#12444]
* bump lock file for 7.11.1 https://github.com/elastic/logstash/pull/12660[#12660]
* [backport #12444 7.11] Separate "not terminated" pipeline state into "running" and "loading". https://github.com/elastic/logstash/pull/12716[#12716]

=== Logstash Commits between 7.11 and 7.11.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.11.1..7.11"

5ea72dd81 - (HEAD -> 7.11, origin/7.11) Separate "not terminated" pipeline state into "running" and "loading". (#12716) (9 hours ago) <Andrea Selva>
854a58b5d - Update patch plugin versions in gemfile lock for 7.11.2 (#12705) (2 days ago) <Logstash Machine>
e9d48e8e9 - bump lock file for 7.11.1 (#12660) (2 weeks ago) <Logstash Machine>
00449470b - bump version to 7.11.2 (#12677) (2 weeks ago) <João Duarte>
4faa50eb0 - Release notes for 7.11.1 (#12674) (2 weeks ago) <Logstash Machine>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.11.1..7.11 *.release"
Changed plugin versions:
logstash-filter-elasticsearch: 3.9.0 -> 3.9.3
logstash-filter-geoip: 6.0.3 -> 6.0.5
logstash-filter-metrics: 4.0.6 -> 4.0.7
logstash-input-beats: 6.0.12 -> 6.0.14
...
logstash-output-elasticsearch: 10.8.1 -> 10.8.4
