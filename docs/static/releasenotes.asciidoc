...
* Negative acknowledgment of a batch. With this functionality a plugin can request the abortion a batch of event.
  When used in combination with persisted queue it enables the reprocessing on Logstash restart https://github.com/elastic/logstash/pull/14940[#14940]
