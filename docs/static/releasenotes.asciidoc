...
=== Logstash Pull Requests with label v7.17.11

=== Logstash Commits between 7.17 and 7.17.10

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.17.10..7.17"

9c4c3c10a - (HEAD -> 7.17, origin/7.17) Update patch plugin versions in gemfile lock (#15101) (40 minutes ago) <github-actions[bot]>
edade46bc - bump to 7.17.11 (#15036) (7 weeks ago) <João Duarte>
06ae8240b - Release notes for 7.17.10 (#15026) (8 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.17.10..7.17 *.release"
...
logstash-integration-rabbitmq: 7.3.1 -> 7.3.3
