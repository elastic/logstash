...
* Makes `monitoring.cluster_uuid` a configurable variable that can pass to docker container with environment flag https://github.com/elastic/logstash/pull/14425[#14425]
* Fixes an issue of `queue.checkpoint.retry` that not respect the user config https://github.com/elastic/logstash/pull/14487[#14487]
