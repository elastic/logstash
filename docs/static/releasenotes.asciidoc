...
In Logstash, we responded by bumping the log4j version to 2.17.0 in https://github.com/elastic/logstash/pull/13548[#13548] to bypass the vulnerability.

IMPORTANT: Update to Logstash version 6.8.22 or 7.16.2 to get this fix.
...
* Update log4j dependency to 2.17.0
* Update Log4j dependency to 2.16, ensuring this plugin's runtime relies only on log4j-api instead of providing its own log4j-core. https://github.com/logstash-plugins/logstash-input-tcp/pull/188[#188]
