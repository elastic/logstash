...
=== Logstash Pull Requests with label v8.10.3

* Expanded the description how to size the memory of the JVM https://github.com/elastic/logstash/pull/15210[#15210]
* Backport PR #15210 to 8.10: Expanded the description how to size the memory of the JVM https://github.com/elastic/logstash/pull/15350[#15350]

=== Logstash Commits between 8.10 and 8.10.2

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.10.2..8.10"

63339bee9 - (HEAD -> 8.10, origin/8.10) bump lock file for 8.10 (#15385) (7 hours ago) <github-actions[bot]>
a62cdce6a - bump lock file for 8.10 (#15376) (16 hours ago) <github-actions[bot]>
69ea40cc9 - (origin/mashhur-patch-1) [backport 8.10] Expanded the description how to size the memory of the JVM (#15210) (#15350) (9 days ago) <github-actions[bot]>
872f5a177 - Bump 8.10.3 (#15338) (2 weeks ago) <Andrea Selva>
a0426a066 - Release notes for 8.10.2 (#15336) (2 weeks ago) <github-actions[bot]>
f6d9a989f - bump lock file for 8.10 (#15334) (2 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.10.2..8.10 *.release"
...
logstash-integration-kafka: 11.3.0 -> 11.3.1
