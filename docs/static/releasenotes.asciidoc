...
* Avoid warning log from status log4j logger when new codecs are created by clone. https://github.com/elastic/logstash/pull/14727[#14727]
...
* Update bundled JDK to 11.0.17+8 https://github.com/elastic/logstash/pull/14729[#14729]
