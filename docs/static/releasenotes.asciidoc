...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v6.6.0

* Remove excess period from logstash-plugin error reporting https://github.com/elastic/logstash/pull/9749[#9749]
* bump to 6.6.0 https://github.com/elastic/logstash/pull/10068[#10068]
* Replace generated for-loops with static method calls https://github.com/elastic/logstash/pull/10133[#10133]
* Add common base class for generated Dataset classes https://github.com/elastic/logstash/pull/10136[#10136]
* [6.x clean backport of #10148] upgrade rack to version 1.6.11  https://github.com/elastic/logstash/pull/10151[#10151]
* Java plugin API (experimental) https://github.com/elastic/logstash/pull/10216[#10216]
* Increase default number of threads reported by hot_threads https://github.com/elastic/logstash/pull/10218[#10218]
* Add list tag for Codec javadoc https://github.com/elastic/logstash/pull/10219[#10219]
* Add Gemfile.jruby-2.3.lock.release file 6.6.0 https://github.com/elastic/logstash/pull/10221[#10221]
* Add option for PQ checkpoint retry https://github.com/elastic/logstash/pull/10246[#10246]
* Add documentation for java-execution flag https://github.com/elastic/logstash/pull/10248[#10248]
* Ignore some unit tests that are failing on some Windows platforms https://github.com/elastic/logstash/pull/10255[#10255]
* add lockfile bump and release notes draft tools https://github.com/elastic/logstash/pull/10265[#10265]
* [6.6 clean backport of #10269] properly set thread name in thread context https://github.com/elastic/logstash/pull/10272[#10272]
* Bump http filter to 1.0.0 https://github.com/elastic/logstash/pull/10281[#10281]

=== Logstash Commits between 6.6 and 6.5.4

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v6.5.4..6.6"

d53ba7e29 - (HEAD -> 6.6, origin/6.6) add missing ruby shebang to release tools (16 minutes ago) <Joao Duarte>
84f3afe2b - Bump http filter to 1.0.0 (#10281) (4 hours ago) <João Duarte>
13f240e65 - Update lock file for 6.6 (#10278) (21 hours ago) <João Duarte>
bbf341b24 - properly set thread name in thread context (#10272) (23 hours ago) <Colin Surprenant>
b578091c1 - Remove excess period (2 days ago) <Josh Soref>
494866389 - add lockfile bump and release notes draft tools (3 days ago) <Joao Duarte>
c1db62e44 - Ignore some unit tests that are failing on some Windows platforms (#10255) (4 days ago) <Dan Hermann>
3ab49680d - abort plugin bump script if base version not found (4 days ago) <Joao Duarte>
39b9523e5 - add option for PQ checkpoint retry (#10246) (7 days ago) <Dan Hermann>
a6e39d128 - Add documentation for java-execution flag and remove any references to beta status (8 days ago) <Dan Hermann>
4319c58ef - Add Gemfile.jruby-2.3.lock.release file 6.6.0 (#10221) (3 weeks ago) <Guy Boertje>
8ac48f4ff - Increase default number of threads reported by hot_threads (3 weeks ago) <Dan Hermann>
e60afab43 - add http and memcached filters to default set of plugins (3 weeks ago) <Joao Duarte>
dfef40dbe - Add list tag for Codec javadoc (3 weeks ago) <Dan Hermann>
6a478b088 - Java plugin API (4 weeks ago) <Dan Hermann>
7f4856999 - tests: remove kafka deprecated `--new-consumer` flag in setup (4 weeks ago) <Ry Biesemeyer>
46156cff4 - Release notes for 6.5.3 (5 weeks ago) <Guy Boertje>
81019d0b3 - Add Zing JVM to the list of supported garbage collectors. (5 weeks ago) <dmitriisilin>
177b5dc99 - Release notes for 6.5.2 (5 weeks ago) <João Duarte>
a9ceaaf7a - Remove codec-cloudtrail from skiplist (6 weeks ago) <Karen Metts>
5a8af51c9 - Move new field ref content to deepdive (6 weeks ago) <Karen Metts>
170d21d70 - FieldReference: add formal grammar definition docs (6 weeks ago) <Ry Biesemeyer>
1e099f099 - setting a list config to empty array should not result in nil (6 weeks ago) <Joao Duarte>
f8ad6d54b - skip prerelease gems on plugin version bump rake task (7 weeks ago) <Joao Duarte>
0f3f0f6fe - Update Kafka download version (7 weeks ago) <Rob Bavey>
4585af6fc - Update release notes for 6.4.3 (7 weeks ago) <João Duarte>
98929aed0 - Add release notes for 6.5.1 (8 weeks ago) <João Duarte>
ffa38f167 - upgrade rack to version 1.6.11 (#10148) (#10151) (8 weeks ago) <Colin Surprenant>
80e0e68f8 - release notes for 6.5.0 (8 weeks ago) <Dan Hermann>
5b69b5326 - add common base class for generated Dataset classes (9 weeks ago) <Dan Hermann>
d3414a2c7 - generalize method parameters (9 weeks ago) <Dan Hermann>
fae93ca90 - replace for-loop with static method calls (9 weeks ago) <Dan Hermann>
3496e56f7 - rename appsearch to elastic_app_search (9 weeks ago) <Joao Duarte>
715f04c71 - only start monitoring pipeline after valid license (#10106) (9 weeks ago) <João Duarte>
c7141f82f - Incorporate review comments (10 weeks ago) <Karen Metts>
75a6b7992 - Minor wording tweaks while waiting for review comments (10 weeks ago) <Karen Metts>
869cad9f9 - Restructure logging topic to clarify and make it scannable (10 weeks ago) <Karen Metts>
8bd805db6 - Add conditional wrappers to codec table rows (2 months ago) <Karen Metts>
94edb575c - Add conditional directives to handle plugins with no codec (2 months ago) <Karen Metts>
55be6dfd0 - Fixed indents (2 months ago) <Karen Metts>
e924d3d43 - Add SC and EB input TLS support for the Logstash ArcSight module (#10056) (2 months ago) <Guy Boertje>
e14ba09a3 - Backport of #10052 (2 months ago) <Dan Hermann>
d19860a88 - Handle equality checks on list and map types (3 months ago) <Dan Hermann>
2cffb4c90 - bump to 6.6.0 (3 months ago) <Joao Duarte>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v6.5.4..6.6 *.release"
Changed plugin versions:
logstash-filter-aggregate: 2.8.0 -> 2.9.0
logstash-filter-elasticsearch: 3.4.0 -> 3.6.0
logstash-filter-http: 1.0.0 -> 1.0.0
logstash-filter-memcached: 0.1.1 -> 0.1.1
logstash-filter-split: 3.1.6 -> 3.1.7
logstash-input-beats: 5.1.6 -> 5.1.8
logstash-input-file: 4.1.8 -> 4.1.9
logstash-input-gelf: 3.1.1 -> 3.2.0
logstash-input-http: 3.2.2 -> 3.2.4
logstash-input-kafka: 8.2.1 -> 8.3.1
logstash-output-elasticsearch: 9.2.4 -> 9.3.0
logstash-output-kafka: 7.2.1 -> 7.3.1
