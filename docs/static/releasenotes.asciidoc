...
=== Logstash Pull Requests with label v7.17.25

=== Logstash Commits between 7.17 and 7.17.24

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.17.24..7.17"

de7e0d04c - (HEAD -> 7.17, origin/7.17) bump lock file for 7.17 (#16559) (5 days ago) <github-actions[bot]>
0e19e42a4 - Pin CI container images to v0.4 for 7.17 branch (#16497) (3 weeks ago) <Dimitrios Liappis>
34c84f6f7 - bump core to 7.17.25 (#16438) (6 weeks ago) <kaisecheng>
9ea8a15af - Release notes for 7.17.24 (#16415) (6 weeks ago) <github-actions[bot]>
d8a5f4977 - Update z_rubycheck.rake to no longer inject Xmx1g (#16420) (7 weeks ago) <João Duarte>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.17.24..7.17 *.release"
