...
=== Logstash Pull Requests with label v8.1.3

* Bump Logstash version to 8.1.3 https://github.com/elastic/logstash/pull/13964[#13964]

=== Logstash Commits between 8.1 and 8.1.2

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.1.2..8.1"

d458e219e - (HEAD -> 8.1, origin/8.1) Bump Logstash version to 8.1.3 (#13964) (12 days ago) <João Duarte>
fa9bfea9f - Release notes for 8.1.2 (#13940) (13 days ago) <Logstash Machine>
16b0af03b - [DOC] precedence between environment variables and yml in docker (#12198) (#13948) (2 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.1.2..8.1 *.release"
