...
* Significantly improves write speeds to the persistent queue when a pipeline's workers are caught up with already-written events [#17789](https://github.com/elastic/logstash/pull/17789)
