...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v7.10.2

=== Logstash Commits between 7.10 and 7.10.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.10.1..7.10"

4352ef940 - (HEAD -> 7.10, origin/7.10) bump lock file for 7.10.2 (#12548) (7 hours ago) <Logstash Machine>
327e86a75 - Doc: Add info on contributor program (#12547) (2 days ago) <Karen Metts>
281a60685 - Update jrjackons and databind versions (#12385) (3 weeks ago) <Rob Bavey>
b3524f278 - REE: output reload interval as nanos instead of object (#12515) (4 weeks ago) <Rob Bavey>
ff5878833 - bumped version to 7.10.2 (4 weeks ago) <andsel>
814e8aa79 - Created release notes for 7.10.1 (4 weeks ago) <Karol Bucek>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.10.1..7.10 *.release"
Changed plugin versions:
logstash-input-beats: 6.0.11 -> 6.0.12
logstash-input-file: 4.2.2 -> 4.2.3
logstash-output-elasticsearch: 10.7.0 -> 10.7.3
---------- DELETE UP TO HERE ------------
