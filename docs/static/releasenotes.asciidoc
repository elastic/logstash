...
=== Logstash Pull Requests with label v7.14.1

* Bump plugins for 7.14.1 release https://github.com/elastic/logstash/pull/13162[#13162]
* Test: better logging reconfiguration asserts https://github.com/elastic/logstash/pull/13164[#13164]

=== Logstash Commits between 7.14 and 7.14.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.14.0..7.14"

1e8ea0491 - (HEAD -> 7.14, origin/7.14) Backport #13164: Test: improve monitoring api logging asserts (#13171) (70 minutes ago) <Karol Bucek>
23933cc7d - Bump plugins for 7.14.1 release (#13162) (2 days ago) <Andrea Selva>
82595e28a - Doc: Add aarch64 support to 7.14.0 release notes (#13132) (10 days ago) <Karen Metts>
63c76e52f - Backport Docs: fix java filter unit test link (#13124) (2 weeks ago) <Karol Bucek>
773bf6707 - Release notes for 7.14.0 (#13089) (3 weeks ago) <Logstash Machine>
d78e19611 - Bump 7.14.1 (#13116) (3 weeks ago) <Ry Biesemeyer>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.14.0..7.14 *.release"
Changed plugin versions:
logstash-codec-cef: 6.2.2 -> 6.2.3
logstash-codec-graphite: 3.0.5 -> 3.0.6
logstash-codec-netflow: 4.2.1 -> 4.2.2
logstash-filter-elasticsearch: 3.9.3 -> 3.9.5
logstash-input-elasticsearch: 4.9.1 -> 4.9.3
logstash-integration-jdbc: 5.1.4 -> 5.1.5
logstash-mixin-event_support: 1.0.1 -> 1.0.1
logstash-output-elasticsearch: 11.0.2 -> 11.0.3
