...
=== Logstash Pull Requests with label v7.17.2

* i18n: alias logstash.runner.configuration.* under logstash.agent.configuration https://github.com/elastic/logstash/pull/13244[#13244]
* pipeline-info: increase safety of transforming stats https://github.com/elastic/logstash/pull/13345[#13345]
* geoip-db: support `http_proxy` environment variable https://github.com/elastic/logstash/pull/13410[#13410]
* api: avoid 5xx when stats/events not yet populated https://github.com/elastic/logstash/pull/13424[#13424]
...
* artifacts: omit openssl_pkcs8_pure specs from built artifacts https://github.com/elastic/logstash/pull/13715[#13715]
* Feat: conservative plugin (dependency) updates by default https://github.com/elastic/logstash/pull/13794[#13794]
* Backport PR #13794 to 7.17: Feat: conservative plugin (dependency) updates by default https://github.com/elastic/logstash/pull/13804[#13804]
* [Doc] update queue.max_bytes and queue.page_capacity https://github.com/elastic/logstash/pull/13833[#13833]
* Fix Logstash cli tools to use the selected JDK under Windows https://github.com/elastic/logstash/pull/13839[#13839]
* Backport PR #13410 to 7.17: geoip-db: support `http_proxy` environment variable https://github.com/elastic/logstash/pull/13841[#13841]
* Backport PR #13244 to 7.17: i18n: alias logstash.runner.configuration.* under logstash.agent.configuration https://github.com/elastic/logstash/pull/13843[#13843]
* Backport PR #13424 to 7.17: api: avoid 5xx when stats/events not yet populated https://github.com/elastic/logstash/pull/13845[#13845]
* Backport PR #13345 to 7.17: pipeline-info: increase safety of transforming stats https://github.com/elastic/logstash/pull/13850[#13850]
* Backport PR #13715 to 7.17: artifacts: omit openssl_pkcs8_pure specs from built artifacts https://github.com/elastic/logstash/pull/13852[#13852]
* speed up artifact file listing https://github.com/elastic/logstash/pull/13862[#13862]
* [Backport 7.17]Fix Logstash cli tools to use the selected JDK under Windows (#13839) https://github.com/elastic/logstash/pull/13863[#13863]
* Backport PR #13862 to 7.17: speed up artifact file listing https://github.com/elastic/logstash/pull/13865[#13865]
* Backport PR #13687 to 7.17: bump jdk to 11.0.14.1+1 https://github.com/elastic/logstash/pull/13870[#13870]
* Quotes java executable path in case it contains spaces https://github.com/elastic/logstash/pull/13881[#13881]
* [Backport #13881 7.17]Quotes java executable path in case it contains spaces https://github.com/elastic/logstash/pull/13893[#13893]
* Update Jackson databind in ingest-converter tool https://github.com/elastic/logstash/pull/13900[#13900]
* add backoff to checkpoint write https://github.com/elastic/logstash/pull/13902[#13902]
* Backport PR #13833 to 7.17: [Doc] update queue.max_bytes and queue.page_capacity https://github.com/elastic/logstash/pull/13910[#13910]
* Backport PR #13900 to 7.17: Update Jackson databind in ingest-converter tool https://github.com/elastic/logstash/pull/13917[#13917]
* Backport PR #13902 to 7.17: add backoff to checkpoint write https://github.com/elastic/logstash/pull/13931[#13931]

=== Logstash Commits between 7.17 and 7.17.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.17.1..7.17"

8c8eac0e4 - (HEAD -> 7.17, origin/7.17) bump lock file for 7.17 (#13927) (2 minutes ago) <github-actions[bot]>
86ed16008 - add backoff to checkpoint write (#13902) (#13931) (29 minutes ago) <github-actions[bot]>
7df02cc82 - Update Jackson databind in ingest-converter tool (#13900) (#13917) (6 days ago) <github-actions[bot]>
898da5f41 - fix default argument handling in rake artifact task (#13904) (6 days ago) <João Duarte>
59a30d8b3 - [Doc] update queue.max_bytes and queue.page_capacity (#13833) (#13910) (6 days ago) <github-actions[bot]>
3300df77b - Deps: unpin jruby-openssl in logstash-core (#13903) (7 days ago) <Karol Bucek>
67dea141c - Quotes java executable path in case it contains spaces (#13881) (#13893) (10 days ago) <Andrea Selva>
e06efed62 - bump jdk to 11.0.14.1+1 (#13687) (#13870) (2 weeks ago) <João Duarte>
011cc5ba7 - i18n: alias logstash.runner.configuration.* under logstash.agent.configuration (#13244) (#13843) (2 weeks ago) <Ry Biesemeyer>
a491462e6 - api: avoid 5xx when stats/events not yet populated (#13424) (#13845) (2 weeks ago) <Ry Biesemeyer>
5d0ad6ea3 - pipeline-info: increase safety of transforming stats (#13345) (#13850) (2 weeks ago) <Ry Biesemeyer>
f0fa13d18 - speed up artifact file listing (#13862) (#13865) (2 weeks ago) <João Duarte>
a7893d8bb - [Backport 7.17]Fix Logstash cli tools to use the selected JDK under Windows (#13839) (#13863) (2 weeks ago) <Andrea Selva>
6fe6bc105 - Backport PR #13715 to 7.17: artifacts: omit openssl_pkcs8_pure specs from built artifacts (#13852) (3 weeks ago) <Ry Biesemeyer>
fb68365e4 - geoip-db: support `http_proxy` environment variable (#13410) (#13841) (3 weeks ago) <Ry Biesemeyer>
4f6419fd1 - Build: avoid doing a redundant bundle install (#13820) (#13824) (3 weeks ago) <Karol Bucek>
6f447440f - Feat: conservative plugin (dependency) updates by default (#13794) (#13804) (3 weeks ago) <Karol Bucek>
f46c9faa2 - bump core version to 7.17.2 (#13817) (3 weeks ago) <kaisecheng>
60688f237 - Release notes draft for 7.17.1 (#13813) (4 weeks ago) <Logstash Machine>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.17.1..7.17 *.release"
Changed plugin versions:
logstash-codec-cef: 6.2.3 -> 6.2.4
logstash-filter-geoip: 7.2.11 -> 7.2.12
logstash-filter-truncate: 1.0.4 -> 1.0.5
logstash-input-dead_letter_queue: 1.1.10 -> 1.1.11
logstash-integration-jdbc: 5.2.3 -> 5.2.4
logstash-output-tcp: 6.0.1 -> 6.0.2
...
* Switches behavior of add_tag and add_field, now tags and fields are added only when the truncation happens 
    on any field or nested field https://github.com/logstash-plugins/logstash-filter-truncate/pull/7[#7].
