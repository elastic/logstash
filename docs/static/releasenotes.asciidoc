...
Starting with 8.15.0, {ls} will provide an extra Docker image flavor based on the https://github.com/wolfi-dev[wolfi] Linux distribution (https://github.com/elastic/logstash/pull/16189[#16189]). To use the image append "-wolfi" to the image name:
