...
=== Logstash Pull Requests with label v8.17.9

=== Logstash Commits between 8.17 and 8.17.8

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.17.8..8.17"

78e976b40 - (HEAD -> 8.17, origin/8.17) bump lock file for 8.17 (#17779) (26 hours ago) <github-actions[bot]>
133101764 - [8.19] Standardize image artifacts name (#17757) (#17761) (9 days ago) <mergify[bot]>
87dde3a1f - Upgrade OSS and Full docker image to Ubuntu 24.04 (#17743) (#17750) (9 days ago) <mergify[bot]>
2f8a19960 - [8.17] (backport #17727) Standardize image artifact name (#17752) (12 days ago) <mergify[bot]>
ed990ad58 - Bump to 8.17.9 version  (#17714) (2 weeks ago) <Edmo Vamerlatti Costa>
83da95200 - Release notes for 8.17.8 (#17711) (2 weeks ago) <github-actions[bot]>
1a876e235 - Added support for GAUGE_LIST metric type (#17721) (#17723) (2 weeks ago) <mergify[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.17.8..8.17 *.release"
