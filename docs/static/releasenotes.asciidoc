...
=== Logstash Pull Requests with label v7.17.21

=== Logstash Commits between 7.17 and 7.17.20

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.17.20..7.17"

d1477d0ad - (HEAD -> 7.17, origin/7.17) Release notes for 7.17.20 (#16067) (2 weeks ago) <github-actions[bot]>
8cfc4a091 - bump version to 7.17.21 (#16070) (2 weeks ago) <João Duarte>
3e412daaa - Update patch plugin versions in gemfile lock (#16061) (3 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.17.20..7.17 *.release"
