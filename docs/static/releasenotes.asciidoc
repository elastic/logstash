...
* Provide opt-in flag to avoid fields name clash when log format is json https://github.com/elastic/logstash/pull/15969[#15969]
...
* Backport PR #15969 to 8.14: Provide opt-in flag to avoid fields name clash when log format is json https://github.com/elastic/logstash/pull/16094[#16094]
* upgrade jruby to 9.4.7.0 https://github.com/elastic/logstash/pull/16125[#16125]
* Backport PR #16125 to 8.14: upgrade jruby to 9.4.7.0 https://github.com/elastic/logstash/pull/16126[#16126]
* force ruby-maven-libs constraint to >= 3.9.6.1 https://github.com/elastic/logstash/pull/16130[#16130]
* Backport PR #16130 to 8.14: force ruby-maven-libs constraint to >= 3.9.6.1 https://github.com/elastic/logstash/pull/16131[#16131]
* Release notes for 8.13.4 https://github.com/elastic/logstash/pull/16144[#16144]
* Backport PR #16144 to 8.14: Release notes for 8.13.4 https://github.com/elastic/logstash/pull/16151[#16151]

=== Logstash Commits between 8.14 and 8.13.4

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v8.13.4..8.14"

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v8.13.4..8.14 *.release"
