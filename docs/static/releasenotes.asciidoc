...
=== Logstash Pull Requests with label v7.17.22

* [DOC] Remove reference to puppet LS module https://github.com/elastic/logstash/pull/12356[#12356]
* Backport PR #12356 to 7.17: [DOC] Remove reference to puppet LS module https://github.com/elastic/logstash/pull/16167[#16167]

=== Logstash Commits between 7.17 and 7.17.21

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.17.21..7.17"

0ccc0c3ff - (HEAD -> 7.17, origin/7.17) [DOC] Remove reference to puppet LS module (#12356) (#16167) (13 days ago) <github-actions[bot]>
c2ffe2f7b - bump 7.17.22 (#16122) (4 weeks ago) <kaisecheng>
5791f5fc1 - Release notes for 7.17.21 (#16109) (4 weeks ago) <github-actions[bot]>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.17.21..7.17 *.release"
