...
I will update the role shown here after finalizing https://github.com/elastic/elasticsearch/pull/94348
...
Will the Logstash integration be GA for 8.7.0? If not, I will add a bit of text
to explain the filter options at the bottom of the page.
