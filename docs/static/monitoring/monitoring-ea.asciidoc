...
Make sure that **Logs** and
**Metrics (Technical Preview)** are turned on, and **Metrics (Stack Monitoring)** is turned off
+
--
[role="screenshot"]
image::images/integration-configure-collectors.png[{kib} home page]
--
...
[discrete]
[[view-data]]
== Step 3: Monitor Logstash logs and metrics
...
. Open the **[Metrics Logstash] Logstash overview** dashboard to view overall performance. Then follow the navigation panel to further drill down into Logstash performance.
+
[role="screenshot"]
