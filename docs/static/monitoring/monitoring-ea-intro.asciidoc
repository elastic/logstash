...
* <<dashboard-monitoring-with-elastic-agent,{ecloud} or self-managed dashboards>>. {agent} collects
...
* <<serverless-monitoring-with-elastic-agent,{ecloud} dashboards (serverless)>>. {agent} collects
