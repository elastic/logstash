...
==== Define `cluster_uuid`
If your each pipeline contains <<plugins-outputs-elasticsearch,{es} output plugin>>,
*Stack Monitoring* automatically figures out the `cluster_uuid` and no need to specify it.
