...
=== Collect {ls} monitoring data for {serverless-full} dashboards
[subs="attributes"]
++++
<titleabbrev>Collect monitoring data for {serverless-short} dashboards</titleabbrev>
++++
...
Complete these steps as you prepare to collect and ship monitoring data for {serverless} dashboards:
...
[discrete]
[[add-logstash-integration-svrless]]
...
https://github.com/elastic/integrations/blob/main/packages/logstash/_dev/build/docs/README.md
https://docs.elastic.co/serverless/observability/what-is-observability-serverless
