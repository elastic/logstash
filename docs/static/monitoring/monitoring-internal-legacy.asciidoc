...
host, and select **Stack Monitoring** from the side navigation. If it is an initial setup, choose *Or, set up with self monitoring* option from the UI and click *Turn on monitoring* button.
