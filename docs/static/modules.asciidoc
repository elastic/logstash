...
[source,shell]
----
bin/logstash --modules arcsight -M "arcsight.var.elasticsearch.hosts=my-es-cloud"
----
...
----
bin/logstash --modules arcsight --cloud.id <your-cloud-id> --cloud.auth <your-cloud-auth>
----
