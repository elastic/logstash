...
the higher percentage you can use. The heap size used by the process comprises native
memory needed by the JVM itself to work, the direct memory used for IO operations and
the Java heap used to execute Logstash.
