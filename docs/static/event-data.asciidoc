...
These configuration options work only within filter and output blocks because they depend on events and fields.
...
This format enables you to refer to field values from within other strings. 
