...
Symptoms of persistent queue problems include {ls} or pipelines not starting successfully, accompanied by an error message similar to this one.
...
The `pqcheck` utility helps you identify which persistent queue--or queues--have been corrupted. 
