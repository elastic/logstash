...
This option allows you to <<ecs-ls, opt-out of ECS compatibility>> modes for all plugins in a pipeline, which will make them behave as they did in Logstash 7.
