...
1b7570c69 - (HEAD -> 9.5, origin/9.5) Update patch plugin versions in gemfile lock (#19353) (14 hours ago) <github-actions[bot]>
a4003c200 - Bump log4j to 2.25.5 (#19335) (#19346) (6 days ago) <mergify[bot]>
4964c098c - Update patch plugin versions in gemfile lock (#19339) (7 days ago) <github-actions[bot]>
bb9d5f62a - [9.5] (backport #19313) Release notes for 9.3.8 (#19325) (9 days ago) <mergify[bot]>
94e5b9b5e - Release notes for 9.4.4 (#19314) (#19322) (9 days ago) <mergify[bot]>
25f351689 - Bump actions/setup-node in the github-actions group across 1 directory (#19316) (#19318) (10 days ago) <mergify[bot]>
2e28f2373 - bump lock file for 9.5 (#19302) (2 weeks ago) <github-actions[bot]>
55cbe4404 - Track 9.next in .ci/logstash-versions.yml (#19301) (2 weeks ago) <Cas Donoghue>
a7c9e1ba4 - chore: deps(updatecli): Bump updatecli version to v0.119.0 (#19295) (#19297) (2 weeks ago) <mergify[bot]>
2e9b5b2aa - [9.5] (backport #19249) Bump jackson and jrjackson dependencies (#19287) (3 weeks ago) <mergify[bot]>
c563ec851 - Downgrade ES client (#19281) (3 weeks ago) <Cas Donoghue>
4a5541998 - [9.5 release] Create gemfile.lock from 9.4 (#19277) (3 weeks ago) <Álex Cámara Lara>
27841cfd1 - Update jruby to 10.0.6.0 (#19264) (3 weeks ago) <Cas Donoghue>
c2f03e0a0 - Bump docker/login-action in the github-actions group across 1 directory (#19269) (3 weeks ago) <dependabot[bot]>
0875e0b10 - Forwardporting 9.3.7 and 9.4.3 release notes to main (#19254) (4 weeks ago) <Mashhur>
9be3f33ea - Fix typos in pipeline.workers documentation (#19238) (5 weeks ago) <James Moon>
1576c0250 - Forwardport 9.3.6 to main (#19231) (5 weeks ago) <Mashhur>
c06b494eb - upgrade puma to 8.x (#19200) (5 weeks ago) <João Duarte>
2a031ac8f - deps: Bump ironbank version to 10.2 (#19218) (5 weeks ago) <github-actions[bot]>
6d894e856 - Bump actions/checkout in the github-actions group across 1 directory (#19217) (5 weeks ago) <dependabot[bot]>
7f7a61ca8 - ci: add team Slack mention to version bump pipeline notifications (#19202) (6 weeks ago) <ninalee12>
eacab559f - Bump OpenTelemetry to 1.62.0 (#19209) (6 weeks ago) <Kaise>
dcd46afa3 - ci: use copilot-requests: write instead of COPILOT_GITHUB_TOKEN PAT (6 weeks ago) <Victor Martinez>
421880d55 - document Logstash's file descriptors usage, limits and sizing guidance (#18584) (6 weeks ago) <João Duarte>
f2400df86 - chore: deps(updatecli): Bump updatecli version to v0.118.0 (#19203) (6 weeks ago) <github-actions[bot]>
ae40e7278 - Enable AI Agentic Workflow for Buildkite build failure analysis (#19196) (7 weeks ago) <Copilot>
04868fe4a - Fix flaky `FileWatchServiceTest` (#19184) (8 weeks ago) <Cas Donoghue>
497b995c7 - chore: deps(updatecli): Bump updatecli version to v0.117.1 (#19183) (8 weeks ago) <github-actions[bot]>
62f479ee6 - [Doc] Clarify API server TLS keystore auto-reload behavior (#19182) (9 weeks ago) <Kaise>
dc2b52321 - Forwardports 9.3.5 and 9.4.2 release notes. (#19176) (9 weeks ago) <Mashhur>
0b09a83ed - Add missed standard types during batch's size estimation (#19158) (9 weeks ago) <Andrea Selva>
c12cc9b9e - Bump the github-actions group across 1 directory with 2 updates (#19163) (9 weeks ago) <dependabot[bot]>
89ef160ec - Remove metrics OTLP dataset config option (#19142) (9 weeks ago) <Emily S>
f71e27b49 - Improve version bump flexibility and automate AWS deps updates to minor automatically while patching dependencies(#19118) (9 weeks ago) <Álex Cámara Lara>
45b237f37 - Create buildkite pipeline to periodically clean up logstash artifact snyk projects (#19139) (9 weeks ago) <Álex Cámara Lara>
9f842f511 - change team name (#19154) (10 weeks ago) <ninalee12>
c904f714c - Remove pipe output plugin from default bundle (#19159) (10 weeks ago) <Kaise>
d33fe7cc0 - Added known issue to version 9.2.0 for batch's estimate type errors (#19157) (10 weeks ago) <Andrea Selva>
849ad93f1 - Fix cgroup test isolation in otel_spec by resetting cached state (#19153) (2 months ago) <Emily S>
664798c06 - Make asciidoc RN generator org aware (#19145) (2 months ago) <Cas Donoghue>
7f72fb733 - Send Logstash Metrics via OTLP (#18857) (2 months ago) <Emily S>
76ca7e2c5 - Add RHEL 10, Oracle Linux 10, Rocky Linux 10, and Alma Linux 10 to exhaustive tests (#19123) (2 months ago) <Kaise>
0be31404c - chore: deps(updatecli): Bump updatecli version to v0.117.0 (#19128) (2 months ago) <github-actions[bot]>
a92145cdb - Remove cgi pin in Gemfile (#19119) (3 months ago) <Ivona Cvija>
ba5d2f108 - Upgrade jrjackson and fasterxml.jackson. (#19103) (3 months ago) <Mashhur>
582ea8823 - Remove legacy output concurrency (#19003) (3 months ago) <Andrew Cholakian>
d583fb7cc - Clear pipeline metrics when a pipeline fails to start (#19091) (3 months ago) <Kaise>
2821f4d18 - [Doc] Automatic reload of certificates (#19065) (3 months ago) <Kaise>
b898885aa - Release notes for 9.4.1 (#19096) (#19097) (3 months ago) <mergify[bot]>
...
4a5172655 - require java 21, since jruby 10 requires it (#19010) (4 months ago) <Rye Biesemeyer>
894ca214c - Optimize DLQ segment directory scans with single-pass logic. (#18970) (4 months ago) <Mashhur>
3254ac755 - [9.3] Add deprecated JDK cipher to release notes (#18949) (#19007) (4 months ago) <mergify[bot]>
c3b4dca7d - Log the estimate of batch metrics memory consumption (#18916) (4 months ago) <Andrea Selva>
f7a42a53f - docs: clarify Gradle test task structure in AGENTS.md (#19004) (4 months ago) <Andrew Cholakian>
3c4fbaf4c - ci: enable use-release-branches for docs workflows (#18992) (4 months ago) <Martijn Laarman>
ce7ef0282 - log4j update to 2.25.4 (#18991) (4 months ago) <Rob Bavey>
3b0163ce5 - chore: deps(updatecli): Bump updatecli version to v0.116.1 (#18988) (4 months ago) <github-actions[bot]>
c4192aed2 - Bump actions/github-script (#18987) (4 months ago) <dependabot[bot]>
2ed80127e - Limit exhaustive test triggers to active branches only (#18975) (4 months ago) <Cas Donoghue>
597df17bc - pin multi_json to 1.19.1 since 1.20.0 has java variant with newer concurrent-ruby pin (#18977) (4 months ago) <João Duarte>
98760509e - add support for cgroupv2 (#18708) (4 months ago) <João Duarte>
82c33d7d1 - Expose ruby_plugin on filter/output delegators (#18936) (4 months ago) <Kaise>
f77ab48b6 - Update jruby to 10.0.5.0 (#18965) (4 months ago) <Cas Donoghue>
...
logstash-filter-elastic_integration: 9.4.5 -> 9.5.2
