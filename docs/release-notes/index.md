...
* A fix to receive gauge metric types in pipeline info which appears in pipeline vertex of node stats API [#18082](https://github.com/elastic/logstash/pull/18082)
