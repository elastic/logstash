...
Starting {{ls}} on Windows or aarch64 Linux/MacOS with 9.2.5 artifacts will result in an fatal error as the bundled JDK will not execute on those platforms.
