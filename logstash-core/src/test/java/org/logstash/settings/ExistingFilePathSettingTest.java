...
public class ExistingFilePathSettingTest {

    @Rule
    public TemporaryFolder temporaryFolder = new TemporaryFolder();

    @Test
    public void whenFileExistsThenValidationPasses() throws IOException {
        File existingFile = temporaryFolder.newFile("existing-file.txt");
        ExistingFilePathSetting sut = new ExistingFilePathSetting("my.file.path", null, false);

        sut.setSafely(existingFile.getAbsolutePath());

        assertThat(sut.value(), equalTo(existingFile.getAbsolutePath()));
    }
