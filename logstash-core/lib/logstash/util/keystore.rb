...
module ::LogStash::Util::KeyStore
  ...
  def self.lookup(name)
    ...
    return unless secret_store # no keystore exists
    secret_store.retrieveSecret(SecretStoreExt.getStoreId(name))
  end

  def self.load_secret_store
