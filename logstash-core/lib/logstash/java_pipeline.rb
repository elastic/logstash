...
module LogStash; class JavaPipeline < AbstractPipeline
  ...
  def start_workers
    ...
    begin
      ...
      batch_output_chunking_trigger_factor = settings.get("pipeline.batch.output_chunking_trigger_factor")
      ...
      pipeline_log_params = default_logging_keys(
        ...
        "pipeline.batch.output_chunking_trigger_factor" => batch_output_chunking_trigger_factor,
