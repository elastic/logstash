 ...
 Setting::WritableDirectory.new("path.data", ::File.join(LogStash::Environment::LOGSTASH_HOME, "data")),
   ...
   Setting::CoercibleString.new("pipeline.ecs_compatibility", "v8", true, %w(disabled v1 v8)),
    ...
    Setting::NullableString.new("interactive", nil, false),
           ...
           Setting::Boolean.new("api.enabled", true).with_deprecated_alias("http.enabled", obsoleted_version: "9"),
            Setting::String.new("api.http.host", "127.0.0.1").with_deprecated_alias("http.host", obsoleted_version: "9"),
         Setting::PortRange.new("api.http.port", 9600..9700).with_deprecated_alias("http.port", obsoleted_version: "9"),
            Setting::String.new("api.environment", "production").with_deprecated_alias("http.environment", obsoleted_version: "9"),
