...
module LogStash
  ...
  [
           Setting::BooleanSetting.new("allow_superuser", true),
 ...
 Setting::WritableDirectory.new("path.data", ::File.join(LogStash::Environment::LOGSTASH_HOME, "data")),
    Setting::NullableString.new("config.string", nil, false),
           ...
           Setting::BooleanSetting.new("modules_setup", false),
   ...
   Setting::CoercibleString.new("pipeline.ecs_compatibility", "v8", true, %w(disabled v1 v8)),
    ...
    Setting::NullableString.new("interactive", nil, false),
           ...
           Setting::BooleanSetting.new("log.format.json.fix_duplicate_message_fields", false),
           Setting::BooleanSetting.new("api.enabled", true).with_deprecated_alias("http.enabled"),
