...
describe "inputs/ganglia" do
  ...
  describe "read gmetric_ganglia_packets" do
    ...
    expected = [
        {"log_host"=>"contoso.com", "name"=>"pageviews", "val"=>"7000", "dmax"=>300, "tmax"=>60, "slope"=>"both", "units"=>"req/min", "vtype"=>"int32", "host"=>"127.0.0.1"},
        {"log_host"=>"contoso.com", "name"=>"jvm.metrics.memNonHeapUsedM", "val"=>"1", "dmax"=>0, "tmax"=>60, "slope"=>"both", "units"=>"", "vtype"=>"float", "host"=>"127.0.0.1"}
        ]
    ...
    expected = [
        {"log_host"=>"us-west-2.compute.amazonaws.com", "name"=>"ugi.ugi.loginSuccess_num_ops", "val"=>"9", "dmax"=>0, "tmax"=>60, "slope"=>"positive", "units"=>"", "vtype"=>"float", "host"=>"127.0.0.1" },
        {"log_host"=>"us-west-2.compute.amazonaws.com", "name"=>"jvm.metrics.memNonHeapUsedM", "val"=>"22.936615", "dmax"=>0, "tmax"=>60, "slope"=>"both", "units"=>"", "vtype"=>"float", "host"=>"127.0.0.1"}
        ]
